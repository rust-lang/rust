...
entry:
  tail call void (...) @__enzyme_fwddiff.f64(void (i8*, i8*, i64)* nonnull @memcpy_ptr, metadata !"enzyme_width", i64 3, metadata !"enzyme_dup", i8* %dst, i8* %dstp1, i8* %dstp2, i8* %dstp3, metadata !"enzyme_dup", i8* %src, i8* %dsrcp1, i8* %dsrcp2, i8* %dsrcp3, i64 %n)
  ret void
}

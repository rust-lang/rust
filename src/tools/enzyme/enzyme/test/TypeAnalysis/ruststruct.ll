...
start:
  ...
  call void @llvm.dbg.declare(metadata { float, float }* %t.dbg.spill, metadata !383, metadata !DIExpression()), !dbg !384
  ret void
}
...
!19 = !DIFile(filename: "ruststruct.rs", directory: "/home/nomanous/Space/Tmp/Enzyme")
!20 = !{!21, !28}
...
!373 = distinct !DISubprogram(name: "callee", linkageName: "callee", scope: !375, file: !374, line: 6, type: !376, scopeLine: 6, flags: DIFlagPrototyped, unit: !18, templateParams: !4, retainedNodes: !382)
!374 = !DIFile(filename: "ruststruct.rs", directory: "/home/nomanous/Space/Tmp/Enzyme", checksumkind: CSK_MD5, checksum: "51ad72bf77ae7bb9fee45c54880f18e6")
!375 = !DINamespace(name: "ruststruct", scope: null)
!376 = !DISubroutineType(types: !377)
!377 = !{!156, !378}
!378 = !DICompositeType(tag: DW_TAG_structure_type, name: "T", scope: !375, file: !2, size: 64, align: 32, elements: !379, templateParams: !4, identifier: "cd6fdfa020aa20d6f045c3bebc2bb8de")
!379 = !{!380, !381}
!380 = !DIDerivedType(tag: DW_TAG_member, name: "x", scope: !378, file: !2, baseType: !156, size: 32, align: 32)
!381 = !DIDerivedType(tag: DW_TAG_member, name: "y", scope: !378, file: !2, baseType: !156, size: 32, align: 32, offset: 32)
!382 = !{!383}
!383 = !DILocalVariable(name: "t", arg: 1, scope: !373, file: !374, line: 6, type: !378)
!384 = !DILocation(line: 6, column: 11, scope: !373)

; CHECK: callee - {} |{[-1]:Pointer}:{} 
; CHECK-NEXT: i8* %t: {[-1]:Pointer, [-1,0]:Float@float, [-1,4]:Float@float}
; CHECK-NEXT: start
; CHECK-NEXT:   %t.dbg.spill = bitcast i8* %t to { float, float }*: {[-1]:Pointer, [-1,0]:Float@float, [-1,4]:Float@float}
; CHECK-NEXT:   call void @llvm.dbg.declare(metadata { float, float }* %t.dbg.spill, metadata !38, metadata !DIExpression()), !dbg !50: {}
; CHECK-NEXT:   ret void: {}

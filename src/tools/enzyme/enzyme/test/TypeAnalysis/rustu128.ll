...
start:
  %x.dbg.spill = bitcast i8* %x to i128*
  call void @llvm.dbg.declare(metadata i128* %x.dbg.spill, metadata !171, metadata !DIExpression()), !dbg !172
  ret void
}
...
!19 = !DIFile(filename: "rustu128.rs", directory: "/home/nomanous/Space/Tmp/EnzymeTest")
!20 = !{!0}
...
!164 = !DIFile(filename: "rustu128.rs", directory: "/home/nomanous/Space/Tmp/EnzymeTest", checksumkind: CSK_MD5, checksum: "0ffa2fc57228092cae011f2317eaf738")
!165 = !DINamespace(name: "rustu128", scope: null)
!166 = !DISubroutineType(types: !167)
!167 = !{!168, !169}
!168 = !DIBasicType(name: "f32", size: 32, encoding: DW_ATE_float)
!169 = !DIBasicType(name: "u128", size: 128, encoding: DW_ATE_unsigned)
!170 = !{!171}
...
; CHECK-NEXT: start
; CHECK-NEXT:   %x.dbg.spill = bitcast i8* %x to i128*: {[-1]:Pointer, [-1,0]:Integer}
; CHECK-NEXT:   call void @llvm.dbg.declare(metadata i128* %x.dbg.spill, metadata !21, metadata !DIExpression()), !dbg !30: {}
; CHECK-NEXT:   ret void: {}

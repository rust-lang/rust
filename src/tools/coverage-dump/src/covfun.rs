        ...
        for i in 0..num_files {
            ...
            for _ in 0..num_mappings {
                ...
                match kind {
                    ...
                    MappingKind::Code(operand @ Operand::Expression { .. })
                    | MappingKind::Gap(operand @ Operand::Expression { .. }) => {
                        println!("    = {}", expression_resolver.format_operand(operand));
                    }
                    ...
                    MappingKind::Branch { r#true, r#false } => {
                        println!("    true  = {}", expression_resolver.format_operand(r#true));
                        println!("    false = {}", expression_resolver.format_operand(r#false));
                    }
                    _ => (),
                }
            }

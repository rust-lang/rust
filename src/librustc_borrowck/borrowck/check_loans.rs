...
impl<'a, 'tcx> CheckLoanCtxt<'a, 'tcx> {
    ...
    pub fn check_for_loans_across_yields(
        ...
        pub fn borrow_of_local_data<'tcx>(cmt: &mc::cmt_<'tcx>) -> bool {
            match cmt.cat {
                ...
                Categorization::ThreadLocal(region) | Categorization::Rvalue(region) => {
    ...
    pub fn report_error_if_loan_conflicts_with_restriction(
        ...
        for restr_path in &loan1.restricted_paths {
            ...
            let previous_end_span = Some(
                self.tcx().sess.source_map().end_point(
                    old_loan
                        .kill_scope
    ...
    pub fn analyze_restrictions_on_use(
        ...
        self.each_in_scope_loan_affecting_path(scope, use_path, |loan| {
    ...
    fn check_if_path_is_moved(
        ...
        self.move_data
            .each_move_of(id, &base_lp, |the_move, moved_lp| {
                self.bccx
                    .report_use_of_moved_value(span, use_kind, &lp, the_move, moved_lp);
                false
            });
    }

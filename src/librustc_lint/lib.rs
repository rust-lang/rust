...
use rustc::lint::builtin::{
    parser::QUESTION_MARK_MACRO_SEP, ABSOLUTE_PATHS_NOT_STARTING_WITH_CRATE, BARE_TRAIT_OBJECTS,
    ELIDED_LIFETIMES_IN_PATHS, EXPLICIT_OUTLIVES_REQUIREMENTS, INTRA_DOC_LINK_RESOLUTION_FAILURE,
...
pub fn register_builtins(store: &mut lint::LintStore, sess: Option<&Session>) {
    ...
    add_pre_expansion_builtin!(sess, KeywordIdents,);

...
pub unsafe fn report_overflow() {
    extern {
        fn rust_std_report_overflow();
    }

    rust_std_report_overflow();
}
...
mod imp {
    use thread::prelude::*;
    use super::Handler;
    use stack_overflow::prelude::report_overflow;
    use unix::page_size;
    use core::mem;
    use core::ptr;
    use unix::c::{siginfo, sigaction, SIGBUS, SIG_DFL,

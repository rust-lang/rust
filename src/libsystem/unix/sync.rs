...
pub struct Sync(());
impl ::sync::Sync for Sync {
    type Mutex = ::unix::mutex::Mutex;
    type ReentrantMutex = ::unix::mutex::ReentrantMutex;
    type RwLock = ::unix::rwlock::RwLock;
    type Condvar = ::unix::condvar::Condvar;
    type Once = ::common::once::Once;
}

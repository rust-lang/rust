...
use rustc_target::abi::{Abi, Align, FieldPlacement};
...
fn uncached_llvm_type<'a, 'tcx>(
    ...
    match layout.fields {
        ...
        FieldPlacement::Arbitrary { .. } => match name {
            None => {
...
impl<'tcx> LayoutLlvmExt<'tcx> for TyAndLayout<'tcx> {
    ...
    fn llvm_field_index(&self, index: usize) -> u64 {
        ...
        match self.fields {
            ...
            FieldPlacement::Array { .. } => index as u64,

            FieldPlacement::Arbitrary { .. } => 1 + (self.fields.memory_index(index) as u64) * 2,
        }
    }

use super::debuginfo::{
    ...
    DIFile, DIFlags, DIGlobalVariableExpression, DILexicalBlock, DINameSpace, DIScope,
    DISubprogram, DISubrange, DITemplateTypeParameter, DIType, DIVariable,
};
...
extern "C" {
    ...
    pub fn LLVMRustLinkerAdd(linker: &Linker, bytecode: *const c_char, bytecode_len: usize)
        -> bool;

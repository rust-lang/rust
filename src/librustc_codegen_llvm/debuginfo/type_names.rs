...
pub fn compute_debuginfo_type_name<'a, 'tcx>(cx: &CodegenCx<'a, 'tcx, &'a Value>,
                                             t: Ty<'tcx>,
                                             qualified: bool)
                                             -> String {
...
pub fn push_debuginfo_type_name<'a, 'tcx>(cx: &CodegenCx<'a, 'tcx, &'a Value>,
                                          t: Ty<'tcx>,
                                          qualified: bool,
                                          output: &mut String) {
    ...
    fn push_item_name(cx: &CodegenCx<'ll, '_, &'ll Value>,
                      def_id: DefId,
                      qualified: bool,
                      output: &mut String) {
        if qualified {
    ...
    fn push_type_params<'a, 'tcx>(cx: &CodegenCx<'a, 'tcx, &'a Value>,
                                  substs: &Substs<'tcx>,
                                  output: &mut String) {

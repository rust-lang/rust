...
use crate::{Build, Config, DocTests, TargetSelection};

/// Whether or not color should be present in the output
...
/// Whether to deny warnings or use the default behavior
#[derive(Copy, Clone, Default, Debug, ValueEnum)]
pub enum Warnings {
    Deny,
    #[default]
...
pub struct Flags {
    ...
    #[arg(global(true), long, value_name = "TARGET")]
    /// target targets to build
    pub target: Option<Vec<TargetSelection>>,

    #[arg(global(true), long, value_name = "PATH", value_hint = clap::ValueHint::DirPath)]
    ...
    #[arg(global(true), long)]
    #[clap(value_enum, default_value_t=Warnings::Default, value_name = "deny")]

...
impl<'a> Builder<'a> {
    ...
    pub fn cargo(
        ...
        let debuginfo_level = match mode.is_tool() {
            // If this is actually a compiler, not std,
            // then debuginfo level will be overwritten later.
            false => self.config.rust_debuginfo_level_std,
            true => self.config.rust_debuginfo_level_tools,
        };

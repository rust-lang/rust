...
On the other hand, for [compiler intrinsics][intrinsics] and internal features,
...
The `sysroot` doesn't just store the standard library,
though - it includes anything that needs to be loaded at runtime.
...
but more detailed and complete documentation compare to topic above).

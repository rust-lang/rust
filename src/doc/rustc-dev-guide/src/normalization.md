...
When an alias can't yet be normalized but may wind up normalizable in the [current environment](./typing-parameter-envs.md),
...
[universe]: borrow-check/region-inference/placeholders-and-universes.md#what-is-a-universee]

...
We have a cargo extension called [cargo-openvm] that allow users to generate
...
generated by the [cargo-openvm] utility and the [openvm-build] crate. This
...
[cargo-openvm]: https://docs.openvm.dev/book/getting-started/introduction
[openvm-build]: https://docs.openvm.dev/book/getting-started/introduction

...
upcall_s_fail(s_fail_args *args) {
    ...
    task->fail(args->unwind, args->expr,
               args->file, args->line);
}

extern "C" CDECL void
upcall_fail(bool unwind,
            char const *expr,
            char const *file,
            size_t line) {
    ...
    s_fail_args args = {unwind,task,expr,file,line};
...
extern "C" CDECL void
rust_upcall_fail(bool unwind,
                 char const *expr,
                 char const *file,
                 size_t line) {
    upcall_fail(unwind, expr, file, line);
}

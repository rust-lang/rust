...
// UEFI systems always run in protected-mode, have the interrupt-controller pre-configured and force a
...
pub fn target() -> TargetResult {
    ...
    //      }
    //   The compiler intrisics should be implemented by https://github.com/rust-lang-nursery/compiler-builtins.
    ...
    // As a result, we choose -gnu for i686 version before those intrisics are implemented in compiler-builtins.
    // After compiler-builtins implements all required intrinsics, we may remove -gnu and use the default one.
    Ok(Target {

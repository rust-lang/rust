...
impl Default for TargetOptions {
    ...
    fn default() -> TargetOptions {
        TargetOptions {
            ...
            cpu: "generic".into_string(),
            features: "".into_string(),
            dynamic_linking: false,
            executables: false,
            morestack: false,
            relocation_model: "pic".into_string(),
            code_model: "default".into_string(),
            disable_redzone: false,
            eliminate_frame_pointer: true,
            function_sections: true,
            dll_prefix: "lib".into_string(),
            dll_suffix: ".so".into_string(),
            exe_suffix: "".into_string(),
            staticlib_prefix: "lib".into_string(),
            staticlib_suffix: ".a".into_string(),
            is_like_osx: false,

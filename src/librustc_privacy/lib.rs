...
use rustc::ty::{self, Bx, TyCtxt, Ty, TypeFoldable, GenericParamDefKind};
...
pub fn check_crate<'a, 'tcx>(tcx: TyCtxt<'a, 'tcx, 'tcx>) -> Bx<'tcx, AccessLevels> {

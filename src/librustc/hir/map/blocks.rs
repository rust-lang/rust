...
use hir as ast;
use hir::map;
use hir::{Expr, FnDecl, HirId, Node};
...
impl<'a> Code<'a> {
    ...
    pub fn from_node(map: &map::Map<'a>, id: HirId) -> Option<Code<'a>> {
...
impl<'a> ClosureParts<'a> {
    fn new(d: &'a FnDecl, b: ast::BodyId, id: HirId, s: Span, attrs: &'a [Attribute]) -> Self {
        ClosureParts {
            decl: d,
            body: b,
            id,

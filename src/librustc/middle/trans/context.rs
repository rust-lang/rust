    ...
    pub fn new(sess: session::Session,
        ...
        unsafe {
            ...
            CrateContext {
                  ...
                  td: td,
                  tn: tn,
                  externs: HashMap::init(),
                  intrinsics: intrinsics,
                  item_vals: HashMap::init(),
                  exp_map2: emap2,
                  reachable: reachable,
                  item_symbols: HashMap::init(),
                  link_meta: link_meta,
                  enum_sizes: HashMap::init(),
                  discrims: HashMap::init(),
                  discrim_symbols: HashMap::init(),
                  tydescs: HashMap::init(),
                  finished_tydescs: false,
                  external: HashMap::init(),
                  external_srcs: HashMap::init(),
                  non_inlineable_statics: HashSet::init(),
                  monomorphized: HashMap::init(),
                  monomorphizing: HashMap::init(),
                  vtables: HashMap::init(),
                  const_cstr_cache: HashMap::init(),
                  const_globals: HashMap::init(),
                  const_values: HashMap::init(),
                  extern_const_values: HashMap::init(),
                  impl_method_cache: HashMap::init(),
                  module_data: HashMap::init(),
                  lltypes: HashMap::init(),
                  llsizingtypes: HashMap::init(),
                  adt_reprs: HashMap::init(),
                  symbol_hasher: symbol_hasher,
                  type_hashcodes: HashMap::init(),
                  type_short_names: HashMap::init(),
                  all_llvm_symbols: HashSet::init(),
                  tcx: tcx,
                  maps: maps,
                  stats: @mut Stats {
                    n_static_tydescs: 0u,

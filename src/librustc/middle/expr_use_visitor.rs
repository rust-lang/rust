...
impl<'a, 'gcx, 'tcx> ExprUseVisitor<'a, 'gcx, 'tcx> {
    ...
    pub fn consume_body(&mut self, body: &hir::Body) {
        ...
        for arg in &body.arguments {
            ...
            let fn_body_scope_r = self.tcx().mk_region(ty::ReScope(region::Scope {
    ...
    pub fn walk_expr(&mut self, expr: &hir::Expr) {
        ...
        match expr.node {
            ...
            hir::ExprKind::Closure(.., fn_decl_span, _) => self.walk_captures(expr, fn_decl_span),
    ...
    fn cat_captured_var(
        ...
        self.mc
            .cat_def(closure_hir_id, closure_span, var_ty, upvar.def)
    }
}

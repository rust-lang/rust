...
pub fn encode_vtable_res<'a, 'tcx>(ecx: &e::EncodeContext<'a, 'tcx>,
                                   rbml_w: &mut Encoder,
                                   dr: &typeck::vtable_res<'tcx>) {
    // can't autogenerate this code because automatic code of
    // Ty doesn't work, and there is no way (atm) to have
...
pub fn encode_vtable_param_res<'a, 'tcx>(ecx: &e::EncodeContext<'a, 'tcx>,
                                         rbml_w: &mut Encoder,
                                         param_tables: &typeck::vtable_param_res<'tcx>) {
...
pub fn encode_vtable_origin<'a, 'tcx>(ecx: &e::EncodeContext<'a, 'tcx>,
                                      rbml_w: &mut Encoder,
                                      vtable_origin: &typeck::vtable_origin<'tcx>) {
    use serialize::Encoder;

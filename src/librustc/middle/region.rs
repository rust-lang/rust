...
#[derive(
    Clone, PartialEq, PartialOrd, Eq, Ord, Hash, Debug, Copy, RustcEncodable, RustcDecodable,
)]
pub enum ScopeData {
    Node,
...
fn record_var_lifetime(
    visitor: &mut RegionResolutionVisitor<'_, '_>,

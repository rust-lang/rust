...
impl<'a, 'tcx> TypeRelation<'a, 'tcx, PredicateObligations<'tcx>> for Lub<'a, 'tcx> {
                                                ...
                                                -> RelateResult<'tcx, T>
    {
        match variance {
            ...
            ty::Contravariant => self.fields.glb().relate(a, b, side_effects),
        }
    }
    ...
    {
        self.fields.higher_ranked_lub(a, b, side_effects)
    }
}
...
impl<'a, 'tcx> LatticeDir<'a, 'tcx> for Lub<'a, 'tcx> {
        ...
        -> RelateResult<'tcx, ()>
    {
        ...
        sub.relate(&a, &v, side_effects)?;
        sub.relate(&b, &v, side_effects)?;
        Ok(())
    }
}

...
use ty::subst::Substs;
use ty::{
    FnSig, Instance, InstanceDef, ParamEnv, ParamEnvAnd, PolyFnSig, PolyTraitRef, Predicate, Ty,
    TyCtxt,
};
...
#[derive(
    Clone, Copy, Debug, PartialEq, Eq, PartialOrd, Ord, Hash, RustcEncodable, RustcDecodable,
)]

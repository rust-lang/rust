...
pub trait TypeFoldable<'tcx>: fmt::Debug + Clone {
    ...
    fn has_vars_bound_at_or_above(&self, binder: ty::DebruijnIndex) -> bool {
        self.visit_with(&mut HasEscapingVarsVisitor {
            outer_index: binder,
        })
    }
...
impl<'a, 'gcx, 'tcx> BoundVarReplacer<'a, 'gcx, 'tcx> {
    fn new<F, G>(tcx: TyCtxt<'a, 'gcx, 'tcx>, fld_r: &'a mut F, fld_t: &'a mut G) -> Self
    where
...
pub fn shift_vars<'a, 'gcx, 'tcx, T>(tcx: TyCtxt<'a, 'gcx, 'tcx>, value: &T, amount: u32) -> T
where
    T: TypeFoldable<'tcx>,
{
...
pub fn shift_out_vars<'a, 'gcx, 'tcx, T>(tcx: TyCtxt<'a, 'gcx, 'tcx>, value: &T, amount: u32) -> T
where
    T: TypeFoldable<'tcx>,
{

            ...
            ty::Adt(def, substs) => {
                ...
                if def.is_union() {
                    ...
                    if def.repr.align > 0 {
                        ...
                        align =
                            align.max(AbiAndPrefAlign::new(Align::from_bytes(repr_align).unwrap()));
                    }
                    ...
                    for field in &variants[index] {
                        ...
                        if optimize && !field.is_zst() {
                            ...
                            let field_abi = match &field.abi {
                                ...
                                Abi::Vector { element: x, count } => Abi::Vector {
        ...
        cx.layout_of(match this.ty.sty {
            ...
            ty::Ref(_, pointee, _) | ty::RawPtr(ty::TypeAndMut { ty: pointee, .. }) => {
                ...
                match tcx.struct_tail(pointee).sty {
                    ...
                    ty::Dynamic(_, _) => {
                        tcx.mk_imm_ref(tcx.types.re_static, tcx.mk_array(tcx.types.usize, 3))
            ...
            // Tuples, generators and closures.
            ty::Closure(def_id, ref substs) => substs.upvar_tys(def_id, tcx).nth(i).unwrap(),

            ty::Generator(def_id, ref substs, _) => substs.field_tys(def_id, tcx).nth(i).unwrap(),
    ...
    fn find_niche(&self, layout: TyLayout<'tcx>) -> Result<Option<Niche>, LayoutError<'tcx>> {
        ...
        match layout.abi {
            ...
            Abi::ScalarPair(ref a, ref b) => {
                ...
                let niche = iter::once((b, a.value.size(self).align_to(b.value.align(self).abi)))

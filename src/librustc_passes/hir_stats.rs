...
impl<'v> hir_visit::Visitor<'v> for StatCollector<'v> {
    ...
    fn visit_item(&mut self, i: &'v hir::Item) {
        self.record("Item", Id::Hir(i.hir_id), i);
        hir_visit::walk_item(self, i)
    }

    fn visit_mod(&mut self, m: &'v hir::Mod, _s: Span, h: hir::HirId) {
        self.record("Mod", Id::None, m);
        hir_visit::walk_mod(self, m, h)
    }

    fn visit_foreign_item(&mut self, i: &'v hir::ForeignItem) {
        self.record("ForeignItem", Id::Hir(i.hir_id), i);
        hir_visit::walk_foreign_item(self, i)
    }

    fn visit_local(&mut self, l: &'v hir::Local) {
        self.record("Local", Id::Hir(l.hir_id), l);
        hir_visit::walk_local(self, l)
    }

    fn visit_block(&mut self, b: &'v hir::Block) {
        self.record("Block", Id::Hir(b.hir_id), b);
        hir_visit::walk_block(self, b)
    }

    fn visit_stmt(&mut self, s: &'v hir::Stmt) {
        self.record("Stmt", Id::Hir(s.node.hir_id()), s);
    ...
    fn visit_pat(&mut self, p: &'v hir::Pat) {
        self.record("Pat", Id::Hir(p.hir_id), p);
    ...
    fn visit_expr(&mut self, ex: &'v hir::Expr) {
        self.record("Expr", Id::Hir(ex.hir_id), ex);
        hir_visit::walk_expr(self, ex)
    }

    fn visit_ty(&mut self, t: &'v hir::Ty) {
        self.record("Ty", Id::Hir(t.hir_id), t);
    ...
    fn visit_trait_item(&mut self, ti: &'v hir::TraitItem) {
        self.record("TraitItem", Id::Hir(ti.hir_id), ti);
        hir_visit::walk_trait_item(self, ti)
    }

    fn visit_impl_item(&mut self, ii: &'v hir::ImplItem) {
        self.record("ImplItem", Id::Hir(ii.hir_id), ii);
    ...
    fn visit_struct_field(&mut self, s: &'v hir::StructField) {
        self.record("StructField", Id::Hir(s.hir_id), s);
    ...
    fn visit_lifetime(&mut self, lifetime: &'v hir::Lifetime) {
        self.record("Lifetime", Id::Hir(lifetime.hir_id), lifetime);
    ...
    fn visit_assoc_type_binding(&mut self, type_binding: &'v hir::TypeBinding) {
        self.record("TypeBinding", Id::Hir(type_binding.hir_id), type_binding);
    ...
    fn visit_macro_def(&mut self, macro_def: &'v hir::MacroDef) {
        self.record("MacroDef", Id::Hir(macro_def.hir_id), macro_def);

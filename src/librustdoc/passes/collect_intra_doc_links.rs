...
use rustc_errors::{Applicability, DiagnosticBuilder, DiagnosticMessage, ErrorGuaranteed};
...
impl LinkCollector<'_, '_> {
    ...
    fn report_disambiguator_mismatch(
        ...
        let callback = |diag: &mut DiagnosticBuilder<'_, Option<ErrorGuaranteed>>,
...
fn report_diagnostic(
    ...
    decorate: impl FnOnce(
        &mut DiagnosticBuilder<'_, Option<ErrorGuaranteed>>,

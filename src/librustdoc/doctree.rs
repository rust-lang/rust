...
pub struct Module {
    ...
    pub attrs: HirVec<ast::Attribute>,
...
pub struct Struct {
    ...
    pub attrs: HirVec<ast::Attribute>,
    pub fields: HirVec<hir::StructField>,
    pub whence: Span,
}
...
pub struct Trait {
    pub unsafety: hir::Unsafety,
    pub name: Name,
    pub items: HirVec<hir::TraitItem>,
    pub generics: hir::Generics,
    pub bounds: HirVec<hir::TyParamBound>,
    pub attrs: HirVec<ast::Attribute>,
    pub id: ast::NodeId,
    pub whence: Span,
    pub vis: hir::Visibility,

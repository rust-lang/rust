...
impl<'a, 'hir, 'tcx> intravisit::Visitor<'hir> for HirCollector<'a, 'hir, 'tcx> {
    ...
    fn visit_item(&mut self, item: &'hir hir::Item<'_>) {
        ...
        self.visit_testable(name, attrs, item.hir_id, item.span, |this| {
    ...
    fn visit_trait_item(&mut self, item: &'hir hir::TraitItem<'_>) {
        let attrs = self.tcx.hir().attrs(item.hir_id);
        self.visit_testable(item.ident.to_string(), attrs, item.hir_id, item.span, |this| {
    ...
    fn visit_variant(
        ...
        let attrs = self.tcx.hir().attrs(v.id);
        self.visit_testable(v.ident.to_string(), attrs, v.id, v.span, |this| {
    ...
    fn visit_struct_field(&mut self, f: &'hir hir::StructField<'_>) {
        ...
        self.visit_testable(f.ident.to_string(), attrs, f.hir_id, f.span, |this| {

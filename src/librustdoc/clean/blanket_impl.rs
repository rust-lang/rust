...
impl<'a, 'tcx, 'rcx> BlanketImplFinder<'a, 'tcx, 'rcx> {
        ...
        F: Fn(DefId) -> Def,
    {
        ...
        for &trait_def_id in self.cx.all_traits.iter() {
            ...
            self.cx
                .tcx
                .for_each_relevant_impl(trait_def_id, ty, |impl_def_id| {
                    self.cx.tcx.infer_ctxt().enter(|infcx| {
                        debug!(
                            "get_blanet_impls: Considering impl for trait '{:?}' {:?}",
                        ...
                        }) = eq_result
                        {
                            ...
                            let provided_trait_methods = infcx
                                .tcx
                            ...
                            impls.push(Item {
                                ...
                                inner: ImplItem(Impl {
                                    ...
                                    synthetic: false,
                                    blanket_impl: Some(
                                        infcx.tcx.type_of(impl_def_id).clean(self.cx),
                                    ),
                                }),
                            });
                        }

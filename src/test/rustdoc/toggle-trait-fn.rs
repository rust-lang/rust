...
// @has -  '//details[@class="rustdoc-toggle"]//summary//h4' 'is_documented()'
// @!has - '//details[@class="rustdoc-toggle"]//summary//h4' 'not_documented()'
// @has -  '//details[@class="rustdoc-toggle"]//*[@class="docblock"]' 'is_documented is documented'
// @has -  '//details[@class="rustdoc-toggle"]//summary//h4' 'is_documented_optional()'
// @!has - '//details[@class="rustdoc-toggle"]//summary//h4' 'not_documented_optional()'

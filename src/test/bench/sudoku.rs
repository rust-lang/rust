...
#[test]
fn colors_new_works() {
    fail_unless_eq!(*Colors::new(1), 1022u16);
    fail_unless_eq!(*Colors::new(2), 1020u16);
    fail_unless_eq!(*Colors::new(3), 1016u16);
    fail_unless_eq!(*Colors::new(4), 1008u16);
    fail_unless_eq!(*Colors::new(5), 992u16);
    fail_unless_eq!(*Colors::new(6), 960u16);
    fail_unless_eq!(*Colors::new(7), 896u16);
    fail_unless_eq!(*Colors::new(8), 768u16);
    fail_unless_eq!(*Colors::new(9), 512u16);
}

#[test]
fn colors_next_works() {
    fail_unless_eq!(Colors(0).next(), 0u8);
    fail_unless_eq!(Colors(2).next(), 1u8);
    fail_unless_eq!(Colors(4).next(), 2u8);
    fail_unless_eq!(Colors(8).next(), 3u8);
    fail_unless_eq!(Colors(16).next(), 4u8);
    fail_unless_eq!(Colors(32).next(), 5u8);
    fail_unless_eq!(Colors(64).next(), 6u8);
    fail_unless_eq!(Colors(128).next(), 7u8);
    fail_unless_eq!(Colors(256).next(), 8u8);
    fail_unless_eq!(Colors(512).next(), 9u8);
    fail_unless_eq!(Colors(1024).next(), 0u8);
}
...
fn colors_remove_works() {
    ...
    // THEN
    fail_unless_eq!(colors.next(), 2u8);
}

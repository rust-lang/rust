...
impl Foo {
    #[rustc_clean(
        cfg="cfail2",
        except="hir_owner_nodes,optimized_mir,promoted_mir,mir_built,typeck"
    )]
    #[rustc_clean(cfg="cfail3")]
    pub fn method_body() {
        println!("Hello, world!");
...
impl Foo {
    #[rustc_clean(
        cfg="cfail2",
        except="hir_owner,hir_owner_nodes,fn_sig,typeck,optimized_mir,mir_built"
    )]
    #[rustc_clean(cfg="cfail3")]
...
impl Foo {
    #[rustc_clean(
        cfg="cfail2",
        except="hir_owner,hir_owner_nodes,fn_sig,optimized_mir,mir_built,typeck")]
    #[rustc_clean(cfg="cfail3")]
...
impl<T> Bar<T> {
    #[rustc_clean(
        cfg="cfail2",
        except="generics_of,fn_sig,typeck,type_of,optimized_mir,mir_built"
    )]
    #[rustc_clean(cfg="cfail3")]
    pub fn add_type_parameter_to_impl(&self) { }
}
...
#[rustc_clean(cfg="cfail3")]
impl Bar<u64> {
    #[rustc_clean(cfg="cfail2", except="fn_sig,optimized_mir,mir_built,typeck")]
    #[rustc_clean(cfg="cfail3")]
    pub fn change_impl_self_type(&self) { }
}

...
// gdbr-check:$1 = Struct<(u32, i32)> = {x = {8888, -8888}}
...
// gdbr-check:$4 = Struct<(u32, i32)> = {x = {8888, -8888}}
// gdb-command:print arg1
// gdb-check:$5 = -3
// gdb-command:print arg2
// gdb-check:$6 = -4
...
// gdbr-check:$7 = Struct<f64> = {x = 1234.5}
// gdb-command:print arg1
// gdb-check:$8 = -5
// gdb-command:print arg2
// gdb-check:$9 = -6
...
// gdbr-check:$10 = Struct<f64> = {x = 1234.5}
// gdb-command:print arg1
// gdb-check:$11 = -7
// gdb-command:print arg2
// gdb-check:$12 = -8
...
// gdbr-check:$13 = Struct<f64> = {x = 1234.5}
// gdb-command:print arg1
// gdb-check:$14 = -9
// gdb-command:print arg2
// gdb-check:$15 = -10.5

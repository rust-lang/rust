...
// gdbr-check:$1 = Packed = {x = 123, y = 234, z = 345}

// gdb-command:print packedInPacked
// gdbg-check:$2 = {a = 1111, b = {x = 2222, y = 3333, z = 4444}, c = 5555, d = {x = 6666, y = 7777, z = 8888}}
// gdbr-check:$2 = PackedInPacked = {a = 1111, b = Packed = {x = 2222, y = 3333, z = 4444}, c = 5555, d = Packed = {x = 6666, y = 7777, z = 8888}}

// gdb-command:print packedInUnpacked
// gdbg-check:$3 = {a = -1111, b = {x = -2222, y = -3333, z = -4444}, c = -5555, d = {x = -6666, y = -7777, z = -8888}}
// gdbr-check:$3 = PackedInUnpacked = {a = -1111, b = Packed = {x = -2222, y = -3333, z = -4444}, c = -5555, d = Packed = {x = -6666, y = -7777, z = -8888}}

// gdb-command:print unpackedInPacked
// gdbg-check:$4 = {a = 987, b = {x = 876, y = 765, z = 654}, c = {x = 543, y = 432, z = 321}, d = 210}
// gdbr-check:$4 = UnpackedInPacked = {a = 987, b = Unpacked = {x = 876, y = 765, z = 654}, c = Unpacked = {x = 543, y = 432, z = 321}, d = 210}


// gdb-command:print packedInPackedWithDrop
// gdbg-check:$5 = {a = 11, b = {x = 22, y = 33, z = 44}, c = 55, d = {x = 66, y = 77, z = 88}}
// gdbr-check:$5 = PackedInPackedWithDrop = {a = 11, b = Packed = {x = 22, y = 33, z = 44}, c = 55, d = Packed = {x = 66, y = 77, z = 88}}

// gdb-command:print packedInUnpackedWithDrop
// gdbg-check:$6 = {a = -11, b = {x = -22, y = -33, z = -44}, c = -55, d = {x = -66, y = -77, z = -88}}
// gdbr-check:$6 = PackedInUnpackedWithDrop = {a = -11, b = Packed = {x = -22, y = -33, z = -44}, c = -55, d = Packed = {x = -66, y = -77, z = -88}}

// gdb-command:print unpackedInPackedWithDrop
// gdbg-check:$7 = {a = 98, b = {x = 87, y = 76, z = 65}, c = {x = 54, y = 43, z = 32}, d = 21}
// gdbr-check:$7 = UnpackedInPackedWithDrop = {a = 98, b = Unpacked = {x = 87, y = 76, z = 65}, c = Unpacked = {x = 54, y = 43, z = 32}, d = 21}

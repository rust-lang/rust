...
// gdbr-check:$3 = Full = {454545, 0x87654321, 9988}
...
// gdbr-check:$5 = Droid = {id = 675675, range = 10000001, internals = 0x43218765}
...
// gdbr-check:$7 = option_like_enum::NestedNonZero::Yep(10.5, NestedNonZeroField = {a = 10, b = 20, c = 0x3fffffffe6cc "x000000000"})

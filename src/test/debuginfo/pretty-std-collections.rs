...
// gdb-check:$5 = BTreeMap<bool, core::option::Option<bool>>(len: 2) = {[false] = [...], [true] = core::option::Option<bool>::Some(true)}
// (abbreviated because gdb 8.1 displays None as the raw niche-filling value)

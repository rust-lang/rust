...
// Don't trigger on naked fns, but make sure nested fns don't break it

#[naked]
pub extern "C" fn aaa() {
    fn _local() {}

    unsafe { asm!(".Laaa: nop; ret;", options(noreturn)) }
}
...
pub fn normal() {
    ...
    pub extern "C" fn bbb() {
        ...
        unsafe { asm!(".Lbbb: nop; ret;", options(noreturn)) }
    }

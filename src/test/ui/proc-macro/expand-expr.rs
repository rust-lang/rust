...
use expand_expr::{echo_pm, expand_expr_is, recursive_expand};

// Check builtin macros can be expanded.

expand_expr_is!(9u32, line!());
...
expand_expr_is!("", file!()); //~ ERROR: proc macro panicked
...
expand_expr_is!("string", "string"; hello); //~ ERROR: expected one of `.`, `?`, or an operator, found `;`
                                            //~| ERROR: proc macro panicked

// Invalid expressions produce errors in addition to returning `Err(())`.
expand_expr_is!("fail", $); //~ ERROR: expected expression, found `$`
                            //~| ERROR: proc macro panicked
expand_expr_is!("fail", echo_tts!($)); //~ ERROR: proc macro panicked
expand_expr_is!("fail", echo_pm!($)); //~ ERROR: expected expression, found `$`
                                      //~| ERROR: proc macro panicked
...
expand_expr_is!("fail", arbitrary_expression() + "etc"); //~ ERROR: proc macro panicked
expand_expr_is!("fail", echo_tts!(arbitrary_expression() + "etc")); //~ ERROR: proc macro panicked
expand_expr_is!("fail", echo_expr!(arbitrary_expression() + "etc")); //~ ERROR: proc macro panicked
expand_expr_is!("fail", echo_pm!(arbitrary_expression() + "etc")); //~ ERROR: proc macro panicked

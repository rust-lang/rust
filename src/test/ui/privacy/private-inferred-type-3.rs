...
// error-pattern:type `[constructor of {ext::PrivTupleStruct}: fn(u8) -> ext::PrivTupleStruct]` is private
// error-pattern:type `[constructor of {PubTupleStruct}: fn(u8) -> PubTupleStruct]` is private

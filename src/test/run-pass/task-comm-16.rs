...
fn test_rec() {
    ...
    let mut r1: R;
    r1 = po.recv();
    fail_unless_eq!(r1.val0, 0);
    fail_unless_eq!(r1.val1, 1u8);
    fail_unless_eq!(r1.val2, '2');
}
...
fn test_vec() {
    ...
    ch.send(v0);
    let v1 = po.recv();
    fail_unless_eq!(v1[0], 0);
    fail_unless_eq!(v1[1], 1);
    fail_unless_eq!(v1[2], 2);
}
...
fn test_tag() {
    ...
    let mut t1: t;
    t1 = po.recv();
    fail_unless_eq!(t1, tag1);
    t1 = po.recv();
    fail_unless_eq!(t1, tag2(10));
    t1 = po.recv();
    fail_unless_eq!(t1, tag3(10, 11u8, 'A'));
}

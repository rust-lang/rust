...
fn test_heap_to_heap() {
    ...
    fail_unless_eq!(a.len(), 10u);
    fail_unless_eq!(a[0], 0);
    fail_unless_eq!(a[1], 1);
    fail_unless_eq!(a[2], 2);
    fail_unless_eq!(a[3], 3);
    fail_unless_eq!(a[4], 4);
    fail_unless_eq!(a[5], 0);
    fail_unless_eq!(a[6], 1);
    fail_unless_eq!(a[7], 2);
    fail_unless_eq!(a[8], 3);
    fail_unless_eq!(a[9], 4);
}
...
fn test_stack_to_heap() {
    ...
    a = a + a; // FIXME(#3387)---can't write a += a
    fail_unless_eq!(a.len(), 6u);
    fail_unless_eq!(a[0], 0);
    fail_unless_eq!(a[1], 1);
    fail_unless_eq!(a[2], 2);
    fail_unless_eq!(a[3], 0);
    fail_unless_eq!(a[4], 1);
    fail_unless_eq!(a[5], 2);
}

...
# ISSUE(64685): When targeting MSVC, Rust binaries built with both `-Z instrument-coverage` and
# `-C link-dead-code` typically crash (with a seg-fault) or at best generate an empty `*.profraw`
# file, required for coverage reports (as described in the issue comment at
# github.com/rust-lang/rust/issues/64685#issuecomment-679382091 and the expanded notes at
# github.com/richkadel/rust/blob/coverage-msvc-segfault-discuss/coverage-msvc-segfault-notes.md).
#

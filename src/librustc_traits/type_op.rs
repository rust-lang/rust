...
) -> Result<Bx<'tcx, Canonical<'tcx, QueryResponse<'tcx, ()>>>, NoSolution> {
    tcx.infer_ctxt()
...
) -> Result<Bx<'tcx, Canonical<'tcx, QueryResponse<'tcx, Ty<'tcx>>>>, NoSolution> {
    tcx.infer_ctxt()
...
) -> Result<Bx<'tcx, Canonical<'tcx, QueryResponse<'tcx, Predicate<'tcx>>>>, NoSolution> {
    tcx.infer_ctxt()
        .enter_canonical_trait_query(&canonicalized, type_op_normalize)
}
...
) -> Result<Bx<'tcx, Canonical<'tcx, QueryResponse<'tcx, FnSig<'tcx>>>>, NoSolution> {
    tcx.infer_ctxt()
        .enter_canonical_trait_query(&canonicalized, type_op_normalize)
}
...
) -> Result<Bx<'tcx, Canonical<'tcx, QueryResponse<'tcx, PolyFnSig<'tcx>>>>, NoSolution> {
    tcx.infer_ctxt()
        .enter_canonical_trait_query(&canonicalized, type_op_normalize)
}

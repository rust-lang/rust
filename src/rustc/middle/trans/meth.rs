...
// The self type as passed to trans_arg_expr() will be computed from the
// method map entry if override_self_type is not set; otherwise, the self type
// will be the value of override_self_type. override_self_type is currently
// set for default methods.

...
struct CoherenceInfo {
    ...
    // A mapping from an implementation ID to method IDs of the provided
    // (a.k.a. default) methods in the traits that that implementation
    // implements.
...
impl CoherenceChecker {
    ...
    // and trait pair. Returns a mapping from trait method ID to the
    // instantiated method IDs.

...
mod test {
    ...
    fn test_consts() {
        ...
        fn test(c : Complex64, r : f64, i: f64) {
            fail_unless_eq!(c, Cmplx::new(r,i));
        }
        test(_0_0i, 0.0, 0.0);
        test(_1_0i, 1.0, 0.0);
        test(_1_1i, 1.0, 1.0);
        ...
        fail_unless_eq!(_0_0i, Zero::zero());
        fail_unless_eq!(_1_0i, One::one());
    }
    ...
    fn test_norm() {
        fn test(c: Complex64, ns: f64) {
            fail_unless_eq!(c.norm_sqr(), ns);
            fail_unless_eq!(c.norm(), ns.sqrt())
        }
        test(_0_0i, 0.0);
        test(_1_0i, 1.0);
        test(_1_1i, 2.0);
    ...
    fn test_scale_unscale() {
        fail_unless_eq!(_05_05i.scale(2.0), _1_1i);
        fail_unless_eq!(_1_1i.unscale(2.0), _05_05i);
        for &c in all_consts.iter() {
            fail_unless_eq!(c.scale(2.0).unscale(2.0), c);
        }
    }
    ...
    fn test_conj() {
        for &c in all_consts.iter() {
            fail_unless_eq!(c.conj(), Cmplx::new(c.re, -c.im));
            fail_unless_eq!(c.conj().conj(), c);
        }
    }

    #[test]
    fn test_inv() {
        fail_unless_eq!(_1_1i.inv(), _05_05i.conj());
        fail_unless_eq!(_1_0i.inv(), _1_0i.inv());
    }
    ...
    mod arith {
        ...
        #[test]
        fn test_add() {
            fail_unless_eq!(_05_05i + _05_05i, _1_1i);
            fail_unless_eq!(_0_1i + _1_0i, _1_1i);
            fail_unless_eq!(_1_0i + _neg1_1i, _0_1i);

            for &c in all_consts.iter() {
                fail_unless_eq!(_0_0i + c, c);
                fail_unless_eq!(c + _0_0i, c);
            }
        }

        #[test]
        fn test_sub() {
            fail_unless_eq!(_05_05i - _05_05i, _0_0i);
            fail_unless_eq!(_0_1i - _1_0i, _neg1_1i);
            fail_unless_eq!(_0_1i - _neg1_1i, _1_0i);

            for &c in all_consts.iter() {
                fail_unless_eq!(c - _0_0i, c);
                fail_unless_eq!(c - c, _0_0i);
            }
        }

        #[test]
        fn test_mul() {
            fail_unless_eq!(_05_05i * _05_05i, _0_1i.unscale(2.0));
            fail_unless_eq!(_1_1i * _0_1i, _neg1_1i);

            // i^2 & i^4
            fail_unless_eq!(_0_1i * _0_1i, -_1_0i);
            fail_unless_eq!(_0_1i * _0_1i * _0_1i * _0_1i, _1_0i);

            for &c in all_consts.iter() {
                fail_unless_eq!(c * _1_0i, c);
                fail_unless_eq!(_1_0i * c, c);
            }
        }
        #[test]
        fn test_div() {
            fail_unless_eq!(_neg1_1i / _0_1i, _1_1i);
            for &c in all_consts.iter() {
                if c != Zero::zero() {
                    fail_unless_eq!(c / c, _1_0i);
                }
            }
        }
        #[test]
        fn test_neg() {
            fail_unless_eq!(-_1_0i + _0_1i, _neg1_1i);
            fail_unless_eq!((-_0_1i) * _0_1i, _1_0i);
            for &c in all_consts.iter() {
                fail_unless_eq!(-(-c), c);
            }

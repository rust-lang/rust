...
mod tests {
    ...
    fn parse_logging_spec_valid() {
        ...
        assert_eq!(dirs[0].name, Some("crate1::mod1".into_string()));
        assert_eq!(dirs[0].level, 1);

        assert_eq!(dirs[1].name, Some("crate1::mod2".into_string()));
        assert_eq!(dirs[1].level, ::MAX_LOG_LEVEL);

        assert_eq!(dirs[2].name, Some("crate2".into_string()));
    ...
    fn parse_logging_spec_invalid_crate() {
        ...
        assert_eq!(dirs[0].name, Some("crate2".into_string()));
    ...
    fn parse_logging_spec_global() {
        ...
        assert_eq!(dirs[1].name, Some("crate2".into_string()));
    ...
    fn parse_logging_spec_empty_with_filter() {
        ...
        assert_eq!(dirs.len(), 1);
        assert_eq!(dirs[0].name, Some("crate1".into_string()));
        assert_eq!(dirs[0].level, ::MAX_LOG_LEVEL);
        assert!(filter.is_some() && filter.unwrap().to_string() == "a*c");
    }
}

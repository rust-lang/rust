...
mod tests {
    ...
    fn test_decode_option_malformed() {
        check_err::<OptionData>("{ \"opt\": [] }",
                                ExpectedError("Number".to_owned(), "[]".to_owned()));
        check_err::<OptionData>("{ \"opt\": false }",
                                ExpectedError("Number".to_owned(), "false".to_owned()));
    }
    ...
    #[test]
    fn test_write_str() {
        assert_eq!(String("".to_owned()).to_string(), "\"\"");
        assert_eq!(String("".to_owned()).pretty().to_string(), "\"\"");

        assert_eq!(String("homura".to_owned()).to_string(), "\"homura\"");
        assert_eq!(String("madoka".to_owned()).pretty().to_string(), "\"madoka\"");
    }
    ...
    fn test_write_object() {
        ...
        assert_eq!(
            mk_object(&[("a".to_owned(), Boolean(true))]).pretty().to_string(),
            "\
            {\n  \
                \"a\": true\n\
            }"
    ...
    #[test]
    fn test_write_some() {
        check_encoder_for_simple!(Some("jodhpurs".to_owned()), "\"jodhpurs\"");
    }
    ...
    fn test_decode_numbers() {
        ...
        assert_eq!(res, Err(ExpectedError("Integer".to_owned(),
                                          "765.25".to_owned())));
    }
    ...
    fn test_read_str() {
        ...
        assert_eq!(from_str("\"\\t\""), Ok(String("\t".to_owned())));
        assert_eq!(from_str(" \"foo\" "), Ok(String("foo".to_owned())));
        assert_eq!(from_str("\"\\u12ab\""), Ok(String("\u{12ab}".to_owned())));
        assert_eq!(from_str("\"\\uAB12\""), Ok(String("\u{AB12}".to_owned())));
    }
    ...
    fn test_read_object() {
        ...
        assert_eq!(from_str(
                  ...
                  mk_object(&[
                      ("a".to_owned(), F64(1.0)),
                      ("b".to_owned(), Array(vec![Boolean(true)]))
                  ]));
        assert_eq!(from_str(
                      "{\
                          \"a\": 1.0, \
    ...
    fn test_decode_map() {
        ...
        assert_eq!(map.remove(&"a".to_owned()), Some(Dog));
        assert_eq!(map.remove(&"b".to_owned()), Some(Frog("Henry".to_owned(), 349)));
    }
    ...
    fn test_decode_errors_struct() {
        ...
        check_err::<DecodeStruct>("{\"x\": 1, \"y\": true, \"z\": \"\", \"w\": null}",
                                  ExpectedError("Array".to_owned(), "null".to_owned()));
    ...
    fn test_prettyencoder_indent_level_param() {
        ...
        tree.insert("hello".to_owned(), String("guten tag".to_owned()));
        tree.insert("goodbye".to_owned(), String("sayonara".to_owned()));
    ...
    fn test_hashmap_with_numeric_key_will_error_with_string_keys() {
        ...
        assert_eq!(result, Err(ExpectedError("Number".to_owned(), "a".to_owned())));
    }
    ...
    fn test_streaming_parser() {
        assert_stream_equal(
            ...
            vec![
                (ObjectStart,             vec![]),
                  (StringValue("bar".to_owned()),   vec![StackElement::Key("foo")]),
            ...
            vec![
                (ObjectStart,                   vec![]),
                  ...
                  (ArrayStart,                  vec![StackElement::Key("b")]),
                    (BooleanValue(true),        vec![StackElement::Key("b"),
                                                     StackElement::Index(0)]),
                    (StringValue("foo\nbar".to_owned()),  vec![StackElement::Key("b"),
                                                                StackElement::Index(1)]),
    ...
    fn test_to_json() {
        ...
        let object = {
            ...
            tree_map.insert("a".to_owned(), U64(1));
            tree_map.insert("b".to_owned(), U64(2));
            Object(tree_map)
        };
        ...
        assert_eq!("abc".to_json(), String("abc".to_owned()));
        assert_eq!("abc".to_owned().to_json(), String("abc".to_owned()));
        ...
        let mut tree_map = BTreeMap::new();
        tree_map.insert("a".to_owned(), 1 as usize);
        tree_map.insert("b".to_owned(), 2);
        assert_eq!(tree_map.to_json(), object);
        let mut hash_map = HashMap::new();
        hash_map.insert("a".to_owned(), 1 as usize);
        hash_map.insert("b".to_owned(), 2);

...
impl StaticKey {
    ...
    /// been allocated.
    #[inline]
    pub unsafe fn get(&self) -> *mut u8 { unimplemented!() }
    ...
    /// been allocated.
    #[inline]
    pub unsafe fn set(&self, val: *mut u8) { unimplemented!() }
    ...
    #[inline]
    unsafe fn key(&self) -> imp::Key { unimplemented!() }

    unsafe fn lazy_init(&self) -> uint { unimplemented!() }
}
...
impl Key {
    ...
    /// scope.
    #[inline]
    pub fn new(dtor: Option<unsafe extern fn(*mut u8)>) -> Key { unimplemented!() }

    /// See StaticKey::get
    #[inline]
    pub fn get(&self) -> *mut u8 { unimplemented!() }

    /// See StaticKey::set
    #[inline]
    pub fn set(&self, val: *mut u8) { unimplemented!() }
}
...
fn init_keys() { unimplemented!() }

fn register_key(key: imp::Key) { unimplemented!() }

fn unregister_key(key: imp::Key) { unimplemented!() }

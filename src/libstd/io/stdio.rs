...
//!
//! This module provides bindings to the local event loop's TTY interface, using
//! it to offer synchronous but non-blocking versions of stdio. These handles
//! can be inspected for information about terminal dimensions or for related
//! information about the stream or terminal to which it is attached.
//!
//! # Example
//!
//! ```rust

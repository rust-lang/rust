...
//!
//! These pipes are similar to TCP in the sense that you can have both a stream
//! to a server and a server itself. The server provided accepts other
//! `UnixStream` instances as clients.

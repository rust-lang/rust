...
mod tests {
    ...
    #[test]
    fn test_param_reccy() {
        let reccy1: RecCy = RecCy {x: 1, y: 2, t: One(1)};
        let reccy2: RecCy = RecCy {x: 345, y: 2, t: Two(1, 2)};
        let reccy3: RecCy = RecCy {x: 1, y: 777, t: Three(1, 2, 3)};
        let reccy4: RecCy = RecCy {x: 19, y: 252, t: Two(17, 42)};

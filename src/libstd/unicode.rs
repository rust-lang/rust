...
pub mod case_changes {
    ...
    static lowcase_table : &'static [(char,char,i32)] = &[
        ('\x41', '\x5a', 32), ('\xc0', '\xd6', 32),
        ('\xd8', '\xde', 32), ('\u0100', '\u0100', 1),
        ('\u0102', '\u0102', 1), ('\u0104', '\u0104', 1),
        ('\u0106', '\u0106', 1), ('\u0108', '\u0108', 1),
        ('\u010a', '\u010a', 1), ('\u010c', '\u010c', 1),
        ...
        ('\ua7a4', '\ua7a4', 1), ('\ua7a6', '\ua7a6', 1),
        ('\ua7a8', '\ua7a8', 1), ('\ua7aa', '\ua7aa', -42308),
        ('\uff21', '\uff3a', 32), ('\U00010400', '\U00010427', 40)
    ];

    pub fn lowcase_offset(c: char) -> i32 {
        bsearch_range_value_table(c, lowcase_table)
    }

    static upcase_table : &'static [(char,char,i32)] = &[
        ('\x61', '\x7a', -32), ('\xb5', '\xb5', 743),
        ('\xe0', '\xf6', -32), ('\xf8', '\xfe', -32),
        ('\xff', '\xff', 121), ('\u0101', '\u0101', -1),
        ('\u0103', '\u0103', -1), ('\u0105', '\u0105', -1),
        ('\u0107', '\u0107', -1), ('\u0109', '\u0109', -1),
        ('\u010b', '\u010b', -1), ('\u010d', '\u010d', -1),
        ...
        ('\ua7a3', '\ua7a3', -1), ('\ua7a5', '\ua7a5', -1),
        ('\ua7a7', '\ua7a7', -1), ('\ua7a9', '\ua7a9', -1),
        ('\uff41', '\uff5a', -32), ('\U00010428', '\U0001044f', -40)
    ];

    pub fn upcase_offset(c: char) -> i32 {
        bsearch_range_value_table(c, upcase_table)
    }

    static special_table : &'static [(char, &'static str,&'static str)] = &[
        ('\u00df', "\u00df", "\u0053\u0053"),
        ('\u0130', "\u0069\u0307", "\u0130"),
        ('\u0149', "\u0149", "\u02bc\u004e"),
        ('\u01f0', "\u01f0", "\u004a\u030c"),
    ...
    pub fn upcase_special(c:char) -> &'static str {
        case_special(c, 1)
    }

    pub fn lowcase_special(c:char) -> &'static str {
        case_special(c, 0)
    }

...
#[cfg(target_os = "nacl")]
pub use sys::backtrace::none::write;

#[cfg(not(any(all(target_os = "ios", target_arch = "arm"), target_os = "nacl")))]
pub use sys::backtrace::gcc_s::write;
...
#[cfg(all(not(target_os = "nacl"), stage0))] use prelude::v1::*;
...
// tracing impls:
#[cfg(not(any(all(target_os = "ios", target_arch = "arm"), target_os = "nacl")))] mod gcc_s;

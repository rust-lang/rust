...
pub fn trans_intrinsic_call<'a, 'blk, 'tcx>(mut bcx: Block<'blk, 'tcx>,
    ...
    let llval = match (simple, &*name) {
        ...
        (_, "u8_unchecked_div") => UDiv(bcx, llargs[0], llargs[1], call_debug_location),
        (_, "u16_unchecked_div") => UDiv(bcx, llargs[0], llargs[1], call_debug_location),
        (_, "u32_unchecked_div") => UDiv(bcx, llargs[0], llargs[1], call_debug_location),
        (_, "u64_unchecked_div") => UDiv(bcx, llargs[0], llargs[1], call_debug_location),

        (_, "i8_unchecked_div") => SDiv(bcx, llargs[0], llargs[1], call_debug_location),
        (_, "i16_unchecked_div") => SDiv(bcx, llargs[0], llargs[1], call_debug_location),
        (_, "i32_unchecked_div") => SDiv(bcx, llargs[0], llargs[1], call_debug_location),
        (_, "i64_unchecked_div") => SDiv(bcx, llargs[0], llargs[1], call_debug_location),

        (_, "u8_unchecked_rem") => URem(bcx, llargs[0], llargs[1], call_debug_location),
        (_, "u16_unchecked_rem") => URem(bcx, llargs[0], llargs[1], call_debug_location),
        (_, "u32_unchecked_rem") => URem(bcx, llargs[0], llargs[1], call_debug_location),
        (_, "u64_unchecked_rem") => URem(bcx, llargs[0], llargs[1], call_debug_location),

        (_, "i8_unchecked_rem") => SRem(bcx, llargs[0], llargs[1], call_debug_location),
        (_, "i16_unchecked_rem") => SRem(bcx, llargs[0], llargs[1], call_debug_location),
        (_, "i32_unchecked_rem") => SRem(bcx, llargs[0], llargs[1], call_debug_location),
        (_, "i64_unchecked_rem") => SRem(bcx, llargs[0], llargs[1], call_debug_location),

...
pub type iter_vec_block<'a, 'fcx, 'blk, 'tcx> =
    |Block<'fcx, 'blk, 'tcx>, ValueRef, Ty<'tcx>|: 'a -> Block<'fcx, 'blk, 'tcx>;

pub fn iter_vec_loop<'a, 'fcx, 'blk, 'tcx>(bcx: Block<'fcx, 'blk, 'tcx>,
                                     data_ptr: ValueRef,
                                     vt: &VecTypes<'tcx>,
                                     count: ValueRef,
                                     f: iter_vec_block<'a, 'fcx, 'blk, 'tcx>)
                                     -> Block<'fcx, 'blk, 'tcx> {
...
pub fn iter_vec_raw<'a, 'fcx, 'blk, 'tcx>(bcx: Block<'fcx, 'blk, 'tcx>,
                                    data_ptr: ValueRef,
                                    unit_ty: Ty<'tcx>,
                                    len: ValueRef,
                                    f: iter_vec_block<'a, 'fcx, 'blk, 'tcx>)

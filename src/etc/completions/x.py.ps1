...
Register-ArgumentCompleter -Native -CommandName 'x.py' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'x.py' {
            ...
            [CompletionResult]::new('--skip-std-check-if-no-download-rustc', '--skip-std-check-if-no-download-rustc', [CompletionResultType]::ParameterName, 'Skip checking std if `rust.download-rustc` isn''t available, mostly for RA')

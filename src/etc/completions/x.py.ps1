...
Register-ArgumentCompleter -Native -CommandName 'x.py' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'x.py' {
            ...
            [CompletionResult]::new('--warnings', 'warnings', [CompletionResultType]::ParameterName, 'if value is deny, will deny warnings if value is warn, will emit warnings otherwise, use the default configured behavior')

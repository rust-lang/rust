...
complete -c x -n "__fish_x_using_subcommand build" -l dist-std -d 'Build the standard library under the `dist` profile'
...
complete -c x -n "__fish_x_using_subcommand b" -l dist-std -d 'Build the standard library under the `dist` profile'
...
complete -c x -n "__fish_x_using_subcommand test" -l dist-std -d 'Build the standard library under the `dist` profile'
...
complete -c x -n "__fish_x_using_subcommand t" -l dist-std -d 'Build the standard library under the `dist` profile'
...
complete -c x -n "__fish_x_using_subcommand bench" -l dist-std -d 'Build the standard library under the `dist` profile'
...
complete -c x -n "__fish_x_using_subcommand dist" -l dist-std -d 'Build the standard library under the `dist` profile'
...
complete -c x -n "__fish_x_using_subcommand install" -l dist-std -d 'Build the standard library under the `dist` profile'

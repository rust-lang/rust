...
complete -c x -n "__fish_x_using_subcommand b" -l warnings -d 'if value is deny, will deny warnings if value is warn, will emit warnings otherwise, use the default configured behaviour' -r -f -a "deny\t''
warn\t''
default\t''"
complete -c x -n "__fish_x_using_subcommand b" -l color -d 'whether to use color in cargo and rustc output' -r -f -a "always\t''
never\t''
auto\t''"
...
complete -c x -n "__fish_x_using_subcommand b" -l ci -d 'Make bootstrap to behave as it\'s running on the CI environment or not' -r -f -a "true\t''
false\t''"
...
complete -c x -n "__fish_x_using_subcommand c" -l warnings -d 'if value is deny, will deny warnings if value is warn, will emit warnings otherwise, use the default configured behaviour' -r -f -a "deny\t''
warn\t''
default\t''"
complete -c x -n "__fish_x_using_subcommand c" -l color -d 'whether to use color in cargo and rustc output' -r -f -a "always\t''
never\t''
auto\t''"
...
complete -c x -n "__fish_x_using_subcommand c" -l ci -d 'Make bootstrap to behave as it\'s running on the CI environment or not' -r -f -a "true\t''
false\t''"
...
complete -c x -n "__fish_x_using_subcommand d" -l warnings -d 'if value is deny, will deny warnings if value is warn, will emit warnings otherwise, use the default configured behaviour' -r -f -a "deny\t''
warn\t''
default\t''"
complete -c x -n "__fish_x_using_subcommand d" -l color -d 'whether to use color in cargo and rustc output' -r -f -a "always\t''
never\t''
auto\t''"
...
complete -c x -n "__fish_x_using_subcommand d" -l ci -d 'Make bootstrap to behave as it\'s running on the CI environment or not' -r -f -a "true\t''
false\t''"
...
complete -c x -n "__fish_x_using_subcommand test" -l verbose-run-make-subprocess-output -d 'whether to show verbose subprocess output for run-make tests; set to false to suppress output for passing tests (e.g. for cg_clif with --no-capture)' -r -f -a "true\t''
false\t''"
...
complete -c x -n "__fish_x_using_subcommand t" -l verbose-run-make-subprocess-output -d 'whether to show verbose subprocess output for run-make tests; set to false to suppress output for passing tests (e.g. for cg_clif with --no-capture)' -r -f -a "true\t''
false\t''"
...
complete -c x -n "__fish_x_using_subcommand t" -l warnings -d 'if value is deny, will deny warnings if value is warn, will emit warnings otherwise, use the default configured behaviour' -r -f -a "deny\t''
warn\t''
default\t''"
complete -c x -n "__fish_x_using_subcommand t" -l color -d 'whether to use color in cargo and rustc output' -r -f -a "always\t''
never\t''
auto\t''"
...
complete -c x -n "__fish_x_using_subcommand t" -l ci -d 'Make bootstrap to behave as it\'s running on the CI environment or not' -r -f -a "true\t''
false\t''"
...
complete -c x -n "__fish_x_using_subcommand r" -l warnings -d 'if value is deny, will deny warnings if value is warn, will emit warnings otherwise, use the default configured behaviour' -r -f -a "deny\t''
warn\t''
default\t''"
complete -c x -n "__fish_x_using_subcommand r" -l color -d 'whether to use color in cargo and rustc output' -r -f -a "always\t''
never\t''
auto\t''"
...
complete -c x -n "__fish_x_using_subcommand r" -l ci -d 'Make bootstrap to behave as it\'s running on the CI environment or not' -r -f -a "true\t''
false\t''"

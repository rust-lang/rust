...
complete -c x.py -n "__fish_x.py_using_subcommand test" -l quiet -d 'suppress verbose subprocess output for successful run-make tests (useful with --no-capture for panic=abort test suites like cg_clif)'

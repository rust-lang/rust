...
complete -c x.py -n "__fish_x.py_using_subcommand test" -l rustc-args -d 'extra options to pass the compiler when running tests' -r
...
complete -c x.py -n "__fish_x.py_using_subcommand miri" -l rustc-args -d 'extra options to pass the compiler when running tests' -r

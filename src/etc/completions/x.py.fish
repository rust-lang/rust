...
function __fish_x.py_global_optspecs
	string join \n v/verbose i/incremental config= build-dir= build= host= target= exclude= skip= include-default-paths rustc-error-format= on-fail= dry-run dump-bootstrap-shims stage= keep-stage= keep-stage-std= src= j/jobs= warnings= error-format= json-output color= bypass-bootstrap-lock release rust-profile-generate= rust-profile-use= llvm-profile-use= llvm-profile-generate enable-bolt-settings skip-stage0-validation reproducible-artifact= set= h/help
end
...
complete -c x.py -n "__fish_x.py_needs_command" -l release
...
complete -c x.py -n "__fish_x.py_using_subcommand build" -l release
...
complete -c x.py -n "__fish_x.py_using_subcommand check" -l release
...
complete -c x.py -n "__fish_x.py_using_subcommand clippy" -l release
...
complete -c x.py -n "__fish_x.py_using_subcommand fix" -l release
...
complete -c x.py -n "__fish_x.py_using_subcommand fmt" -l release
...
complete -c x.py -n "__fish_x.py_using_subcommand doc" -l release
...
complete -c x.py -n "__fish_x.py_using_subcommand test" -l release
...
complete -c x.py -n "__fish_x.py_using_subcommand miri" -l release
...
complete -c x.py -n "__fish_x.py_using_subcommand bench" -l release
...
complete -c x.py -n "__fish_x.py_using_subcommand clean" -l release
...
complete -c x.py -n "__fish_x.py_using_subcommand dist" -l release
...
complete -c x.py -n "__fish_x.py_using_subcommand install" -l release
...
complete -c x.py -n "__fish_x.py_using_subcommand run" -l release
...
complete -c x.py -n "__fish_x.py_using_subcommand setup" -l release
...
complete -c x.py -n "__fish_x.py_using_subcommand suggest" -l release
...
complete -c x.py -n "__fish_x.py_using_subcommand vendor" -l release
...
complete -c x.py -n "__fish_x.py_using_subcommand perf" -l release

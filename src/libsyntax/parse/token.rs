...
impl Token {
    ...
    /// Returns whether the token can appear at the start of an expression.
    ...
    /// Returns whether the token can appear at the start of a type.
    ...
    /// Returns whether the token can appear at the start of a generic bound.
    crate fn can_begin_bound(&self) -> bool {
        self.is_path_start() || self.is_lifetime() || self.is_keyword(keywords::For) ||
        self == &Question || self == &OpenDelim(Paren)
    }

    /// Returns whether the token is any literal
    ...
    /// Returns whether the token is any literal, a minus (which can follow a literal,
    ...
    /// Returns whether the token is a lifetime.
    crate fn is_lifetime(&self) -> bool {
        self.lifetime().is_some()
    }

    /// Returns whether the token is a identifier whose name is the given
    /// string slice.
    ...
    /// Returns whether the token is an interpolated path.
    ...
    /// Returns whether the token is either the `mut` or `const` keyword.
    ...
    /// Returns whether the token is a given keyword, `kw`.

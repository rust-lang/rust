...
use parse::obsolete::{ObsoleteSwap, ObsoleteUnsafeBlock};
use parse::obsolete::{ObsoleteNamedExternModule,ObsoleteMultipleLocalDecl,ObsoleteUnsafeExternFn};
use parse::obsolete::{ObsoleteTraitFuncVisibility, ObsoleteConstPointer, ObsoleteEmptyImpl};
use parse::obsolete::{ObsoleteLoopAsContinue, ObsoleteEnumWildcard, ObsoleteStructWildcard};
use parse::obsolete::{ObsoleteVecDotDotWildcard, ObsoleteBoxedClosure, ObsoleteClosureType};
use parse::obsolete::{ObsoleteMultipleImport, ObsoleteSyntax, ParserObsoleteMethods};

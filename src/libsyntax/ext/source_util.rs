...
pub fn expand_line(cx: &mut ExtCtxt,
...
pub fn expand_column(cx: &mut ExtCtxt,
                     _path: &Option<::ast::Path>,
                     sp: Span, tts: &[tokenstream::TokenTree])
                  -> Box<base::MacResult+'static> {
...
pub fn expand_column_gated(cx: &mut ExtCtxt,
                          path: &Option<::ast::Path>,
                           sp: Span, tts: &[tokenstream::TokenTree])
                  -> Box<base::MacResult+'static> {
    if sp.allows_unstable() {
        expand_column(cx, path, sp, tts)
    } else {
...
/// out if we wanted.
pub fn expand_file(cx: &mut ExtCtxt, _path: &Option<::ast::Path>,
                   sp: Span, tts: &[tokenstream::TokenTree])
                   -> Box<base::MacResult+'static> {
...
pub fn expand_function<'cx>(cx: &'cx mut ExtCtxt,
    ...
    base::MacEager::expr(cx.expr_str(topmost, Symbol::intern(&path.to_string())))
}

pub fn expand_stringify(cx: &mut ExtCtxt,
                        _path: &Option<::ast::Path>,
                        sp: Span, tts: &[tokenstream::TokenTree])
                        -> Box<base::MacResult+'static> {
...
pub fn expand_mod(cx: &mut ExtCtxt,
                  _path: &Option<::ast::Path>,
                  sp: Span, tts: &[tokenstream::TokenTree])
                  -> Box<base::MacResult+'static> {
...
/// unhygienically.
pub fn expand_include<'cx>(cx: &'cx mut ExtCtxt,
...
pub fn expand_include_str(cx: &mut ExtCtxt,
                          _path: &Option<::ast::Path>,
                          sp: Span, tts: &[tokenstream::TokenTree])
                          -> Box<base::MacResult+'static> {
...
pub fn expand_include_bytes(cx: &mut ExtCtxt,
                            _path: &Option<::ast::Path>,
                            sp: Span, tts: &[tokenstream::TokenTree])
                            -> Box<base::MacResult+'static> {

...
fn create_eq_method(cx: @ext_ctxt,
    ...
    let arg_path_type = super::create_self_type_with_params(cx,
                                                     span,
                                                     type_ident,
                                                     generics);
...
fn expand_deriving_eq_struct_def(cx: @ext_ctxt,
    ...
    let derive_struct_fn = if super::is_struct_tuple(struct_def) {
...
fn expand_deriving_eq_enum_method(cx: @ext_ctxt,
    ...
    for enum_definition.variants.each |self_variant| {
        ...
        let matching_pat = super::create_enum_variant_pattern(cx,
                                                       span,
                                                       self_variant,
                                                       ~"__other");
        ...
        for uint::range(0, super::variant_arg_count(cx, span, self_variant)) |i| {
        ...
        let self_pat = super::create_enum_variant_pattern(cx,
                                                   span,
                                                   self_variant,
                                                   ~"__self");
...
fn expand_deriving_eq_struct_tuple_method(cx: @ext_ctxt,
    ...
    let other_subpats = super::create_subpatterns(cx, span, other_str, fields.len());
    ...
    let self_subpats = super::create_subpatterns(cx, span, self_str, fields.len());
    let self_arm = ast::arm {

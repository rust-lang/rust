...
fn expand_deriving_clone_struct_def(cx: @ext_ctxt,
                                 ...
                                 -> @item {
    // Create the method.
    let method = if !super::is_struct_tuple(struct_def) {
...
fn expand_deriving_clone_tuple_struct_method(cx: @ext_ctxt,
    ...
    let subpats = super::create_subpatterns(cx, span, ~"__self", field_count);
    ...
    let self_match_expr = super::expand_enum_or_struct_match(cx, span, ~[ arm ]);

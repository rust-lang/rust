...
pub fn token_to_string(tok: &Token) -> String {
    match *tok {
        ...
        token::DotDotDot            => "...".to_owned(),
        token::Comma                => ",".to_owned(),
        token::Semi                 => ";".to_owned(),
        token::Colon                => ":".to_owned(),
        token::ModSep               => "::".to_owned(),
        token::RArrow               => "->".to_owned(),
        token::LArrow               => "<-".to_owned(),
        token::FatArrow             => "=>".to_owned(),
        token::OpenDelim(token::Paren) => "(".to_owned(),
        token::CloseDelim(token::Paren) => ")".to_owned(),
        token::OpenDelim(token::Bracket) => "[".to_owned(),
        token::CloseDelim(token::Bracket) => "]".to_owned(),
        token::OpenDelim(token::Brace) => "{".to_owned(),
        token::CloseDelim(token::Brace) => "}".to_owned(),

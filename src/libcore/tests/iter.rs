...
use core::iter::*;
use core::usize;
use core::{i128, i16, i8, isize, u128, u16, usize};
...
fn test_step_forward() {
    ...
    assert_eq!(
        (0x7fff_ffff_ffff_ffff__ffff_ffff_ffff_ff00_i128).forward(0xff_usize),
        Some(i128::MAX),
    );
...
fn test_step_backward() {
    ...
    assert_eq!(
        (-0x7fff_ffff_ffff_ffff__ffff_ffff_ffff_ff00_i128).backward(0x100_usize),
        Some(i128::MIN)
    );
}

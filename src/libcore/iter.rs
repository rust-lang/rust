...
//! # The `Iterator` trait
//!
//! This module defines Rust's core iteration trait. The `Iterator` trait
//! has one unimplemented method, `next`. All other methods are derived
//! through default methods to perform operations such as `zip`, `chain`,
//! `enumerate`, and `fold`.
//!

...
# should do just on mingw, not "custom mingw". same problem of using "custom mingw"
# to mean "mingw" as in that other script.
#https://github.com/rust-lang-ci/rust/commit/b524c6277fd8f6826a97e5b83d397e03ae9c949f

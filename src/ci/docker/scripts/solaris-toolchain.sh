...
# https://github.com/rust-lang/ci-mirrors/commit/84410007c6ec6f2655c1d8ae41b50c985370fb97
...
+          || (vernum > 1 && strcmp(name, "logb") != 0
         ...
         {
EOF
        expand -t 4 binutils-$BINUTILS_VERSION/bfd/elflink.c > binutils-$BINUTILS_VERSION/bfd/elflink.c.exp

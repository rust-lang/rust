...
install-host: $(CSREQ$(ISTAGE)_T_$(CFG_BUILD)_H_$(CFG_BUILD))
	...
	$(Q)$(call INSTALL,$(HB2),$(PHB),rusti$(X_$(CFG_BUILD)))
	...
	$(Q)$(call INSTALL_LIB,$(LIBRUSTI_GLOB_$(CFG_BUILD)))
	...
	$(Q)$(call INSTALL,$(S)/man, $(PREFIX_ROOT)/$(CFG_MANDIR)/man1,rusti.1)

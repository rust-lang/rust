...
entry:
  call void @__enzyme_fwddiff(i8* bitcast (void (double**, i64*)* @_ZL6matvecPKN5Eigen6MatrixIdLin1ELin1ELi0ELin1ELin1EEES3_ to i8*), i8* %a, i8* %b, i8* %c)
  ret void
}

declare void @__enzyme_fwddiff(i8*, i8*, i8*, i8*) local_unnamed_addr
...
; CHECK-NEXT:   %[[i0:.+]] = load double, double* %"call'ipg"

...
;#include <cblas.h>
;
;extern double __enzyme_autodiff(double*, double*, double*, double*, double*);
;
...
;	 double m1[3] = {0.};
;	 double n1[3] = {0.};
;	 double z = __enzyme_autodiff((double*)g, m, m1, n, n1);
;}
...
entry:
  ...
  %1 = bitcast [3 x double]* %n to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %1, i8* align 16 bitcast ([3 x double]* @__const.main.n to i8*), i64 24, i1 false)
  %2 = bitcast [3 x double]* %m1 to i8*
  ...
  %call = call double @__enzyme_autodiff(double* bitcast (double (double*, double*)* @g to double*), double* %arraydecay, double* %arraydecay1, double* %arraydecay2, double* %arraydecay3)
...
declare dso_local double @__enzyme_autodiff(double*, double*, double*, double*, double*)
...
;CHECK-NEXT:  call void @cblas_daxpy(i32 3, double %0, double* %m, i32 1, double* %"n'", i32 1)
;CHECK-NEXT:  call void @cblas_daxpy(i32 3, double %0, double* %n, i32 1, double* %"m'", i32 1)
;CHECK-NEXT:  ret void
;CHECK-NEXT:}

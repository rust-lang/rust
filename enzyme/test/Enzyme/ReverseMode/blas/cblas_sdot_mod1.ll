...
declare dso_local float @cblas_sdot(i32, float*, i32, float*, i32) #1
...
;CHECK-NEXT:  call void @__enzyme_memcpy_floatda0sa0stride(float* %0, float* %m, i32 3, i32 1)
...
;CHECK-NEXT:  call void @cblas_saxpy(i32 3, float %1, float* %0, i32 1, float* %"n'", i32 1)
;CHECK-NEXT:  tail call void @free(i8* %malloccall)
;CHECK-NEXT:  call void @cblas_saxpy(i32 3, float %1, float* %n, i32 1, float* %"m'", i32 1)
;CHECK-NEXT:  ret void
;CHECK-NEXT:}

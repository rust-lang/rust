...
; CHECK-NEXT:   %3 = fmul fast double %0, %0
; CHECK-NEXT:   %4 = fsub fast double %3, %2
...
; CHECK-NEXT:   %18 = fmul fast double %15, %17
; CHECK-NEXT:   %19 = fmul fast double %14, %16
; CHECK-NEXT:   %20 = fsub fast double %19, %18
; CHECK-NEXT:   %21 = fmul fast double %14, %17
; CHECK-NEXT:   %22 = fmul fast double %15, %16
; CHECK-NEXT:   %23 = fadd fast double %22, %21

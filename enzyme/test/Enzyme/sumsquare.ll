; RUN: opt < %s %loadEnzyme -enzyme -enzyme_preopt=false -inline -mem2reg -instsimplify -adce -loop-deletion -correlated-propagation -simplifycfg -early-cse -S | FileCheck %s
...
; CHECK-NEXT:   br i1 %[[cmp]], label %diffesumsquare.exit, label %invertfor.body.i

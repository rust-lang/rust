...
; CHECK-NEXT: entry:
; CHECK-NEXT:   %"data1'ipge" = getelementptr inbounds %struct.S, %struct.S* %"from'", i64 0, i32 1
; CHECK-NEXT:   %data1 = getelementptr inbounds %struct.S, %struct.S* %from, i64 0, i32 1
; CHECK-NEXT:   %"data11'ipge" = getelementptr inbounds %struct.S, %struct.S* %"to'", i64 0, i32 1
...
; CHECK-NEXT:   %3 = bitcast double* %"data11'ipge" to <2 x double>*
; CHECK-NEXT:   %4 = load <2 x double>, <2 x double>* %3, align 8
; CHECK-NEXT:   %"'ipc1" = bitcast double* %"data11'ipge" to <2 x i64>*
; CHECK-NEXT:   store <2 x i64> zeroinitializer, <2 x i64>* %"'ipc1", align 8
; CHECK-NEXT:   %5 = bitcast double* %"data1'ipge" to <2 x double>*
; CHECK-NEXT:   %6 = load <2 x double>, <2 x double>* %5, align 8
; CHECK-NEXT:   %7 = fadd fast <2 x double> %6, %4
; CHECK-NEXT:   %8 = bitcast double* %"data1'ipge" to <2 x double>*

...
; CHECK-NEXT:   %call_augmented = call { double, double } @augmented_total(double* %dims, double* %[[dimsipge]])
...
; CHECK-NEXT:   call void @diffetotal(double* %dims, double* %[[dimsipge]], double %1, double %subcache)
; CHECK-NEXT:   ret void
; CHECK-NEXT: }

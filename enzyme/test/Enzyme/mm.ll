...
; CHECK-NEXT:   %"rhs_data'ipl_unwrap" = load float*, float** %"rhs'", align 8, !invariant.group !17
...
; CHECK-NEXT:   %"lhs_data'ipl_unwrap" = load float*, float** %"lhs'", align 8, !invariant.group !18
...
; CHECK-NEXT:   %"iv3'ac.0" = phi i64 [ %_unwrap17, %invertfor.inc44 ], [ %24, %incinvertfor.body23 ]
...
; CHECK-NEXT:   %"rhs_data'ipl_unwrap15" = load float*, float** %"rhs'", align 8, !invariant.group !17
...
; CHECK-NEXT:   %"lhs_data'ipl_unwrap16" = load float*, float** %"lhs'", align 8, !invariant.group !18
...
; CHECK-NEXT:   %_unwrap17 = add nsw i64 %smax, -2
; CHECK-NEXT:   br label %invertfor.body23

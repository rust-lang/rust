; RUN: opt < %s %loadEnzyme -enzyme -inline -mem2reg -ipconstprop -deadargelim -sroa -early-cse -adce -deadargelim -instcombine -adce -deadargelim -adce -simplifycfg -S -instcombine -dse | FileCheck %s

...
; CHECK-NEXT:   %[[off:.+]] = mul nuw nsw i64 %iv, 4

; CHECK-NEXT:   %[[l2gep:.+]] = getelementptr inbounds double, double* %L2_malloccache, i64 %[[off]]
; CHECK-NEXT:   %[[l2bc:.+]] = bitcast double* %[[l2gep]] to i8*
; CHECK-NEXT:   %[[xbc:.+]] = bitcast double* %x to i8*
; CHECK-NEXT:   call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %[[l2bc]], i8* nonnull %[[xbc]], i64 32, i1 false)
...
; CHECK-NEXT:   %[[a10:.+]] = load i64, i64* %[[a9]], align 8, !invariant.group !1
...
; CHECK-NEXT:   %[[a12:.+]] = mul nuw nsw i64 %"iv'ac.0", 4
; CHECK-NEXT:   %[[a14:.+]] = getelementptr inbounds double, double* %L2_malloccache, i64 %[[a12]]
; CHECK-NEXT:   %[[rgep:.+]] = getelementptr inbounds double, double* %[[a14]], i64 %"iv1'ac.0"
...
; CHECK-NEXT:   %[[a17:.+]] = load double, double* %[[a16]], align 8, !invariant.group !0
...
; CHECK-NEXT:   %"iv'ac.0" = phi i64 [ %[[a8]], %incinvertloop1 ], [ 3, %cleanup ]
; CHECK-NEXT:   br label %invertloop2
; CHECK-NEXT: }

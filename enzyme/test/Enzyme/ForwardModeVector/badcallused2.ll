...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[TMP0:%.*]] = call i1 @fwddiffe3subf(double* [[X]], [3 x double*] %"x'")
; CHECK-NEXT:    [[SEL:%.*]] = select i1 [[TMP0]], double 2.000000e+00, double 3.000000e+00
...
; CHECK-NEXT:    [[TMP10:%.*]] = call i1 @fwddiffe3metasubf(double* [[X]], [3 x double*] %"x'")
; CHECK-NEXT:    ret i1 [[TMP10]]
;
;
; CHECK: define {{[^@]+}}@fwddiffe3omegasubf(double* nocapture [[X:%.*]], [3 x double*] %"x'") 
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[TMP0:%.*]] = extractvalue [3 x double*] %"x'", 0
...
; CHECK-NEXT:    store double 0.000000e+00, double* %"arrayidx'ipg2", align 8
; CHECK-NEXT:    [[TMP3:%.*]] = load double, double* [[X]], align 8
; CHECK-NEXT:    [[CMP:%.*]] = fcmp fast oeq double [[TMP3]], 2.000000e+00

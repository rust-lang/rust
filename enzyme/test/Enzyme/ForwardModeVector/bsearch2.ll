...
; CHECK-NEXT:   %"gep2'ipg" = getelementptr inbounds double, double* %0, i64 %idx
; CHECK-NEXT:   %1 = extractvalue [3 x double*] %"x'", 1
; CHECK-NEXT:   %"gep2'ipg1" = getelementptr inbounds double, double* %1, i64 %idx
; CHECK-NEXT:   %2 = extractvalue [3 x double*] %"x'", 2
; CHECK-NEXT:   %"gep2'ipg2" = getelementptr inbounds double, double* %2, i64 %idx

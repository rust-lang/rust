...
; CHECK-NEXT:   store i32 2, i32* %"num_elems'ipge", align 8
...
; CHECK-NEXT:   %"data2'ipge" = getelementptr inbounds %struct.S, %struct.S* %"to'", i64 0, i32 2
...
; CHECK-NEXT:   %5 = load double, double* %"data2'ipge", align 8
; CHECK-NEXT:   %"'ipc2" = bitcast double* %"data2'ipge" to i64*
; CHECK-NEXT:   store i64 0, i64* %"'ipc2", align 8
; CHECK-NEXT:   %6 = load double, double* %"data1'ipge", align 8
; CHECK-NEXT:   %7 = fadd fast double %6, %5
; CHECK-NEXT:   store double %7, double* %"data1'ipge", align 8
; CHECK-NEXT:   %8 = load double, double* %"data11'ipge", align 8
; CHECK-NEXT:   %"'ipc6" = bitcast double* %"data11'ipge" to i64*
; CHECK-NEXT:   store i64 0, i64* %"'ipc6", align 8
; CHECK-NEXT:   %9 = load double, double* %"data1'ipge", align 8
; CHECK-NEXT:   %10 = fadd fast double %9, %8
; CHECK-NEXT:   store double %10, double* %"data1'ipge", align 8

...
; CHECK: define internal { {} } @augmented_function(double %y, double %z, double* nocapture %x, double* %"x'") 
; CHECK-NEXT: entry:
...
; CHECK: define internal { double, double } @diffefunction(double %y, double %z, double* nocapture %x, double* %"x'", {} %tapeArg) 
; CHECK-NEXT: entry:

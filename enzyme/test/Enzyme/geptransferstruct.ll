...
; CHECK-NEXT:   store i64 %loadnotype, i64* %[[ptr4]], align 4, !tbaa !0
; CHECK-NEXT:   %[[dptr4:.+]] = getelementptr inbounds i64, i64* %"ptr'", i64 4
; CHECK-NEXT:   %[[double_dptr4:.+]] = bitcast i64* %[[dptr4]] to double*
; CHECK-NEXT:   %[[pre_dptr4:.+]] = load double, double* %[[double_dptr4]], align 8
; CHECK-NEXT:   store i64 0, i64* %[[dptr4]], align 4
; CHECK-NEXT:   %[[dptr2:.+]] = getelementptr inbounds i64, i64* %"ptr'", i64 2
; CHECK-NEXT:   %5 = bitcast i64* %[[dptr2]] to double*
; CHECK-NEXT:   %6 = load double, double* %5, align 8
; CHECK-NEXT:   %7 = fadd fast double %6, %[[pre_dptr4]]
...
; CHECK-NEXT:   %[[ldouble_dptr2:.+]] = load double, double* %[[double_dptr2]]

; CHECK-NEXT:   %[[finaladd:.+]] = fadd fast double %[[ldouble_dptr2]], %10
; CHECK-NEXT:   %[[double2_dptr2:.+]] = bitcast i64* %[[ptr2ipge]] to double*
; CHECK-NEXT:   store double %[[finaladd]], double* %[[double2_dptr2]], align 8
; CHECK-NEXT:   ret void
; CHECK-NEXT: }

...
; CHECK-NEXT:   %"loaded'ipl1" = load double*, double** %0, align 8
...
; CHECK-NEXT:   %"gep'ipge" = getelementptr inbounds double, double* %"loaded'ipl1", i64 %and
...
; CHECK-NEXT:   %3 = load double, double* %"gep'ipge", align 8
; CHECK-NEXT:   %4 = fadd fast double %3, %2
; CHECK-NEXT:   store double %4, double* %"gep'ipge", align 8

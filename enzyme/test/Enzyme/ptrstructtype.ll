...
; CHECK: define internal {} @diffe_ZL6matvecPKN5Eigen6MatrixIdLi2ELi2ELi0ELi2ELi2EEES3_PS1_(double* %ad, double* %"ad'", double* noalias %arraydecay, double* %"arraydecay'") #1 {
; CHECK-NEXT: entry:

; RUN: %opt < %s %loadEnzyme -enzyme -enzyme_preopt=false -inline -O3 -dse -S | FileCheck %s
...
; CHECK-NEXT:   tail call fastcc void @diffef(double* nonnull %[[ipci]], double %factor) #6

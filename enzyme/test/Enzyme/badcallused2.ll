...
; CHECK-NEXT:   %[[augret:.+]] = extractvalue { { {}, {} }, i1 } %[[augsubf]], 1
...
; CHECK-NEXT:   %[[gep:.+]] = getelementptr inbounds { { {}, {} }, i1 }, { { {}, {} }, i1 }* %0, i32 0, i32 1
...
; CHECK: define internal {{(dso_local )?}}{} @diffeomegasubf(double* nocapture %x, double* nocapture %"x'", {} %tapeArg)
; CHECK-NEXT: entry:
; CHECK-NEXT:   %[[tostore:.+]] = getelementptr inbounds double, double* %"x'", i64 1
; CHECK-NEXT:   store double 0.000000e+00, double* %[[tostore]], align 8
; CHECK-NEXT:   ret {} undef

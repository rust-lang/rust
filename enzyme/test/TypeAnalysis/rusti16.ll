...
start:
  %x.dbg.spill = bitcast i8* %x to i16*
  call void @llvm.dbg.declare(metadata i16* %x.dbg.spill, metadata !171, metadata !DIExpression()), !dbg !172
  ret void
}
...
!169 = !DIBasicType(name: "i16", size: 16, encoding: DW_ATE_unsigned)
!170 = !{!171}
...
; CHECK-NEXT: start
; CHECK-NEXT:   %x.dbg.spill = bitcast i8* %x to i16*: {[-1]:Pointer, [-1,0]:Integer}
; CHECK-NEXT:   call void @llvm.dbg.declare(metadata i16* %x.dbg.spill, metadata !21, metadata !DIExpression()), !dbg !30: {}
; CHECK-NEXT:   ret void: {}

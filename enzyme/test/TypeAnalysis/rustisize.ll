...
start:
  %x.dbg.spill = bitcast i8* %x to i64*
  call void @llvm.dbg.declare(metadata i64* %x.dbg.spill, metadata !171, metadata !DIExpression()), !dbg !172
  ret void
}
...
!169 = !DIBasicType(name: "isize", size: 64, encoding: DW_ATE_unsigned)
!170 = !{!171}
...
; CHECK-NEXT: start
; CHECK-NEXT:   %x.dbg.spill = bitcast i8* %x to i64*: {[-1]:Pointer, [-1,0]:Integer}
; CHECK-NEXT:   call void @llvm.dbg.declare(metadata i64* %x.dbg.spill, metadata !21, metadata !DIExpression()), !dbg !30: {}
; CHECK-NEXT:   ret void: {}

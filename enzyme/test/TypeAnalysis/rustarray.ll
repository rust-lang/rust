...
start:
  %t = bitcast i8* %arg to [4 x float]*
  call void @llvm.dbg.declare(metadata [4 x float]* %t, metadata !382, metadata !DIExpression()), !dbg !383
  ret void
}
...
!19 = !DIFile(filename: "rustarray.rs", directory: "/home/nomanous/Space/Tmp/Enzyme")
!20 = !{!21, !28}
...
!373 = distinct !DISubprogram(name: "callee", linkageName: "callee", scope: !375, file: !374, line: 1, type: !376, scopeLine: 1, flags: DIFlagPrototyped, unit: !18, templateParams: !4, retainedNodes: !381)
!374 = !DIFile(filename: "rustarray.rs", directory: "/home/nomanous/Space/Tmp/Enzyme", checksumkind: CSK_MD5, checksum: "a034d9aad4c8a6f7e579248ea6b5a8b1")
!375 = !DINamespace(name: "rustarray", scope: null)
!376 = !DISubroutineType(types: !377)
!377 = !{!156, !378}
!378 = !DICompositeType(tag: DW_TAG_array_type, baseType: !156, size: 128, align: 32, elements: !379)
!379 = !{!380}
!380 = !DISubrange(count: 4, lowerBound: 0)
!381 = !{!382}
!382 = !DILocalVariable(name: "t", arg: 1, scope: !373, file: !374, line: 1, type: !378)
!383 = !DILocation(line: 1, column: 11, scope: !373)

; CHECK: callee - {} |{[-1]:Pointer}:{}
; CHECK-NEXT: i8* %arg: {[-1]:Pointer, [-1,0]:Float@float, [-1,4]:Float@float, [-1,8]:Float@float, [-1,12]:Float@float}
; CHECK-NEXT: start
; CHECK-NEXT:   %t = bitcast i8* %arg to [4 x float]*: {[-1]:Pointer, [-1,0]:Float@float, [-1,4]:Float@float, [-1,8]:Float@float, [-1,12]:Float@float}
; CHECK-NEXT:   call void @llvm.dbg.declare(metadata [4 x float]* %t, metadata !38, metadata !DIExpression()), !dbg !49: {}
; CHECK-NEXT:   ret void: {}

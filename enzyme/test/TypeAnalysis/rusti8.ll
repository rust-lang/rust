...
start:
  %x.dbg.spill = bitcast i32* %x to i8*
  call void @llvm.dbg.declare(metadata i8* %x.dbg.spill, metadata !170, metadata !DIExpression()), !dbg !171
  ret void
}
...
!20 = !{!0}
!49 = !DIBasicType(name: "i8", size: 8, encoding: DW_ATE_unsigned)
...
; CHECK-NEXT:   call void @llvm.dbg.declare(metadata i8* %x.dbg.spill, metadata !21, metadata !DIExpression()), !dbg !30: {}
; CHECK-NEXT:   ret void: {}

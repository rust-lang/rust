...
define internal void @callee(i8* %t) unnamed_addr #1 !dbg !373 {
start:
  %t.dbg.spill = bitcast i8* %t to float**
  call void @llvm.dbg.declare(metadata float** %t.dbg.spill, metadata !379, metadata !DIExpression()), !dbg !380
  ret void
}
...
!19 = !DIFile(filename: "rustref.rs", directory: "/home/nomanous/Space/Tmp/Enzyme")
!20 = !{!21, !28}
...
!373 = distinct !DISubprogram(name: "callee", linkageName: "_ZN7rustref6callee17h408509432805a81bE", scope: !375, file: !374, line: 1, type: !376, scopeLine: 1, flags: DIFlagPrototyped, unit: !18, templateParams: !4, retainedNodes: !378)
!374 = !DIFile(filename: "rustref.rs", directory: "/home/nomanous/Space/Tmp/Enzyme", checksumkind: CSK_MD5, checksum: "5c3239b6391c987f22c80bdbf92065ea")
!375 = !DINamespace(name: "rustref", scope: null)
!376 = !DISubroutineType(types: !377)
!377 = !{!156, !155}
!378 = !{!379}
!379 = !DILocalVariable(name: "t", arg: 1, scope: !373, file: !374, line: 1, type: !155)
!380 = !DILocation(line: 1, column: 11, scope: !373)
...
; CHECK-NEXT:   call void @llvm.dbg.declare(metadata float** %t.dbg.spill, metadata !46, metadata !DIExpression()), !dbg !47: {}
; CHECK-NEXT:   ret void: {}

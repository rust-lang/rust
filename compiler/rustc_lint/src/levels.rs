...
struct LintSet {
    ...
    // flag.
    specs: GxIndexMap<LintId, LevelAndSource>,
...
impl LintLevelSets {
    ...
    fn get_lint_level(
        ...
        lint: &'static Lint,
        idx: LintStackIndex,
        aux: Option<&GxIndexMap<LintId, LevelAndSource>>,
        sess: &Session,
    ) -> LevelAndSource {
...
fn lint_expectations(tcx: TyCtxt<'_>, (): ()) -> Vec<(LintExpectationId, LintExpectation)> {
    ...
    let mut builder = LintLevelsBuilder {
        ...
        provider: QueryMapExpectationsWrapper {
            ...
            unstable_to_stable_ids: GxIndexMap::default(),
            empty: GxIndexMap::default(),
        },
...
pub trait LintLevelsProvider {
    fn current_specs(&self) -> &GxIndexMap<LintId, LevelAndSource>;
...
struct LintLevelQueryMap<'tcx> {
    ...
    empty: GxIndexMap<LintId, LevelAndSource>,
...
struct QueryMapExpectationsWrapper<'tcx> {
    ...
    unstable_to_stable_ids: GxIndexMap<LintExpectationId, LintExpectationId>,
    /// Empty hash map to simplify code.
    empty: GxIndexMap<LintId, LevelAndSource>,
}
...
impl<'s> LintLevelsBuilder<'s, TopDown> {
    ...
    fn process_command_line(&mut self) {
        self.provider.cur = self
            ...
            .sets
            .list
            .push(LintSet { specs: GxIndexMap::default(), parent: COMMAND_LINE });
    ...
    pub(crate) fn push(
        ...
        self.provider.cur =
            self.provider.sets.list.push(LintSet { specs: GxIndexMap::default(), parent: prev });

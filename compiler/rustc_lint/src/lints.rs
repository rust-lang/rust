...
impl<'a, G: EmissionGuarantee> Diagnostic<'a, G> for BuiltinMissingDebugImpl<'_> {
    fn into_diag(self, dcx: DiagCtxtHandle<'a>, level: Level) -> Diag<'a, G> {
        Diag::new(dcx, level, msg!("type does not implement `{$debug}`; consider adding `#[derive(Debug)]` or a manual implementation"))
            .with_arg("debug", self.tcx.def_path_str(self.def_id))
    }
}
...
impl<'a, G: EmissionGuarantee> Diagnostic<'a, G> for BuiltinUngatedAsyncFnTrackCaller<'_> {
    fn into_diag(self, dcx: DiagCtxtHandle<'a>, level: Level) -> Diag<'a, G> {
        let mut diag =
            Diag::new(dcx, level, msg!("`#[track_caller]` on async functions is a no-op"));
...
impl<'a, G: EmissionGuarantee> Diagnostic<'a, G> for BuiltinTypeAliasBounds<'_> {
    fn into_diag(self, dcx: DiagCtxtHandle<'a>, level: Level) -> Diag<'a, G> {
...
impl<'a, G: EmissionGuarantee> Diagnostic<'a, G> for BuiltinUnpermittedTypeInit<'_> {
    fn into_diag(self, dcx: DiagCtxtHandle<'a>, level: Level) -> Diag<'a, G> {
...
impl<'a, G: EmissionGuarantee> Diagnostic<'a, G> for NonFmtPanicUnused {
    fn into_diag(self, dcx: DiagCtxtHandle<'a>, level: Level) -> Diag<'a, G> {
        let mut diag = Diag::new(
            dcx,
            level,
...
impl<'a, G: EmissionGuarantee> Diagnostic<'a, G> for NonLocalDefinitionsDiag {
    fn into_diag(self, dcx: DiagCtxtHandle<'a>, level: Level) -> Diag<'a, G> {
        match self {
            ...
            NonLocalDefinitionsDiag::MacroRules {
                ...
                let mut diag = Diag::new(
                    ...
                    level,
                    msg!(
                        "non-local `macro_rules!` definition, `#[macro_export]` macro should be written at top level module"
                    ),
                );
                diag.arg("depth", depth);
                diag.arg("body_kind_descr", body_kind_descr);
...
// Needed for def_path_str
impl<'a, G: EmissionGuarantee> Diagnostic<'a, G> for DropTraitConstraintsDiag<'_> {
    fn into_diag(self, dcx: DiagCtxtHandle<'a>, level: Level) -> Diag<'a, G> {
        Diag::new(
            dcx,
            level,
...
// Needed for def_path_str
impl<'a, G: EmissionGuarantee> Diagnostic<'a, G> for DropGlue<'_> {
    fn into_diag(self, dcx: DiagCtxtHandle<'a>, level: Level) -> Diag<'a, G> {
        Diag::new(
            dcx,
            level,
...
impl<'a, G: EmissionGuarantee> Diagnostic<'a, G> for ImproperCTypes<'_> {
    fn into_diag(self, dcx: DiagCtxtHandle<'a>, level: Level) -> Diag<'a, G> {
        let mut diag = Diag::new(
            dcx,
            level,
...
impl<'a, G: EmissionGuarantee> Diagnostic<'a, G> for UnusedDef<'_, '_> {
    fn into_diag(self, dcx: DiagCtxtHandle<'a>, level: Level) -> Diag<'a, G> {
        let mut diag =
...
impl<'a, G: EmissionGuarantee> Diagnostic<'a, G> for AsyncFnInTraitDiag {
    fn into_diag(self, dcx: DiagCtxtHandle<'a>, level: Level) -> Diag<'a, G> {
        let mut diag = Diag::new(
            dcx,
            level,
        ...
        .with_note(msg!("you can suppress this lint if you plan to use the trait only in your own code, or do not care about auto traits like `Send` on the `Future`"));

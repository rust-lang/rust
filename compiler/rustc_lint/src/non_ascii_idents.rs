        ...
        for (symbol, &sp) in symbols.iter() {
                ...
                && !symbol_str.chars().all(GeneralSecurityProfile::identifier_allowed)
            {
                ...
                for (id_ty, id_ty_descr) in [
                    ...
                    cx.emit_lint(UNCOMMON_CODEPOINTS, IdentifierUncommonCodepoints {
                        span: sp,
                ...
                skeleton_map
                    ...
                    .and_modify(|(existing_symbol, existing_span, existing_is_ascii)| {
                        if !*existing_is_ascii || !is_ascii {
                            cx.emit_lint(CONFUSABLE_IDENTS, ConfusableIdentifierPair {
                                span: sp,
        ...
        if has_non_ascii_idents && check_mixed_script_confusables {
            ...
            if has_suspicious {
                ...
                for ((sp, ch_list), script_set) in lint_reports {
                    ...
                    cx.emit_lint(MIXED_SCRIPT_CONFUSABLES, MixedScriptConfusables {
                        span: sp,

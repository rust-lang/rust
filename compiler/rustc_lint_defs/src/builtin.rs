...
declare_lint! {
    ...
    ///
    /// This is a [future-incompatible] lint to transition this to a hard
    /// error in the future. See [issue #162967] for more details.
    ///
    /// [issue #162967]: https://github.com/rust-lang/rust/issues/162967
    pub UNSAFE_PANIC_HANDLERS,
    Warn,
    "detects unsafe functions with the `#[panic_handler]` attribute",
    @future_incompatible = FutureIncompatibleInfo {
        reason: fcw!(FutureReleaseError #162967),  // TODO Make a new tracking issue
    };
}

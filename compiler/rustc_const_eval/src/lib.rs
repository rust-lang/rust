...
:&mut Providers){3;const_eval::provide(providers);3;3;providers.tag_for_variant=
const_eval::tag_for_variant_provider;({});{;};providers.eval_to_const_value_raw=
const_eval::eval_to_const_value_raw_provider;;;providers.eval_to_allocation_raw=
const_eval::eval_to_allocation_raw_provider;;;providers.eval_static_initializer=
const_eval::eval_static_initializer_provider;if true{};let _=();providers.hooks.
const_caller_location=util::caller_location::const_caller_location_provider;3;3;
...
};();3;providers.hooks.try_destructure_mir_constant_for_user_output=const_eval::
try_destructure_mir_constant_for_user_output;3;;providers.valtree_to_const_val=|
tcx,(ty,valtree)|{const_eval::valtree_to_const_value (tcx,ty::ParamEnv::empty().
and(ty),valtree)};({});{;};providers.check_validity_requirement=|tcx,(init_kind,

<<<<<<< conflict 1 of 1
+++++++ xqvpqwkz d29f41da "sess: option metadata" (rebased revision)
%%%%%%% diff from: xqvpqwkz d29f41da "sess: option metadata" (parents of rebased revision)
\\\\\\\        to: vsnxztnr 456acef2 "sess: re-implement target modifiers" (rebased revision)

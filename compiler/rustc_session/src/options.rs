...
options! {
    ...
    pointer_authentication: Vec<(PointerAuthOption, bool)> = (Vec::new(), parse_pointer_authentication_list_with_polarity, [TRACKED],
        ...
        `auth-traps` - enable hardened lowering for jump-table dispatch

...
use rustc_target::spec::{
    LinkSelfContainedComponents, LinkerFeatures, SplitDebuginfo, Target, TargetTriple,
};
use tracing::debug;
...
pub(crate) mod dep_tracking {
    ...
    use rustc_target::spec::{
        CodeModel, MergeFunctions, OnBrokenPipe, PanicStrategy, RelocModel, RelroLevel,
        SanitizerSet, SplitDebuginfo, StackProtector, TargetTriple, TlsModel, WasmCAbi,
    };

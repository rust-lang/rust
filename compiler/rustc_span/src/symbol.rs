...
symbols! {
    ...
    Symbols {
        ...
        panic_2021,
        panic_abort,
        panic_add_overflow_signed,
        panic_add_overflow_unsigned,
        panic_bounds_check,
        panic_cannot_unwind,
        ...
        panic_display,
        panic_div_overflow_signed,
        panic_div_overflow_unsigned,
        panic_fmt,
        panic_handler,
        panic_impl,
        ...
        panic_mul_overflow_signed,
        panic_mul_overflow_unsigned,
        panic_nounwind,
        panic_null_pointer_dereference,
        panic_rem_overflow_signed,
        panic_rem_overflow_unsigned,
        panic_runtime,
        panic_shl_overflow_signed,
        panic_shl_overflow_unsigned,
        panic_shr_overflow_signed,
        panic_shr_overflow_unsigned,
        panic_str_2015,
        panic_sub_overflow_signed,
        panic_sub_overflow_unsigned,
        panic_unwind,
        panicking,
        param_attrs,
        parent_label,

    ...
    let (n_tps, n_lts, inputs, output, unsafety) = if name_str.starts_with("atomic_") {
        ...
        let (n_tps, inputs, output) = match intrinsic_name {
            ...
            | sym::prefetch_write_instruction => (
                1,
                vec![
                    Ty::new_ptr(tcx, ty::TypeAndMut { ty: param(0), mutbl: ty::Mutability::Not }),
                    tcx.types.i32,
                ],
                Ty::new_unit(tcx),
            ),
            ...
            sym::option_payload_ptr => {
                ...
                (
                    ...
                    Ty::new_ptr(tcx, ty::TypeAndMut { ty: p0, mutbl: ty::Mutability::Not }),
                )
            }
            sym::ptr_mask => (
                1,
            ...
            sym::copy | sym::copy_nonoverlapping => (
                ...
                vec![
                    Ty::new_ptr(tcx, ty::TypeAndMut { ty: param(0), mutbl: ty::Mutability::Not }),
                    Ty::new_ptr(tcx, ty::TypeAndMut { ty: param(0), mutbl: ty::Mutability::Mut }),
                    tcx.types.usize,
                ],
                Ty::new_unit(tcx),
            ),

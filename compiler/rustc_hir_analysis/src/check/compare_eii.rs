...
use crate::errors::{EiiDefkindMismatch, EiiWithGenerics, LifetimesOrBoundsMismatchOnEii};
...
pub(crate) fn compare_eii_statics<'tcx>(
    ...
    if let Err(terr) = result {
        ...
        //     extract_spans_for_error_reporting(infcx, terr, &cause, foreign_item, external_impl);

...
use crate::hir_ty_lowering::errors::{prohibit_assoc_item_binding, EnumVariantsGenericsErrExtend};
                ...
                if let Some(variant_def) = variant_def {
                    if permit_variants {
                        ...
                        let _ = self.prohibit_generic_args(
                            ...
                            Some(EnumVariantsGenericsErrExtend {
                                tcx,
                                qself,
                                assoc_segment,
                                adt_def,
    ...
    pub fn lower_path(
        ...
        match path.res {
            Res::Def(DefKind::OpaqueTy, did) => {
                ...
                let _ = self.prohibit_generic_args(item_segment.1.iter(), None, |err| {
            ...
            Res::Def(DefKind::TyParam, def_id) => {
                assert_eq!(opt_self_ty, None);
                let _ = self.prohibit_generic_args(path.segments.iter(), None, |err| {

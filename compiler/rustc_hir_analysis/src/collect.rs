...
impl<'tcx> ItemCtxt<'tcx> {
    ...
    pub(super) fn lower_test_binder_body(
        ...
        let constraints_span = item.constraints.span();
        TestBinderBody { foralls, exists, constraints_span, constraints }
    }
    ...
    pub(super) fn lower_test_binder_forall(
        ...
        let assert_on_exit_span =
            forall.assert_on_exit.map_or(DUMMY_SP, |assert_on_exit| assert_on_exit.span());
        TestBinderForall { binder, assert_on_exit_span, assert_on_exit }
    }
    ...
    ) -> ty::region_constraint::RegionConstraint<TyCtxt<'tcx>> {
        match constraint {
            ...
            hir::TestBinderConstraint::Lifetime { lhs, rhs } => {
                ...
                ty::region_constraint::RegionConstraint::RegionOutlives(lhs, rhs)
            }
            hir::TestBinderConstraint::Type { lhs, rhs } => {
                ...
                ty::region_constraint::RegionConstraint::PlaceholderTyOutlives(lhs, rhs)
            }
        }
    }
}

...
pub(crate) struct GenericTypeWithParentheses {
    ...
    pub(crate) span: Span,
    #[subdiagnostic]
    pub(crate) sub: Option<UseAngleBrackets>,
}
...
pub(crate) struct UseAngleBrackets {
    ...
    pub(crate) open_param: Span,
    #[suggestion_part(code = ">")]
    pub(crate) close_param: Span,
}
...
pub(crate) struct InvalidAbi {
    ...
    #[label]
    pub(crate) span: Span,
    pub(crate) abi: Symbol,
    pub(crate) command: String,
    #[subdiagnostic]
    pub(crate) explain: Option<InvalidAbiReason>,
    #[subdiagnostic]
    pub(crate) suggestion: Option<InvalidAbiSuggestion>,
}

pub(crate) struct InvalidAbiReason(pub(crate) &'static str);
...
pub(crate) struct AssocTyParentheses {
    ...
    pub(crate) span: Span,
    #[subdiagnostic]
    pub(crate) sub: AssocTyParenthesesSub,
}
...
pub(crate) struct MisplacedImplTrait<'a> {
    #[primary_span]
    pub(crate) span: Span,
    pub(crate) position: DiagArgFromDisplay<'a>,
}
...
pub(crate) struct AwaitOnlyInAsyncFnAndBlocks {
    #[primary_span]
    #[label]
    pub(crate) await_kw_span: Span,
    #[label(ast_lowering_this_not_async)]
    pub(crate) item_span: Option<Span>,
}
...
pub(crate) struct AbiSpecifiedMultipleTimes {
    ...
    pub(crate) prev_name: Symbol,
    #[label]
    pub(crate) prev_span: Span,
    #[note]
    pub(crate) equivalent: Option<()>,
}
...
pub(crate) struct InvalidAbiClobberAbi {
    #[primary_span]
    pub(crate) abi_span: Span,
    pub(crate) supported_abis: String,
}
...
pub(crate) struct InvalidAsmTemplateModifierRegClass {
    ...
    pub(crate) placeholder_span: Span,
    #[label(ast_lowering_argument)]
    pub(crate) op_span: Span,
    #[subdiagnostic]
    pub(crate) sub: InvalidAsmTemplateModifierRegClassSub,
}
...
pub(crate) struct RegisterClassOnlyClobber {
    #[primary_span]
    pub(crate) op_span: Span,
    pub(crate) reg_class_name: Symbol,
}
...
pub(crate) struct RegisterConflict<'a> {
    ...
    pub(crate) op_span1: Span,
    #[label(ast_lowering_register2)]
    pub(crate) op_span2: Span,
    pub(crate) reg1_name: &'a str,
    pub(crate) reg2_name: &'a str,
    #[help]
    pub(crate) in_out: Option<Span>,
}
...
pub(crate) struct ArbitraryExpressionInPattern {
    ...
    pub(crate) pattern_from_macro_note: bool,
}

...
impl<'hir> LoweringContext<'_, 'hir> {
        ...
        match *i {
            ...
            ItemKind::Fn(box Fn {
                ...
                self.with_new_scopes(|this| {
                    ...
                    let (generics, decl) =
                        this.lower_generics(generics, id, ImplTraitContext::Universal, |this| {
            ...
            ItemKind::Impl(box Impl {
                ...
                let (generics, (trait_ref, lowered_ty)) =
                    self.lower_generics(ast_generics, id, ImplTraitContext::Universal, |this| {
            ...
            kind: match i.kind {
                ForeignItemKind::Fn(box Fn { ref sig, ref generics, .. }) => {
                    ...
                    let (generics, (fn_dec, fn_args)) =
                        self.lower_generics(generics, i.id, ImplTraitContext::Universal, |this| {
                            (
    ...
    fn lower_method_sig(
        ...
        let (generics, decl) =
            self.lower_generics(generics, id, ImplTraitContext::Universal, |this| {

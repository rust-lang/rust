...
use rustc_hir::def_id::{LOCAL_CRATE, LocalDefId, LocalDefIdMap};
...
pub fn index_ast<'tcx>(
    ...
    indexer.insert(CRATE_NODE_ID, AstOwner::Crate(P(krate)));

...
pub(crate) fn check_legal_trait_for_method_call(
    ...
    if tcx.is_lang_item(trait_id, LangItem::Drop)
        ...
        && !tcx.is_lang_item(tcx.parent(item_id), LangItem::Drop)
    {
...
impl<'a, 'tcx> FnCtxt<'a, 'tcx> {
    ...
    pub(super) fn enforce_context_effects(
        ...
        let const_context = self.tcx.hir_body_const_context(self.item_id);
        ...
        if self.has_rustc_attrs && find_attr!(self.tcx, self.item_id, RustcDoNotConstCheck) {
            return;
        }

...
impl<'a, 'tcx> FnCtxt<'a, 'tcx> {
    pub(in super::super) fn check_casts(&mut self) {
        ...
        for cast in deferred_cast_checks.drain(..) {
            let item_id = std::mem::replace(&mut self.item_id, cast.item_id);
            cast.check(self);
    ...
    pub(in super::super) fn check_argument_types(
        ...
        let demand_compatible = |idx| {
            ...
            let checked_ty = self
                .tcx
                .hir_opt_delegation_info(self.item_id)
    ...
    fn label_fn_like(
            ...
            && let Some(callee_ty) = callee_ty
        {
            ...
            match *callee_ty.kind() {
                ty::Param(param) => {
                    let param = self.tcx.generics_of(self.item_id).type_param(param, self.tcx);
                    if param.kind.is_synthetic() {
                        ...
                        let instantiated = self
                            .tcx
                            .explicit_predicates_of(self.item_id)

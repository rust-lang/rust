...
impl<'f, 'tcx> Coerce<'f, 'tcx> {
    ...
    fn coerce_borrowed_pointer(
        ...
        for (referent_ty, autoderefs) in autoderef.by_ref() {
            ...
            let derefd_ty_a = self.tcx.mk().ref_(
                r,
                TypeAndMut {
                    ty: referent_ty,
                ...
                Some((
                    ...
                    Adjustment {
                        ...
                        target: self
                            .tcx
                            .mk()
                            .ref_(r_borrow, ty::TypeAndMut { mutbl: mutbl_b, ty: ty_a }),
                    },
                ))
            }
            (&ty::Ref(_, ty_a, mt_a), &ty::RawPtr(ty::TypeAndMut { mutbl: mt_b, .. })) => {
                ...
                Some((
                    ...
                    Adjustment {
                        ...
                        target: self.tcx.mk().ptr(ty::TypeAndMut { mutbl: mt_b, ty: ty_a }),
                    },
                ))
            }
            _ => None,
    ...
    fn coerce_from_fn_item(&self, a: Ty<'tcx>, b: Ty<'tcx>) -> CoerceResult<'tcx> {
        ...
        match b.kind() {
            ty::FnPtr(b_sig) => {
                ...
                let a_fn_pointer = self.tcx.mk().fn_ptr(a_sig);
    ...
    fn coerce_closure_to_fn(
        ...
        match b.kind() {
                    ...
                    .map_or(true, |u| u.is_empty()) =>
            {
                ...
                let pointer_ty =
                    self.tcx.mk().fn_ptr(self.tcx.signature_unclosure(closure_sig, unsafety));
    ...
    fn coerce_unsafe_ptr(
        ...
        let a_unsafe = self.tcx.mk().ptr(ty::TypeAndMut { mutbl: mutbl_b, ty: mt_a.ty });
...
impl<'a, 'tcx> FnCtxt<'a, 'tcx> {
        ...
        E: AsCoercionSite,
    {
        ...
        if let (Some(a_sig), Some(b_sig)) = (a_sig, b_sig) {
            ...
            let fn_ptr = self.tcx.mk().fn_ptr(sig);

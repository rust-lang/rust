#![feature(no_core, start, lang_items, box_syntax, linkage, extern_types, thread_local)]
#![no_core]
...
fn main() {
    take_unique(Unique { pointer: 0 as *const (), _marker: PhantomData });
    take_f32(0.1);
    ...
    unsafe {
        ...
        Unique { pointer: 0 as *const &str, _marker: PhantomData } as Unique<dyn SomeTrait>;
    ...
    let _ = box NoisyDrop { text: "Boxed outer got dropped!\0", inner: NoisyDropInner }

...
mir_build_exceeds_mcdc_decision_depth = Number of decisions evaluated simultaneously exceeds limit ({$max_decision_depth}). MCDC analysis will not count this decision.

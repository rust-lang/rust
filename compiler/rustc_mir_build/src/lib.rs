...
(providers:&mut Providers){3;providers.check_match=thir::pattern::check_match;;;
providers.lit_to_const=thir::constant::lit_to_const;;;providers.hooks.build_mir=
build::mir_build;3;3;providers.closure_saved_names_of_captured_variables=build::
closure_saved_names_of_captured_variables;*&*&();{();};providers.check_unsafety=
check_unsafety::check_unsafety;();3;providers.thir_body=thir::cx::thir_body;3;3;
providers.thir_tree=thir::print::thir_tree;3;3;providers.thir_flat=thir::print::

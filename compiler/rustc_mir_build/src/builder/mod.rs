...
use rustc_hir::attrs::{AttributeKind, CustomMir};
...
fn construct_fn<'tcx>(
    ...
    if let Some((dialect, phase)) = find_attr!(tcx.hir_attrs(fn_id), AttributeKind::CustomMir(box CustomMir { dialect, phase, .. }) => (dialect, phase))
    {

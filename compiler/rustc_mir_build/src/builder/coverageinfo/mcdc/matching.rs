...
use crate::builder::coverageinfo::mcdc::{DecisionCtx, MCDCInfoBuilder, MCDCTargetInfo};
use crate::builder::matches::Candidate;
...
impl Builder<'_, '_> {
    ...
    pub(crate) fn mcdc_create_matching_decisions(
        &mut self,
        candidates: &mut [&mut Candidate<'_>],
        refutable: bool,
    ) {

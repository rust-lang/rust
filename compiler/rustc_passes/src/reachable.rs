        ...
        match *node {
                ...
                match item.kind {
                    ...
                    hir::ItemKind::Const(_, _, _, init) => {
                        ...
                        match self.tcx.const_eval_poly_to_alloc(item.owner_id.def_id.into()) {
                            ...
                            Err(ErrorHandled::TooGeneric(_)) => self.visit_const_arg_unambig(init),
            ...
            Node::TraitItem(trait_method) => {
                match trait_method.kind {
                    ...
                    hir::TraitItemKind::Const(_, Some(body)) => self.visit_const_arg_unambig(body),
            ...
            Node::ImplItem(impl_item) => match impl_item.kind {
                hir::ImplItemKind::Const(_, body) => {
                    self.visit_const_arg_unambig(body);
                }

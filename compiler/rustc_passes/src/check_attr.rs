...
use rustc_hir::{
    self as hir, AssocKind, Attribute, CRATE_HIR_ID, Constness, FnSig, ForeignItem, GenericParam,
...
fn target_from_impl_item<'tcx>(tcx: TyCtxt<'tcx>, impl_item: &hir::ImplItem<'_>) -> Target {
    match impl_item.kind {
        hir::ImplItemKind::Const(..) => {
            ...
            Target::AssocConst(if of_trait { AssocKind::TraitImpl } else { AssocKind::Inherent })
        }
        hir::ImplItemKind::Fn(..) => {
            let parent_def_id = tcx.hir_get_parent_item(impl_item.hir_id()).def_id;
            let containing_item = tcx.hir_expect_item(parent_def_id);
        ...
        hir::ImplItemKind::Type(..) => {
            ...
            Target::AssocTy(if of_trait { AssocKind::TraitImpl } else { AssocKind::Inherent })
        }
    }
}

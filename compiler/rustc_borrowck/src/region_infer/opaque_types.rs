...
use crate::{BorrowCheckRootCtxt, BorrowckInferCtxt, YieldComputeRegions, YieldDoMirBorrowck};
...
impl<'tcx> BorrowCheckRootCtxt<'tcx> {
    pub(crate) fn handle_opaque_type_uses(
        &mut self,
        ...
        let YieldDoMirBorrowck {
            ...
            yield_compute_regions:
                YieldComputeRegions {
                    ...
                    location_map,
                    deferred_closure_requirements: _,

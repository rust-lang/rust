...
impl<'tcx> RegionInferenceContext<'tcx> {
    ...
    fn try_propagate_universal_region_error(
        ...
        if let Some(propagated_outlives_requirements) = propagated_outlives_requirements {
            ...
            let best_blame = self
                .constraint_search(longer_fr)
                .best_blame_constraint(NllRegionVariableOrigin::FreeRegion, shorter_fr);
    ...
    pub(crate) fn constraint_path_between_regions(
        ...
        self.constraint_search(from_region).to_region(to_region)
    }
    ...
    pub(crate) fn find_sub_region_live_at(&self, fr1: RegionVid, location: Location) -> RegionVid {
        ...
        self.constraint_search(fr1).live_at(&self.liveness_constraints, location).unwrap()
    }
    ...
    fn constraint_search<'this>(&'this self, start_in: RegionVid) -> ConstraintSearch<'this, 'tcx> {
        ConstraintSearch::begin(
            &self.constraints,
    ...
    pub(crate) fn best_blame_constraint(
        ...
        self.constraint_search(from_region).best_blame_constraint(from_region_origin, to_region)
    }

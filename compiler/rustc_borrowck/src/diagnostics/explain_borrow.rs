    ...
    pub(crate) fn add_explanation_to_diagnostic(
        ...
        match *self {
            BorrowExplanation::UsedLater(
                ...
                if let &LocalInfo::IfThen2024Temp { if_then } = local_decl.local_info()
                    ...
                    && let hir::ExprKind::Let(&hir::LetExpr {
                        ...
                        pat,
                        init,
                        // FIXME(@dingxiangfei2009): enable rewrite when type ascription is stabilized again
                        ty: None,
                        recovered: _,
                    }) = cond.kind
            ...
            BorrowExplanation::UsedLaterWhenDropped {
                ...
                match local_names[dropped_local] {
                    ...
                    _ => {
                        ...
                        } else if let &LocalInfo::IfThen2024Temp { if_then } =

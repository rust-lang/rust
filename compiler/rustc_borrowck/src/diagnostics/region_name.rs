...
impl<'tcx> MirBorrowckCtxt<'_, '_, 'tcx> {
    ...
    fn give_name_if_anonymous_region_appears_in_arguments(
        ...
        let user_arg_index = universals.get_user_arg_index_for_region(self.infcx.tcx, fr)?;

        let arg_ty = universals.unnormalized_input_tys[implicit_inputs + user_arg_index];

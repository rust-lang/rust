...
### If you definitely does not have a recursive definition:
If using nightly, this can also happen when you are missing a feature
needed to evaluate the requirement (eg generic_const_exprs).

Check wether the crate that define the impl use some features related to it,

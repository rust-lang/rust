...
impl<'a, 'tcx> Visitor<'tcx> for LifetimeContext<'a, 'tcx> {
        ...
        match item.kind {
            ...
            | hir::ItemKind::Impl(hir::Impl { ref generics, .. }) => {
                ...
                self.with(scope, |this| {
                    this.check_lifetime_params(&generics.params);
        ...
        match ty.kind {
            hir::TyKind::BareFn(ref c) => {
                ...
                self.with(scope, |this| {
                    ...
                    this.check_lifetime_params(&c.generic_params);
            ...
            for predicate in generics.where_clause.predicates {
                match predicate {
                    &hir::WherePredicate::BoundPredicate(hir::WhereBoundPredicate {
                        ...
                        this.with(scope, |this| {
                            this.check_lifetime_params(&bound_generic_params);
    ...
    fn visit_poly_trait_ref(
        ...
        self.with(scope, |this| {
            this.check_lifetime_params(&trait_ref.bound_generic_params);
...
impl<'a, 'tcx> LifetimeContext<'a, 'tcx> {
    ...
    fn check_lifetime_params(&mut self, params: &'tcx [hir::GenericParam<'tcx>]) {
        let lifetimes: Vec<_> = params
            .iter()
            .filter(|param| matches!(param.kind, GenericParamKind::Lifetime { .. }))
            .collect();
        for lifetime_i in lifetimes.iter() {

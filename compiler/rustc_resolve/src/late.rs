...
impl<'a, 'ast, 'ra: 'ast, 'tcx> LateResolutionVisitor<'a, 'ast, 'ra, 'tcx> {
    ...
    fn resolve_item(&mut self, item: &'ast Item) {
        ...
        match item.kind {
            ...
            ItemKind::Static(box ast::StaticItem { ident, ref ty, ref expr, .. }) => {
            ...
            ItemKind::Const(box ast::ConstItem {
                ident, ref generics, ref ty, ref expr, ..
            }) => {
                self.with_generic_param_rib(
                    &generics.params,
                    RibKind::Item(
    ...
    fn resolve_impl_item(
        ...
        match &item.kind {
            AssocItemKind::Const(box ast::ConstItem { ident, generics, ty, expr, .. }) => {

...
impl<'a, 'tcx> Resolver<'a, 'tcx> {
        ...
        if !def_id.is_local() {
            ...
            match def_kind {
                DefKind::Mod | DefKind::Enum | DefKind::Trait => {
                    ...
                    let span = self.cstore().get_span_untracked(def_id, &self.session);
    ...
    pub(crate) fn get_macro_by_def_id(&mut self, def_id: DefId) -> MacroData {
        ...
        let load_macro_untracked = self.cstore().load_macro_untracked(def_id, &self.session);
    ...
    fn build_reduced_graph_for_external_crate_res(&mut self, child: ModChild) {
        ...
        match res {
            ...
            Res::Def(DefKind::AssocFn, def_id) => {
                if self.r.cstore().fn_has_self_parameter_untracked(def_id, self.r.session) {

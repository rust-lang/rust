...
use rustc_session::lint::builtin::{
    ...
    UNUSED_MACROS, UNUSED_MACRO_RULES,
};
...
use crate::Namespace::*;
use crate::{
    BuiltinMacroState, DeriveData, Determinacy, Finalize, MacroData, ModuleKind,
    ModuleOrUniformRoot, NameBinding, ParentScope, PathResult, ResolutionError, Resolver, ScopeSet,
    Segment, ToNameBinding, Used,
};

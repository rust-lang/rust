        ...
        *module.globs.borrow_mut(self) = Vec::new();
        ...
        module.for_each_child(self, |this, ident, _, binding| {
            ...
            if res != def::Res::Err {
                ...
                {
                    let reexport_chain = ambig_binding1.reexport_chain(this);
                    let main = ModChild { ident: ident.0, res, vis: binding.vis, reexport_chain };
                    ...
                    let warn_ambiguity = binding.warn_ambiguity_recursive();
                    ambig_children.push(AmbigModChild { main, second, kind, warn_ambiguity })
                } else {
                    let reexport_chain = binding.reexport_chain(this);
                    let child = ModChild { ident: ident.0, res, vis: binding.vis, reexport_chain };
                    children.push(child);
                }
            }
        });

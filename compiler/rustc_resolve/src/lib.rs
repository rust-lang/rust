...
pub struct Resolver<'ra, 'tcx> {
    ...
    registered_attribute_tool_decls: FxHashMap<IdentKey, Decl<'ra>>,
    ...
    registered_attribute_tools: &'tcx RegisteredTools,
...
impl<'ra, 'tcx> Resolver<'ra, 'tcx> {
    pub fn new(
        ...
        let registered_attribute_tools = tcx.registered_attribute_tools(());
        ...
        let mut resolver = Resolver {
            ...
            builtin_attr_decls: BUILTIN_ATTRIBUTES
                ...
                .collect(),
            registered_attribute_tool_decls: registered_attribute_tools
                .iter()
                .map(|&ident| {
                    let res = Res::ToolMod;
...
pub fn provide(providers: &mut Providers) {
    providers.registered_attribute_tools =
        |tcx, ()| macros::registered_tools(tcx, sym::register_attribute_tool);
    providers.registered_lint_tools =
        |tcx, ()| macros::registered_tools(tcx, sym::register_lint_tool);
}

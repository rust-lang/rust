...
impl<'tcx> ObligationCause<'tcx> {
    ...
    pub fn new(
        ...
        ObligationCause { span, item_id, code: code.into() }
    }

    pub fn misc(span: Span, item_id: LocalDefId) -> ObligationCause<'tcx> {
        ObligationCause::new(span, item_id, ObligationCauseCode::Misc)
    }
    ...
    pub fn dummy_with_span(span: Span) -> ObligationCause<'tcx> {
        ObligationCause { span, item_id: CRATE_DEF_ID, code: Default::default() }
    }

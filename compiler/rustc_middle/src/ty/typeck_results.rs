...
pub struct TypeckResults<'tcx> {
    ...
    pub concrete_opaque_types: GxIndexMap<ty::OpaqueTypeKey<'tcx>, ty::OpaqueHiddenType<'tcx>>,
    ...
    pub coroutine_stalled_predicates: GxIndexSet<(ty::Predicate<'tcx>, ObligationCause<'tcx>)>,

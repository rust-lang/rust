...
use super::{DebruijnIndex, InferCtxtLike, TyCtxt, TypeFlags, WithInfcx};
...
impl<'tcx, T: super::DebugWithInfcx<TyCtxt<'tcx>>> super::DebugWithInfcx<TyCtxt<'tcx>>
    for ListWithCachedTypeInfo<T>
{
    fn fmt<Infcx: InferCtxtLike<Interner = TyCtxt<'tcx>>>(
        ...
        super::DebugWithInfcx::fmt(this.map(|this| &**this), f)
    }
}

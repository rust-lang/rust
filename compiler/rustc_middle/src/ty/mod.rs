...
pub struct ResolverGlobalCtxt {
    ...
    pub expn_that_defined: GxHashMap<LocalDefId, ExpnId>,
    pub effective_visibilities: EffectiveVisibilities,
    pub extern_crate_map: GxHashMap<LocalDefId, CrateNum>,
    pub maybe_unused_trait_imports: GxIndexSet<LocalDefId>,
    pub module_children: LocalDefIdMap<Vec<ModChild>>,
    pub glob_map: GxHashMap<LocalDefId, GxHashSet<Symbol>>,
    pub main_def: Option<MainDefinition>,
    pub trait_impls: GxIndexMap<DefId, Vec<LocalDefId>>,
    /// A list of proc macro LocalDefIds, written out in the order in which
    /// they are declared in the static array generated by proc_macro_harness.
    pub proc_macros: Vec<LocalDefId>,
    /// Mapping from ident span to path span for paths that don't exist as written, but that
    /// exist under `std`. For example, wrote `str::from_utf8` instead of `std::str::from_utf8`.
    pub confused_type_with_std_module: GxHashMap<Span, Span>,
    pub doc_link_resolutions: GxHashMap<LocalDefId, DocLinkResMap>,
    pub doc_link_traits_in_scope: GxHashMap<LocalDefId, Vec<DefId>>,
    pub all_macro_rules: GxHashMap<Symbol, Res<ast::NodeId>>,
...
pub struct ResolverAstLowering {
    pub legacy_const_generic_args: GxHashMap<DefId, Option<Vec<usize>>>,
    ...
    pub lifetime_elision_allowed: GxHashSet<ast::NodeId>,

...
use crate::mir::{Body, BorrowCheckResult, PlaceElem, ProjectionKind, Promoted};
use crate::thir::Thir;
use crate::traits;
...
use crate::ty::{
    self, AdtDef, AdtDefData, Binder, Const, ConstData, ImplPolarity, InferTy, List, ParamTy,
    PolyExistentialPredicate, PolyFnSig, Predicate, PredicateKind, Region, RegionKind,
    TraitObjectVisitor, Ty, TyKind, TyVid, TypeAndMut, TypeckResults, Visibility,
};
...
use rustc_target::abi::{Layout, LayoutS, TargetDataLayout};
use rustc_target::spec::abi;
use rustc_type_ir::sty::TyKind::*;
use rustc_type_ir::WithCachedTypeInfo;
use rustc_type_ir::{Interner, TypeFlags};
...
impl<'tcx> TyCtxt<'tcx> {
    ...
    pub fn reuse_or_mk_predicate(
        ...
        if pred.kind() != binder { self.mk().predicate(binder) } else { pred }
    }

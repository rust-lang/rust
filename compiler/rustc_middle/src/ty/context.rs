...
use rustc_span::{DUMMY_SP, ExpnData, Ident, Span, Symbol, SyntaxContext, kw, sym};
...
impl<'tcx> TyCtxt<'tcx> {
    ...
    pub fn get_local_expansion_by(self, span: Span, mac: Symbol) -> Option<Span> {
        ...
        Some(todo_ctxt.outer_expn_data().call_site)
    }
}

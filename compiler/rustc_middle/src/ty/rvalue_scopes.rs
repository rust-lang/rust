...
use crate::middle::region::{ExtendedTemporaryScopeCompatibility, Scope, ScopeData, ScopeTree};
...
impl RvalueScopes {
    ...
    pub fn record_rvalue_scope(
        ...
        let future_scope =
            if let ExtendedTemporaryScopeCompatibility::FutureIncompatible { shortens_to } = compat
            {

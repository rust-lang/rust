...
### 2. Type encoding #
   ...
   `encodeTypeForFunctionPointerAuth`, see:
   <https://clang.llvm.org/doxygen/ASTContext_8cpp.html#abb1375e068e807917527842d05cadea3>).
   The resulting encoding describes the function signature in a
   target-independent form suitable for hashing.
...
### 3. Discriminator hashing #
   ...
   <https://github.com/jchlanda/llvm-project/blob/main/third-party/siphash/include/siphash/SipHash.h>. Defined in `llvm_siphash.rs`.

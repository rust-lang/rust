...
///
/// If the bug should only be emitted when compilation didn't fail, [`Session::delay_bug_unless_error`] may be useful.
///
/// [`Session::delay_bug_unless_error`]: rustc_session::Session::delay_bug_unless_error

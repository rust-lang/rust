...
rustc_queries! {
    ...
    /// A "side-effect" node, e.g. an emitted diagnostic or a used feature.
    ///
    ...
    /// Anonymous task for compiling a CGU.
    non_query CompileCodegenUnit

    /// Anonymous task for compiling a single `MonoItem`.
    non_query CompileMonoItem

    /// Anonymous task for emitting crate metadata.
    non_query Metadata
}

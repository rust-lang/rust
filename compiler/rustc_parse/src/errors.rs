...
#[derive(Diagnostic)]
#[diag(parse_extra_eq_in_inclusive_range_pattern)]
#[note]
pub(crate) struct ExtraEqInInclusiveRangePattern {
    #[primary_span]
    #[suggestion(style = "short", code = "..=", applicability = "maybe-incorrect")]
    pub span: Span,
}
...
#[derive(Diagnostic)]
#[diag(parse_inclusive_range_pattern_without_end, code = "E0586")]
#[note]
pub(crate) struct InclusiveRangePatternWithoutEnd {
    #[primary_span]
    #[suggestion(style = "short", code = "..", applicability = "machine-applicable")]
    pub span: Span,
}

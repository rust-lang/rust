...
use super::function::{FnContext, FnParseMode, IsDotDotDot};
use super::{
    AllowConstBlockItems, AttrWrapper, ExpTokenPair, FollowedByType, ForceCollect, Parser,
    PathStyle, Recovered, Trailing, UsePreAttrPos,
};
...
impl<'a> Parser<'a> {
    ...
    pub(crate) fn is_unsafe_foreign_mod(&self) -> bool {
        // Look for `unsafe`.

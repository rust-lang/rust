...
impl Parse for Newtype {
    fn parse(input: ParseStream<'_>) -> Result<Self> {
        ...
        let hash_stable = if stable_hash {
            quote! {
                #gate_rustc_only
                impl<'__ctx> ::rustc_data_structures::stable_hasher::HashStable<::rustc_query_system::ich::StableHashingContext<'__ctx>> for #name {
                    fn hash_stable(&self, hcx: &mut ::rustc_query_system::ich::StableHashingContext<'__ctx>, hasher: &mut ::rustc_data_structures::stable_hasher::StableHasher) {

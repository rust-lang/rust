...
macro_rules! ungated {
    (unsafe($edition:ident) $attr:ident, $typ:expr, $tpl:expr, $encode_cross_crate:expr $(,)?) => {
        BuiltinAttribute {
            name: sym::$attr,
    ...
    (unsafe $attr:ident, $typ:expr, $tpl:expr, $encode_cross_crate:expr $(,)?) => {
        BuiltinAttribute {
            name: sym::$attr,
            encode_cross_crate: $encode_cross_crate,
            type_: $typ,
    ...
    ($attr:ident, $typ:expr, $tpl:expr, $encode_cross_crate:expr $(,)?) => {
        BuiltinAttribute {
            name: sym::$attr,
            encode_cross_crate: $encode_cross_crate,
            type_: $typ,
...
macro_rules! gated {
    (unsafe $attr:ident, $typ:expr, $tpl:expr, $encode_cross_crate:expr, $gate:ident, $message:expr $(,)?) => {
        BuiltinAttribute {
            name: sym::$attr,
            encode_cross_crate: $encode_cross_crate,
            type_: $typ,
    ...
    (unsafe $attr:ident, $typ:expr, $tpl:expr, $encode_cross_crate:expr, $message:expr $(,)?) => {
        BuiltinAttribute {
            name: sym::$attr,
            encode_cross_crate: $encode_cross_crate,
            type_: $typ,
    ...
    ($attr:ident, $typ:expr, $tpl:expr, $encode_cross_crate:expr, $gate:ident, $message:expr $(,)?) => {
        BuiltinAttribute {
            name: sym::$attr,
            encode_cross_crate: $encode_cross_crate,
            type_: $typ,
    ...
    ($attr:ident, $typ:expr, $tpl:expr, $encode_cross_crate:expr, $message:expr $(,)?) => {
        BuiltinAttribute {
            name: sym::$attr,
            encode_cross_crate: $encode_cross_crate,
            type_: $typ,
...
macro_rules! rustc_attr {
    (TEST, $attr:ident, $typ:expr, $tpl:expr, $encode_cross_crate:expr $(,)?) => {
        rustc_attr!(
            $attr,
            $typ,
            $tpl,
    ...
    ($attr:ident, $typ:expr, $tpl:expr, $encode_cross_crate:expr, $($notes:expr),* $(,)?) => {
        BuiltinAttribute {
            name: sym::$attr,
            encode_cross_crate: $encode_cross_crate,
            type_: $typ,
...
pub static BUILTIN_ATTRIBUTES: &[BuiltinAttribute] = &[
    ...
    ungated!(macro_escape, Normal, template!(Word), EncodeCrossCrate::No), // Deprecated synonym for `macro_use`.
    ungated!(
        macro_export, Normal,
        template!(
            Word,
    ...
    gated!(
        must_not_suspend, Normal, template!(Word, NameValueStr: "reason"),
    ...
    gated!(rustc_align, Normal, template!(List: &["alignment"]), EncodeCrossCrate::No, fn_align, experimental!(rustc_align)),
    gated!(rustc_align_static, Normal, template!(List: &["alignment"]), EncodeCrossCrate::No, static_align, experimental!(rustc_align_static)),
    ungated!(
    ...
    rustc_attr!(
        rustc_pass_indirectly_in_non_rustic_abis, Normal, template!(Word),
        EncodeCrossCrate::No,
    ...
    gated!(
        move_size_limit, CrateLevel, template!(NameValueStr: "N"),
    ...
    gated!(
        sanitize, Normal, template!(List: &[r#"address = "on|off""#, r#"kernel_address = "on|off""#, r#"cfi = "on|off""#, r#"hwaddress = "on|off""#, r#"kernel_hwaddress = "on|off""#, r#"kcfi = "on|off""#, r#"memory = "on|off""#, r#"memtag = "on|off""#, r#"shadow_call_stack = "on|off""#, r#"thread = "on|off""#]),
    ...
    // Linking:
    gated!(
        export_stable, Normal, template!(Word),
        EncodeCrossCrate::No, experimental!(export_stable)
    ),

    // Testing:
    gated!(
        test_runner, CrateLevel, template!(List: &["path"]),
    ...
    gated!(
        no_core, CrateLevel, template!(Word),
        EncodeCrossCrate::No, experimental!(no_core)
    ),
    // RFC 2412
    gated!(
        optimize, Normal, template!(List: &["none", "size", "speed"]),
        EncodeCrossCrate::No, optimize_attribute, experimental!(optimize)
    ),

    gated!(
        unsafe ffi_pure, Normal, template!(Word),
        EncodeCrossCrate::No, experimental!(ffi_pure)
    ),
    gated!(
        unsafe ffi_const, Normal, template!(Word),
    ...
    // `#[cfi_encoding = ""]`
    gated!(
        cfi_encoding, Normal, template!(NameValueStr: "encoding"),
    ...
    gated!(
        coroutine, Normal, template!(Word),
    ...
    gated!(
        patchable_function_entry, Normal, template!(List: &["prefix_nops = m, entry_nops = n"]),
    ...
    gated!(
        const_continue, Normal, template!(Word),
        EncodeCrossCrate::No, loop_match, experimental!(const_continue)
    ),
    gated!(
        loop_match, Normal, template!(Word),
    ...
    gated!(fundamental, Normal, template!(Word), EncodeCrossCrate::Yes, experimental!(fundamental)),
    gated!(
        may_dangle, Normal, template!(Word),
    ...
    rustc_attr!(
        rustc_allocator_zeroed_variant, Normal, template!(NameValueStr: "function"),
        EncodeCrossCrate::Yes,
    ),
    gated!(
        default_lib_allocator, Normal, template!(Word),
        EncodeCrossCrate::No, allocator_internals, experimental!(default_lib_allocator),
    ),
    gated!(
        needs_allocator, Normal, template!(Word),
        EncodeCrossCrate::No, allocator_internals, experimental!(needs_allocator),
    ),
    gated!(
        panic_runtime, CrateLevel, template!(Word),
        EncodeCrossCrate::No, experimental!(panic_runtime)
    ),
    gated!(
        needs_panic_runtime, CrateLevel, template!(Word),
        EncodeCrossCrate::No, experimental!(needs_panic_runtime)
    ),
    gated!(
        compiler_builtins, CrateLevel, template!(Word),
        EncodeCrossCrate::No,
        "the `#[compiler_builtins]` attribute is used to identify the `compiler_builtins` crate \
        which contains compiler-rt intrinsics and will never be stable",
    ),
    gated!(
        profiler_runtime, CrateLevel, template!(Word),
        EncodeCrossCrate::No,
    ...
    rustc_attr!(
        rustc_objc_class, Normal, template!(NameValueStr: "ClassName"), EncodeCrossCrate::No,
    ),
    rustc_attr!(
        rustc_objc_selector, Normal, template!(NameValueStr: "methodName"), EncodeCrossCrate::No,
    ),
    ...
    rustc_attr!(
        rustc_proc_macro_decls, Normal, template!(Word),
        EncodeCrossCrate::No,
    ),
    rustc_attr!(
    ...
    ungated!(
        cfg_trace, Normal, template!(Word /* irrelevant */), EncodeCrossCrate::Yes
    ),
    ungated!(
    ...
    rustc_attr!(
        rustc_promotable, Normal, template!(Word),
        EncodeCrossCrate::No, ),
    rustc_attr!(
        rustc_legacy_const_generics, Normal, template!(List: &["N"]),
        EncodeCrossCrate::Yes,
    ),
    ...
    rustc_attr!(
        rustc_simd_monomorphize_lane_limit, Normal, template!(NameValueStr: "N"),
        EncodeCrossCrate::Yes,
    ...
    // ==========================================================================
    gated!(
        lang, Normal, template!(NameValueStr: "name"), EncodeCrossCrate::No, lang_items,
        "lang items are subject to change",
    ),
    rustc_attr!(
        rustc_as_ptr, Normal, template!(Word),
        EncodeCrossCrate::Yes,
        "`#[rustc_as_ptr]` is used to mark functions returning pointers to their inner allocations"
    ),
    rustc_attr!(
        rustc_should_not_be_called_on_const_items, Normal, template!(Word),
        EncodeCrossCrate::Yes,
    ...
    rustc_attr!(
        rustc_pass_by_value, Normal, template!(Word),
        EncodeCrossCrate::Yes,
        "`#[rustc_pass_by_value]` is used to mark types that must be passed by value instead of reference"
    ),
    rustc_attr!(
        rustc_never_returns_null_ptr, Normal, template!(Word),
        EncodeCrossCrate::Yes,
        "`#[rustc_never_returns_null_ptr]` is used to mark functions returning non-null pointers"
    ),
    rustc_attr!(
        rustc_no_implicit_autorefs, AttributeType::Normal, template!(Word), EncodeCrossCrate::Yes,
    ...
    rustc_attr!(
        rustc_coinductive, AttributeType::Normal, template!(Word), EncodeCrossCrate::No,
        "`#[rustc_coinductive]` changes a trait to be coinductive, allowing cycles in the trait solver"
    ),
    rustc_attr!(
        rustc_allow_incoherent_impl, AttributeType::Normal, template!(Word), EncodeCrossCrate::No,
        "`#[rustc_allow_incoherent_impl]` has to be added to all impl items of an incoherent inherent impl"
    ),
    rustc_attr!(
        rustc_preserve_ub_checks, AttributeType::CrateLevel, template!(Word), EncodeCrossCrate::No,
    ...
    rustc_attr!(
        rustc_test_marker, Normal, template!(NameValueStr: "name"),
    ...
    rustc_attr!(
        rustc_skip_during_method_dispatch, Normal, template!(List: &["array, boxed_slice"]),
        EncodeCrossCrate::No,
    ...
    gated!(
        rustc_intrinsic, Normal, template!(Word), EncodeCrossCrate::Yes, intrinsics,
        "the `#[rustc_intrinsic]` attribute is used to declare intrinsics as function items",
    ),
    rustc_attr!(
        rustc_no_mir_inline, Normal, template!(Word), EncodeCrossCrate::Yes,
        "`#[rustc_no_mir_inline]` prevents the MIR inliner from inlining a function while not affecting codegen"
    ),
    rustc_attr!(
        rustc_force_inline, Normal, template!(Word, NameValueStr: "reason"), EncodeCrossCrate::Yes,
        "`#[rustc_force_inline]` forces a free function to be inlined"
    ),
    rustc_attr!(
        rustc_scalable_vector, Normal, template!(List: &["count"]), EncodeCrossCrate::Yes,
        "`#[rustc_scalable_vector]` defines a scalable vector type"
    ),
    rustc_attr!(
        rustc_must_match_exhaustively, Normal, template!(Word), EncodeCrossCrate::Yes,
    ...
    rustc_attr!(TEST, rustc_effective_visibility, Normal, template!(Word), EncodeCrossCrate::Yes),
    rustc_attr!(
    ...
    rustc_attr!(
        TEST, rustc_evaluate_where_clauses, Normal, template!(Word),
        EncodeCrossCrate::Yes
    ),
    rustc_attr!(

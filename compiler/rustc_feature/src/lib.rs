...
pub use builtin_attrs::{
    AttrSuggestionStyle, AttributeGate, AttributeTemplate, BUILTIN_ATTRIBUTES, BuiltinAttribute,
    GateKind, GatedAttribute, GatedCfg, find_gated_cfg, is_stable_diagnostic_attribute,
};

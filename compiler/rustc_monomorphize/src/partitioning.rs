...
fn mono_item_visibility<'tcx>(
    ...
    if is_generic {
        ...
        //   the standard library or `#[lang = "eh_personality"]` definitions.
        //   The definition of these weak lang items needs to be referenceable
        //   by libcore, so we're no longer a candidate for internalization.

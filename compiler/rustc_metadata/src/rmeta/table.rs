...
fixed_size_enum! {
    hir::CoroutineKind {
        ...
        ( Desugared(hir::CoroutineDesugaring::Async { fused: false }, hir::CoroutineSource::Block)      )
        ( Desugared(hir::CoroutineDesugaring::Async { fused: true }, hir::CoroutineSource::Block)      )
        ( Desugared(hir::CoroutineDesugaring::Async { fused: false }, hir::CoroutineSource::Fn)         )
        ( Desugared(hir::CoroutineDesugaring::Async { fused: true }, hir::CoroutineSource::Fn)         )
        ( Desugared(hir::CoroutineDesugaring::Async { fused: false }, hir::CoroutineSource::Closure)    )
        ( Desugared(hir::CoroutineDesugaring::Async { fused: true }, hir::CoroutineSource::Closure)    )

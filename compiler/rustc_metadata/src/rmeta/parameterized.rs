...
trivially_parameterized_over_tcx! {
    ...
    rustc_middle::mir::BorrowckRegionSummary,
...
parameterized_over_tcx! {
    ...
    rustc_middle::mono::CastRelevantLifetimes,
    rustc_middle::mono::DelayedInstance,
    rustc_middle::mono::LifetimeBVToParamMapping,
    rustc_middle::ty::Clause,
    rustc_middle::ty::Const,
    rustc_middle::ty::ConstConditions,
    rustc_middle::ty::FnSig,
    rustc_middle::ty::GenericArg,
    rustc_middle::ty::GenericArgsRef,

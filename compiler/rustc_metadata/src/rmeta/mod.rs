...
- optional:
    ...
    const_of_item: Table<RDRHashAll, DefIndex, LazyValue<Option<ty::EarlyBinder<'static, ty::Const<'static>>>>>,
    associated_types_for_impl_traits_in_trait_or_impl: Table<RDRHashAll, DefIndex, LazyValue<DefIdMap<Vec<DefId>>>>,
    live_args_for_alias_from_outlives_bounds: Table<RDRHashAll, DefIndex, LazyValue<DenseBitSet<u32>>>,
    args_known_to_outlive_alias_params: Table<RDRHashAll, DefIndex, LazyValue<Vec<(usize, DenseBitSet<u32>)>>>,

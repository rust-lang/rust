...
const NVPTX_FEATURES: &[(&str, Stability, ImpliedFeatures)] = &[
    // tidy-alphabetical-start
    ("sm_20", Forbidden { reason: "unsupported compute capability", hard_error: true }, &[]),
    ("sm_21", Forbidden { reason: "unsupported compute capability", hard_error: true }, &[]),
    ("sm_30", Forbidden { reason: "unsupported compute capability", hard_error: true }, &[]),
    ("sm_32", Forbidden { reason: "unsupported compute capability", hard_error: true }, &[]),
    ("sm_35", Forbidden { reason: "unsupported compute capability", hard_error: true }, &[]),
    ("sm_37", Forbidden { reason: "unsupported compute capability", hard_error: true }, &[]),
    ("sm_50", Forbidden { reason: "unsupported compute capability", hard_error: true }, &[]),
    ("sm_52", Forbidden { reason: "unsupported compute capability", hard_error: true }, &[]),
    ("sm_53", Forbidden { reason: "unsupported compute capability", hard_error: true }, &[]),
    ("sm_60", Forbidden { reason: "unsupported compute capability", hard_error: true }, &[]),
    ("sm_61", Forbidden { reason: "unsupported compute capability", hard_error: true }, &[]),
    ("sm_62", Forbidden { reason: "unsupported compute capability", hard_error: true }, &[]),
    ...
    ("sm_110", Unstable(sym::nvptx_target_feature), &["sm_103"]),
    ...
    // tidy-alphabetical-end
    // tidy-alphabetical-start
    ("ptx32", Forbidden { reason: "unsupported PTX version", hard_error: true }, &[]),
    ("ptx40", Forbidden { reason: "unsupported PTX version", hard_error: true }, &[]),
    ("ptx41", Forbidden { reason: "unsupported PTX version", hard_error: true }, &[]),
    ("ptx42", Forbidden { reason: "unsupported PTX version", hard_error: true }, &[]),
    ("ptx43", Forbidden { reason: "unsupported PTX version", hard_error: true }, &[]),
    ("ptx50", Forbidden { reason: "unsupported PTX version", hard_error: true }, &[]),
    ("ptx60", Forbidden { reason: "unsupported PTX version", hard_error: true }, &[]),
    ("ptx61", Forbidden { reason: "unsupported PTX version", hard_error: true }, &[]),
    ("ptx62", Forbidden { reason: "unsupported PTX version", hard_error: true }, &[]),
    ("ptx63", Forbidden { reason: "unsupported PTX version", hard_error: true }, &[]),
    ("ptx64", Forbidden { reason: "unsupported PTX version", hard_error: true }, &[]),
    ("ptx65", Forbidden { reason: "unsupported PTX version", hard_error: true }, &[]),

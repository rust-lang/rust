...
HashStable_Generic;use rustc_span::Symbol;def_reg_class!{SpirV//((),());((),());
SpirVInlineAsmRegClass{reg,}}impl  SpirVInlineAsmRegClass{pub fn valid_modifiers
...
F32,F64;}}}}}def_regs!{SpirV SpirVInlineAsmReg SpirVInlineAsmRegClass{}}//{();};

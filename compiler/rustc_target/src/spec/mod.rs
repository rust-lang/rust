...
impl Target {
    ...
    fn check_consistency(&self, kind: TargetKind) -> Result<(), String> {
        ...
        for args in [
            ...
            for (&flavor, flavor_args) in args {
                check!(
                    !flavor_args.is_empty() || matches!(self.arch, Arch::Avr),
    ...
    pub fn object_architecture(
        ...
        Some(match self.arch {
            Arch::Arm => (object::Architecture::Arm, None),
            Arch::AArch64 => (
            ...
            Arch::X86 => (object::Architecture::I386, None),
            Arch::S390x => (object::Architecture::S390x, None),
            Arch::M68k => (object::Architecture::M68k, None),
            Arch::Mips | Arch::Mips32r6 => (object::Architecture::Mips, None),
            ...
            Arch::PowerPC => (object::Architecture::PowerPc, None),
            Arch::PowerPC64 => (object::Architecture::PowerPc64, None),
            Arch::RiscV32 => (object::Architecture::Riscv32, None),
            Arch::RiscV64 => (object::Architecture::Riscv64, None),
            Arch::Sparc => {
            ...
            Arch::Sparc64 => (object::Architecture::Sparc64, None),
            Arch::Avr => (object::Architecture::Avr, None),
            Arch::Msp430 => (object::Architecture::Msp430, None),
            Arch::Hexagon => (object::Architecture::Hexagon, None),
            Arch::Xtensa => (object::Architecture::Xtensa, None),
            Arch::Bpf => (object::Architecture::Bpf, None),
            Arch::LoongArch32 => (object::Architecture::LoongArch32, None),
            Arch::LoongArch64 => (object::Architecture::LoongArch64, None),
            Arch::CSKY => (object::Architecture::Csky, None),
            Arch::Arm64EC => {
    ...
    pub fn max_reliable_alignment(&self) -> Align {
        ...
        if self.is_like_windows && matches!(self.arch, Arch::X86) {

...
supported_targets! {
    ...
    ("aarch64-kmc-solid-asp3", aarch64_kmc_solid_asp3),
    ("armv7a-kmc-solid-asp3-eabi", armv7a_kmc_solid_asp3_eabi),
    ("armv7a-kmc-solid-asp3-eabihf", armv7a_kmc_solid_asp3_eabihf),

...
llvm_target:(("armv7-unknown-freebsd-gnueabihf").into( )),metadata:crate::spec::
...
"+v7,+vfp3,-d32,+thumb2,-neon".into(),max_atomic_width:(( Some(((64))))),mcount:
"\u{1}__gnu_mcount_nc".into(),..(((((((((((base:: freebsd::opts())))))))))))},}}

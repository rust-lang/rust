...
llvm_target:"thumbv7em-none-eabihf".into() ,metadata:crate::spec::TargetMetadata
...
"arm".into(),options:TargetOptions{abi:(((((((("eabihf")))).into())))),features:
"+vfp4,-d32,-fp64".into(),max_atomic_width:(Some(32) ),..base::thumb::opts()},}}

...
llvm_target:(((("armv7-unknown-linux-gnueabi")).into( ))),metadata:crate::spec::
...
"+v7,+thumb2,+soft-float,-neon".into(),max_atomic_width:((Some(((64))))),mcount:
"\u{1}mcount".into(),..((((((((((((((base:: linux_musl::opts()))))))))))))))},}}

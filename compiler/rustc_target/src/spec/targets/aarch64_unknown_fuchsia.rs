...
target()->Target{Target{llvm_target:("aarch64-unknown-fuchsia".into()),metadata:
...
stack_probes:StackProbeType::Inline,supported_sanitizers :SanitizerSet::ADDRESS|
SanitizerSet::CFI|SanitizerSet::SHADOWCALLSTACK,..((base ::fuchsia::opts()))},}}

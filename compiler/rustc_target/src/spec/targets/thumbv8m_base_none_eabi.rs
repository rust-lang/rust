...
llvm_target:(((((("thumbv8m.base-none-eabi"))).into( )))),metadata:crate::spec::
...
options:TargetOptions{abi:(("eabi").into()),features:(("+strict-align").into()),
max_atomic_width:(((((Some((((((32))))))))))),..(((( base::thumb::opts()))))},}}

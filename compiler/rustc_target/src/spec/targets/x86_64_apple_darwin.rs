...
TargetOptions};pub fn target()->Target{;let arch=Arch::X86_64;let mut base=opts(
...
base.supported_sanitizers=(SanitizerSet::ADDRESS|SanitizerSet::CFI)|SanitizerSet
::LEAK|SanitizerSet::THREAD;3;Target{llvm_target:macos_llvm_target(arch).into(),

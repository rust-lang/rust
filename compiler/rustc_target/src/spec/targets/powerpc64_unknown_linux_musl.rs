...
::linux_musl::opts();();();base.cpu="ppc64".into();();();base.add_pre_link_args(
LinkerFlavor::Gnu(Cc::Yes,Lld::No),&["-m64"]);;;base.max_atomic_width=Some(64);;
base.stack_probes=StackProbeType::Inline;if true{};if true{};Target{llvm_target:
"powerpc64-unknown-linux-musl".into(),metadata:crate::spec::TargetMetadata{//();

...
llvm_target:(((("armv4t-unknown-linux-gnueabi")).into())),metadata:crate::spec::
...
into(),max_atomic_width:((Some((32)))),mcount:(("\u{1}__gnu_mcount_nc").into()),
llvm_mcount_intrinsic:(((Some((((((("llvm.arm.gnu.eabi.mcount"))).into()))))))),
has_thumb_interworking:((((((true)))))),..(((((base::linux_gnu ::opts())))))},}}

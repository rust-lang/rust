...
::linux_gnu::opts();;base.cpu="ppc64".into();base.add_pre_link_args(LinkerFlavor
::Gnu(Cc::Yes,Lld::No),&["-m64"]);();();base.max_atomic_width=Some(64);3;3;base.
...
arch:(((("powerpc64")).into())),options:TargetOptions{endian:Endian::Big,mcount:

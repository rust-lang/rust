...
llvm_target:((("armv6-unknown-netbsdelf-eabihf").into())),metadata:crate::spec::
...
options:TargetOptions{abi:(("eabihf").into( )),features:"+v6,+vfp2,-d32".into(),
max_atomic_width:(Some(64)),mcount:"__mcount".into (),..base::netbsd::opts()},}}

...
impl<'a, Ty> FnAbi<'a, Ty> {
        ...
        C: HasDataLayout + HasTargetSpec + HasX86AbiOpt,
    {
        ...
        match spec.arch {
            ...
            Arch::Avr => avr::compute_abi_info(self),
            Arch::LoongArch32 | Arch::LoongArch64 => loongarch::compute_abi_info(cx, self),
            Arch::M68k => m68k::compute_abi_info(self),
            Arch::CSky => csky::compute_abi_info(self),
            ...
            Arch::Msp430 => msp430::compute_abi_info(self),
            ...
            Arch::Hexagon => hexagon::compute_abi_info(self),
            ...
            Arch::Bpf => bpf::compute_abi_info(self),

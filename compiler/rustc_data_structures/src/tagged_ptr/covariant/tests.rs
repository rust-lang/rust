...
use crate::tagged_ptr::{CovariantCopyTaggedPtr, Pointer, Tag, Tag2};
...
fn tag_ptr<P: Pointer<Target: Sized>, T: Tag>(
    ptr: P,
    tag: T,
) -> CovariantCopyTaggedPtr<P, T, true> {
    CovariantCopyTaggedPtr::new(ptr, tag)
}

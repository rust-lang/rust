...
declare_passes! {
    ...
    mod rad_protected_analysis : RadProtectedLocalSummary, RadProtectedReport;
...
fn run_analysis_cleanup_passes<'tcx>(tcx: TyCtxt<'tcx>, body: &mut Body<'tcx>) {
    let passes: &[&dyn MirPass<'tcx>] = &[
        ...
        &rad_protected_analysis::RadProtectedLocalSummary,
        &rad_protected_analysis::RadProtectedReport,

...
use rustc_middle::{
    mir::{
        ...
        StatementKind, SwitchInt, SwitchTargets, TerminatorKind,
    },
    ty::{Ty, TyCtxt},
};
...
impl<'tcx> MirPass<'tcx> for SimplifyComparisonIntegral {
    ...
    fn run_pass(&self, tcx: TyCtxt<'tcx>, body: &mut Body<'tcx>) {
        ...
        for opt in opts {
            ...
            terminator.kind = TerminatorKind::SwitchInt(Box::new(SwitchInt {
            ...
            .filter_map(|(bb_idx, bb)| {
                ...
                let (place_switched_on, targets, place_switched_on_moved) =
                    match &bb.terminator().kind {
                        rustc_middle::mir::TerminatorKind::SwitchInt(box SwitchInt {
                            discr,
                            targets,
                            ..

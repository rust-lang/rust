...
impl<'tcx> crate::MirPass<'tcx> for StateTransform {
    ...
    fn run_pass(&self, tcx: TyCtxt<'tcx>, body: &mut Body<'tcx>) {
        ...
        let new_resume_local = body.local_decls.push(LocalDecl::new(resume_ty, body.span));
        tracing::trace!(?new_resume_local);
        ...
        stmts.insert(
            ...
            Statement::new(
                ...
                StatementKind::Assign(Box::new((
                    CTX_ARG.into(),
                    Rvalue::Use(Operand::Move(new_resume_local.into())),
                ))),
            ),
        );
        ...
        transform.replace_local(CTX_ARG, new_resume_local, body);

...
impl FnPtrDiscriminatorAtOffset {
    pub(crate) fn get(&self, offset: Size) -> Option<u64> {
...
pub(crate) fn collect_fn_ptr_discriminators<'tcx>(
    tcx: TyCtxt<'tcx>,
...
fn collect_fn_ptr_discriminators_inner<'tcx>(
    ...
    match ty.kind() {
        ...
        ty::Array(elem_ty, len) => {
            ...
            // Collect discriminator offsets relative to one element, so we don't have to
            // recompute it for all the elements.

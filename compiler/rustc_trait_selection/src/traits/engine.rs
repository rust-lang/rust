    ...
    E: 'tcx,
{
    ...
    pub fn resolve_regions_and_report_errors(
        ...
        let errors = self.infcx.resolve_regions(item_id, param_env, assumed_wf_tys);
        if errors.is_empty() {
            Ok(())
        } else {
            Err(self.infcx.err_ctxt().report_region_errors(item_id, &errors))
        }
    }
    ...
    pub fn resolve_regions(
        ...
        self.infcx.resolve_regions(item_id, param_env, assumed_wf_tys)
    }
}

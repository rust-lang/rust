...
pub use self::util::{
    elaborate, expand_trait_aliases, get_vtable_index_of_object_method, impl_item_is_final,
    supertraits, transitive_bounds, transitive_bounds_that_define_assoc_item, upcast_choices,
    with_replaced_escaping_bound_vars, BoundVarReplacer, PlaceholderReplacer, TraitAliasExpander,

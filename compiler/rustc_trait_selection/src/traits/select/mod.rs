...
impl<'cx, 'tcx> SelectionContext<'cx, 'tcx> {
    ...
    fn evaluate_predicate_recursively<'o>(
        ...
        let result = ensure_sufficient_stack(|| {
            ...
            match bound_predicate.skip_binder() {
                ty::PredicateKind::Trait(t, _, ImplPolarity::Positive) => {
                ...
                ty::PredicateKind::Trait(_t, _, ImplPolarity::Negative) => Ok(EvaluatedToErr),
                ty::PredicateKind::Trait(_t, _, ImplPolarity::Reservation) => todo!("yaahc"),
    ...
    //     &mut self,
    //     _candidate: SelectionCandidate<'tcx>,
    // ) -> SelectionResult<'tcx, SelectionCandidate<'tcx>> {
    //     todo!("yaahc")
    // }

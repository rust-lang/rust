...
impl<'tcx> EvalCtxt<'_, 'tcx> {
    ...
    fn normalize_anon_const(
        ...
        if let Some(normalized_const) = self.try_const_eval_resolve(
            goal.param_env,
            ty::UnevaluatedConst::new(goal.predicate.alias.def_id, goal.predicate.alias.substs),
            self.tcx()
...
impl<'tcx> assembly::GoalKind<'tcx> for ty::NormalizesTo<'tcx> {
    ...
    fn consider_impl_candidate(
        ...
        ecx.probe(|ecx| {
                    ...
                    ty::AssocKind::Const => tcx
                        .const_error(
                            tcx.type_of(goal.predicate.def_id())
                                .subst(tcx, goal.predicate.alias.substs),
                            guar,
                        )
                        .into(),
            ...
            let impl_substs_with_gat =
                goal.predicate.alias.substs.rebase_onto(tcx, goal_trait_ref.def_id, impl_substs);
    ...
    fn consider_builtin_fn_trait_candidates(
        ...
        // We're using `ProjectionPredicate` as a clause here.
        //

...
use crate::{AssocKind, MethodKind, Target};
...
//  Variant name,            Name,                     Getter method name,         Target                  Generic requirements;
    ...
    AlignOf,                 sym::mem_align_const,     align_const,                Target::AssocConst(AssocKind::Trait),     GenericRequirement::Exact(0);
    SizeOf,                  sym::mem_size_const,      size_const,                 Target::AssocConst(AssocKind::Trait),     GenericRequirement::Exact(0);
    ...
    Discriminant,            sym::discriminant_type,   discriminant_type,          Target::AssocTy(AssocKind::Trait),        GenericRequirement::None;

    PointeeTrait,            sym::pointee_trait,       pointee_trait,              Target::Trait,          GenericRequirement::None;
    Metadata,                sym::metadata_type,       metadata_type,              Target::AssocTy(AssocKind::Trait),        GenericRequirement::None;
    ...
    DerefTarget,             sym::deref_target,        deref_target,               Target::AssocTy(AssocKind::Trait),        GenericRequirement::None;
    Receiver,                sym::receiver,            receiver_trait,             Target::Trait,          GenericRequirement::None;
    ReceiverTarget,          sym::receiver_target,     receiver_target,            Target::AssocTy(AssocKind::Trait),        GenericRequirement::None;
    ...
    AsyncFnOnceOutput,       sym::async_fn_once_output, async_fn_once_output,       Target::AssocTy(AssocKind::Trait),        GenericRequirement::Exact(1);
    CallOnceFuture,          sym::call_once_future,    call_once_future,           Target::AssocTy(AssocKind::Trait),        GenericRequirement::Exact(1);
    CallRefFuture,           sym::call_ref_future,     call_ref_future,            Target::AssocTy(AssocKind::Trait),        GenericRequirement::Exact(2);
    AsyncFnKindHelper,       sym::async_fn_kind_helper, async_fn_kind_helper,      Target::Trait,          GenericRequirement::Exact(1);
    AsyncFnKindUpvars,       sym::async_fn_kind_upvars, async_fn_kind_upvars,      Target::AssocTy(AssocKind::Trait),          GenericRequirement::Exact(5);

    FnOnceOutput,            sym::fn_once_output,      fn_once_output,             Target::AssocTy(AssocKind::Trait),        GenericRequirement::None;
    ...
    FutureOutput,            sym::future_output,       future_output,              Target::AssocTy(AssocKind::Trait),        GenericRequirement::Exact(0);
    AsyncIterator,           sym::async_iterator,      async_iterator_trait,       Target::Trait,          GenericRequirement::Exact(0);

    CoroutineState,          sym::coroutine_state,     coroutine_state,            Target::Enum,           GenericRequirement::None;
    Coroutine,               sym::coroutine,           coroutine_trait,            Target::Trait,          GenericRequirement::Exact(1);
    CoroutineReturn,         sym::coroutine_return,    coroutine_return,           Target::AssocTy(AssocKind::Trait),        GenericRequirement::Exact(1);
    CoroutineYield,          sym::coroutine_yield,     coroutine_yield,            Target::AssocTy(AssocKind::Trait),        GenericRequirement::Exact(1);
    ...
    AsyncGenPending,         sym::AsyncGenPending,     async_gen_pending,          Target::AssocConst(AssocKind::Inherent), GenericRequirement::Exact(1);
    AsyncGenFinished,        sym::AsyncGenFinished,    async_gen_finished,         Target::AssocConst(AssocKind::Inherent), GenericRequirement::Exact(1);
    ...
    RangeMax,                sym::RangeMax,            range_max,                  Target::AssocConst(AssocKind::Trait),     GenericRequirement::Exact(0);
    RangeMin,                sym::RangeMin,            range_min,                  Target::AssocConst(AssocKind::Trait),     GenericRequirement::Exact(0);
    ...
    FieldBase,               sym::field_base,              field_base,                 Target::AssocTy(AssocKind::Trait),        GenericRequirement::Exact(0);
    FieldType,               sym::field_type,              field_type,                 Target::AssocTy(AssocKind::Trait),        GenericRequirement::Exact(0);
    FieldOffset,             sym::field_offset,            field_offset,               Target::AssocConst(AssocKind::Trait),     GenericRequirement::Exact(0);

...
//  Variant name,            Name,                     Getter method name,         Target                  Generic requirements;
    ...
    // User-facing `core::ptr::drop_in_place` function which calls `drop_glue`.
    // This lang item exists to detect it in mir-opts.
    DropInPlace,             sym::drop_in_place,       drop_in_place_fn,           Target::Fn,             GenericRequirement::Exact(1);

...
pub trait Visitor<'v>: Sized {
    ...
    fn visit_nested_item(&mut self, id: ItemId) -> ControlFlow<Self::BreakTy> {
    ...
    /// method.
    fn visit_nested_trait_item(&mut self, id: TraitItemId) -> ControlFlow<Self::BreakTy> {
        if Self::NestedFilter::INTER {
    ...
    /// `visit_nested_item()` for advice on when to override this
    /// method.
    fn visit_nested_impl_item(&mut self, id: ImplItemId) -> ControlFlow<Self::BreakTy> {
        if Self::NestedFilter::INTER {
    ...
    /// `visit_nested_item()` for advice on when to override this
    /// method.
    fn visit_nested_foreign_item(&mut self, id: ForeignItemId) -> ControlFlow<Self::BreakTy> {
        if Self::NestedFilter::INTER {
    ...
    /// `Self::NestedFilter`.
    fn visit_nested_body(&mut self, id: BodyId) -> ControlFlow<Self::BreakTy> {
    ...
    fn visit_param(&mut self, param: &'v Param<'v>) -> ControlFlow<Self::BreakTy> {
        walk_param(self, param)
    }

    /// Visits the top-level item and (optionally) nested items / impl items. See
    /// `visit_nested_item` for details.
    fn visit_item(&mut self, i: &'v Item<'v>) -> ControlFlow<Self::BreakTy> {
        walk_item(self, i)
    }

    fn visit_body(&mut self, b: &'v Body<'v>) -> ControlFlow<Self::BreakTy> {
        walk_body(self, b)
    }

    ///////////////////////////////////////////////////////////////////////////

    fn visit_id(&mut self, _hir_id: HirId) -> ControlFlow<Self::BreakTy> {
        // Nothing to do.
        Continue(())
    }
    fn visit_name(&mut self, _name: Symbol) -> ControlFlow<Self::BreakTy> {
        // Nothing to do.
        Continue(())
    }
    fn visit_ident(&mut self, ident: Ident) -> ControlFlow<Self::BreakTy> {
        walk_ident(self, ident)
    }
    fn visit_mod(&mut self, m: &'v Mod<'v>, _s: Span, n: HirId) -> ControlFlow<Self::BreakTy> {
        walk_mod(self, m, n)
    }
    fn visit_foreign_item(&mut self, i: &'v ForeignItem<'v>) -> ControlFlow<Self::BreakTy> {
        walk_foreign_item(self, i)
    }
    fn visit_local(&mut self, l: &'v Local<'v>) -> ControlFlow<Self::BreakTy> {
        walk_local(self, l)
    }
    fn visit_block(&mut self, b: &'v Block<'v>) -> ControlFlow<Self::BreakTy> {
        walk_block(self, b)
    }
    fn visit_stmt(&mut self, s: &'v Stmt<'v>) -> ControlFlow<Self::BreakTy> {
        walk_stmt(self, s)
    }
    fn visit_arm(&mut self, a: &'v Arm<'v>) -> ControlFlow<Self::BreakTy> {
        walk_arm(self, a)
    }
    fn visit_pat(&mut self, p: &'v Pat<'v>) -> ControlFlow<Self::BreakTy> {
        walk_pat(self, p)
    }
    fn visit_pat_field(&mut self, f: &'v PatField<'v>) -> ControlFlow<Self::BreakTy> {
        walk_pat_field(self, f)
    }
    fn visit_array_length(&mut self, len: &'v ArrayLen) -> ControlFlow<Self::BreakTy> {
        walk_array_len(self, len)
    }
    fn visit_anon_const(&mut self, c: &'v AnonConst) -> ControlFlow<Self::BreakTy> {
        walk_anon_const(self, c)
    }
    fn visit_expr(&mut self, ex: &'v Expr<'v>) -> ControlFlow<Self::BreakTy> {
        walk_expr(self, ex)
    }
    fn visit_let_expr(&mut self, lex: &'v Let<'v>) -> ControlFlow<Self::BreakTy> {
        walk_let_expr(self, lex)
    }
    fn visit_expr_field(&mut self, field: &'v ExprField<'v>) -> ControlFlow<Self::BreakTy> {
        walk_expr_field(self, field)
    }
    fn visit_ty(&mut self, t: &'v Ty<'v>) -> ControlFlow<Self::BreakTy> {
        walk_ty(self, t)
    }
    fn visit_generic_param(&mut self, p: &'v GenericParam<'v>) -> ControlFlow<Self::BreakTy> {
    ...
    fn visit_generics(&mut self, g: &'v Generics<'v>) -> ControlFlow<Self::BreakTy> {
    ...
    fn visit_fn_ret_ty(&mut self, ret_ty: &'v FnRetTy<'v>) -> ControlFlow<Self::BreakTy> {
        walk_fn_ret_ty(self, ret_ty)
    }
    fn visit_fn_decl(&mut self, fd: &'v FnDecl<'v>) -> ControlFlow<Self::BreakTy> {
    ...
    fn visit_use(&mut self, path: &'v UsePath<'v>, hir_id: HirId) -> ControlFlow<Self::BreakTy> {
        walk_use(self, path, hir_id)
    }
    fn visit_trait_item(&mut self, ti: &'v TraitItem<'v>) -> ControlFlow<Self::BreakTy> {
        walk_trait_item(self, ti)
    }
    fn visit_trait_item_ref(&mut self, ii: &'v TraitItemRef) -> ControlFlow<Self::BreakTy> {
        walk_trait_item_ref(self, ii)
    }
    fn visit_impl_item(&mut self, ii: &'v ImplItem<'v>) -> ControlFlow<Self::BreakTy> {
        walk_impl_item(self, ii)
    }
    fn visit_foreign_item_ref(&mut self, ii: &'v ForeignItemRef) -> ControlFlow<Self::BreakTy> {
        walk_foreign_item_ref(self, ii)
    }
    fn visit_impl_item_ref(&mut self, ii: &'v ImplItemRef) -> ControlFlow<Self::BreakTy> {
        walk_impl_item_ref(self, ii)
    }
    fn visit_trait_ref(&mut self, t: &'v TraitRef<'v>) -> ControlFlow<Self::BreakTy> {
        walk_trait_ref(self, t)
    }
    fn visit_param_bound(&mut self, bounds: &'v GenericBound<'v>) -> ControlFlow<Self::BreakTy> {
        walk_param_bound(self, bounds)
    }
    fn visit_poly_trait_ref(&mut self, t: &'v PolyTraitRef<'v>) -> ControlFlow<Self::BreakTy> {
        walk_poly_trait_ref(self, t)
    }
    fn visit_variant_data(&mut self, s: &'v VariantData<'v>) -> ControlFlow<Self::BreakTy> {
        walk_struct_def(self, s)
    }
    fn visit_field_def(&mut self, s: &'v FieldDef<'v>) -> ControlFlow<Self::BreakTy> {
    ...
    fn visit_variant(&mut self, v: &'v Variant<'v>) -> ControlFlow<Self::BreakTy> {
        walk_variant(self, v)
    }
    fn visit_label(&mut self, label: &'v Label) -> ControlFlow<Self::BreakTy> {
        walk_label(self, label)
    }
    fn visit_infer(&mut self, inf: &'v InferArg) -> ControlFlow<Self::BreakTy> {
        walk_inf(self, inf)
    }
    fn visit_generic_arg(&mut self, generic_arg: &'v GenericArg<'v>) -> ControlFlow<Self::BreakTy> {
        walk_generic_arg(self, generic_arg)
    }
    fn visit_lifetime(&mut self, lifetime: &'v Lifetime) -> ControlFlow<Self::BreakTy> {
    ...
    fn visit_path(&mut self, path: &Path<'v>, _id: HirId) -> ControlFlow<Self::BreakTy> {
        walk_path(self, path)
    }
    ...
    fn visit_attribute(&mut self, _attr: &'v Attribute) -> ControlFlow<Self::BreakTy> {
        Continue(())
    }
    ...
    fn visit_defaultness(&mut self, defaultness: &'v Defaultness) -> ControlFlow<Self::BreakTy> {
...
pub fn walk_item<'v, V: Visitor<'v>>(
    visitor: &mut V,
    item: &'v Item<'v>,
) -> ControlFlow<V::BreakTy> {
    ...
    match item.kind {
        ...
        ItemKind::Use(path, _) => visitor.visit_use(path, item.hir_id()),
        ItemKind::Static(typ, _, body) | ItemKind::Const(typ, body) => {
            visitor.visit_id(item.hir_id())?;
        ...
        ItemKind::Macro(..) => visitor.visit_id(item.hir_id()),
        ItemKind::Mod(module) => {
        ...
        ItemKind::Enum(ref enum_definition, generics) => {
            visitor.visit_generics(generics)?;
        ...
        ItemKind::Struct(ref struct_definition, generics)
        | ItemKind::Union(ref struct_definition, generics) => {
            visitor.visit_generics(generics)?;
            visitor.visit_id(item.hir_id())?;
            visitor.visit_variant_data(struct_definition)
        }
        ItemKind::Trait(.., generics, bounds, trait_item_refs) => {
            visitor.visit_id(item.hir_id())?;
            visitor.visit_generics(generics)?;
            walk_list!(visitor, visit_param_bound, bounds);
...
pub fn walk_ident<'v, V: Visitor<'v>>(visitor: &mut V, ident: Ident) -> ControlFlow<V::BreakTy> {
...
pub fn walk_foreign_item<'v, V: Visitor<'v>>(
    ...
    match foreign_item.kind {
        ForeignItemKind::Fn(function_declaration, param_names, generics) => {
            visitor.visit_generics(generics)?;
            visitor.visit_fn_decl(function_declaration)?;
            walk_list!(visitor, visit_ident, param_names.iter().copied());
            Continue(())
        }
        ForeignItemKind::Static(typ, _) => visitor.visit_ty(typ),
        ForeignItemKind::Type => Continue(()),
    }
}
...
pub fn walk_stmt<'v, V: Visitor<'v>>(
    ...
    match statement.kind {
        ...
        StmtKind::Expr(expression) | StmtKind::Semi(expression) => visitor.visit_expr(expression),
    }
}

pub fn walk_arm<'v, V: Visitor<'v>>(visitor: &mut V, arm: &'v Arm<'v>) -> ControlFlow<V::BreakTy> {
    visitor.visit_id(arm.hir_id)?;
    visitor.visit_pat(arm.pat)?;
    if let Some(ref g) = arm.guard {
        match g {
            Guard::If(e) => visitor.visit_expr(e)?,
            Guard::IfLet(l) => visitor.visit_let_expr(l)?,
        }
    }
...
pub fn walk_pat<'v, V: Visitor<'v>>(
    ...
    match pattern.kind {
        ...
        PatKind::Box(subpattern) | PatKind::Ref(subpattern, _) => {
            visitor.visit_pat(subpattern)?;
        }
        PatKind::Binding(_, _hir_id, ident, optional_subpattern) => {
        ...
        PatKind::Wild => (),
        PatKind::Slice(prepatterns, slice_pattern, postpatterns) => {
...
pub fn walk_pat_field<'v, V: Visitor<'v>>(
    visitor: &mut V,
    field: &'v PatField<'v>,
) -> ControlFlow<V::BreakTy> {
...
pub fn walk_anon_const<'v, V: Visitor<'v>>(
    visitor: &mut V,
    constant: &'v AnonConst,
) -> ControlFlow<V::BreakTy> {
...
pub fn walk_expr<'v, V: Visitor<'v>>(
    ...
    match expression.kind {
        ...
        ExprKind::Struct(qpath, fields, optional_base) => {
        ...
        ExprKind::DropTemps(subexpression) => {
            visitor.visit_expr(subexpression)?;
        }
        ...
        ExprKind::Loop(block, ref opt_label, _, _) => {
        ...
        ExprKind::Break(ref destination, opt_expr) => {
        ...
        ExprKind::Yield(subexpression, _) => {
            visitor.visit_expr(subexpression)?;
        }
...
pub fn walk_let_expr<'v, V: Visitor<'v>>(
    visitor: &mut V,
    let_expr: &'v Let<'v>,
) -> ControlFlow<V::BreakTy> {
...
pub fn walk_ty<'v, V: Visitor<'v>>(visitor: &mut V, typ: &'v Ty<'v>) -> ControlFlow<V::BreakTy> {
    visitor.visit_id(typ.hir_id)?;

    match typ.kind {
        TyKind::Slice(ty) => visitor.visit_ty(ty),
        TyKind::Ptr(ref mutable_type) => visitor.visit_ty(mutable_type.ty),
        TyKind::Ref(lifetime, ref mutable_type) => {
        ...
        TyKind::Path(ref qpath) => visitor.visit_qpath(qpath, typ.hir_id, typ.span),
        ...
        TyKind::TraitObject(bounds, lifetime, _syntax) => {
            walk_list!(visitor, visit_poly_trait_ref, bounds);
            visitor.visit_lifetime(lifetime)
        }
        TyKind::Typeof(ref expression) => visitor.visit_anon_const(expression),
        TyKind::Infer | TyKind::Err(_) | TyKind::Never => Continue(()),
    }
}
...
pub fn walk_generics<'v, V: Visitor<'v>>(
    visitor: &mut V,
...
pub fn walk_fn_ret_ty<'v, V: Visitor<'v>>(
    visitor: &mut V,
    ret_ty: &'v FnRetTy<'v>,
) -> ControlFlow<V::BreakTy> {
...
pub fn walk_fn_kind<'v, V: Visitor<'v>>(
    ...
    match function_kind {
        FnKind::ItemFn(_, generics, ..) => visitor.visit_generics(generics),
        FnKind::Closure | FnKind::Method(..) => Continue(()),
    }
}
...
pub fn walk_impl_item<'v, V: Visitor<'v>>(
    ...
    // N.B., deliberately force a compilation error if/when new fields are added.
    let ImplItem { owner_id: _, ident, generics, ref kind, ref defaultness, span: _, vis_span: _ } =
        *impl_item;
...
pub fn walk_inf<'v, V: Visitor<'v>>(visitor: &mut V, inf: &'v InferArg) -> ControlFlow<V::BreakTy> {
...
pub fn walk_qpath<'v, V: Visitor<'v>>(
    ...
    match *qpath {
        ...
        QPath::LangItem(..) => Continue(()),
    }
}

pub fn walk_path<'v, V: Visitor<'v>>(visitor: &mut V, path: &Path<'v>) -> ControlFlow<V::BreakTy> {
...
pub fn walk_path_segment<'v, V: Visitor<'v>>(
    ...
    walk_list!(visitor, visit_generic_args, segment.args);
    Continue(())
}
    ...
    for (op, op_sp) in asm.operands {
        match op {
            ...
            InlineAsmOperand::SplitInOut { in_expr, out_expr, .. } => {
                ...
                walk_list!(visitor, visit_expr, out_expr);
            }

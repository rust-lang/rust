...
use super::{QueryConfig, QueryStackDeferred, QueryStackFrameExtra};
...
#[cold]
#[inline(never)]
fn mk_cycle<'tcx, Q, Qcx>(query: Q, qcx: Qcx, cycle_error: CycleError) -> Q::Value
where
    Q: QueryConfig<'tcx, Qcx>,
    Qcx: QueryContext<'tcx>,
{
    let error = report_cycle(qcx.dep_context().sess(), &cycle_error);
    handle_cycle_error(query, qcx, &cycle_error, error)
}

fn handle_cycle_error<'tcx, Q, Qcx>(
    query: Q,
    qcx: Qcx,
...
#[inline(never)]
fn try_execute_query<'tcx, Q, Qcx, const INCR: bool>(
    query: Q,
    qcx: Qcx,
    span: Span,
    key: Q::Key,
...
#[inline(always)]
fn execute_job<'a, 'tcx, Q, Qcx, const INCR: bool>(
    query: Q,
    qcx: Qcx,
    state: &'a QueryState<'tcx, Q::Key>,
    key: Q::Key,
    key_hash: u64,
    id: QueryJobId,
    dep_node: Option<DepNode>,
...
#[inline(always)]
fn execute_job_non_incr<'tcx, Q, Qcx>(
    query: Q,
    qcx: Qcx,
    key: Q::Key,
    job_id: QueryJobId,
...
#[inline(always)]
fn try_load_from_disk_and_cache_in_memory<'tcx, Q, Qcx>(
    query: Q,
    dep_graph_data: &DepGraphData<Qcx::Deps>,
    qcx: Qcx,
    key: &Q::Key,
...
#[inline(always)]
pub fn get_query_non_incr<'tcx, Q, Qcx>(query: Q, qcx: Qcx, span: Span, key: Q::Key) -> Q::Value
where
    Q: QueryConfig<'tcx, Qcx>,
    Qcx: QueryContext<'tcx>,
{
...
#[inline(always)]
pub fn get_query_incr<'tcx, Q, Qcx>(
    query: Q,
    qcx: Qcx,
    span: Span,
    key: Q::Key,
...
pub fn force_query<'tcx, Q, Qcx>(query: Q, qcx: Qcx, key: Q::Key, dep_node: DepNode)
where
    Q: QueryConfig<'tcx, Qcx>,
    Qcx: QueryContext<'tcx>,
{

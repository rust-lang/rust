    ...
    match param.kind {
        ...
        hir::GenericParamKind::Const { ty: hir_ty } => {
                ...
                .is_some()
            {
                ...
                // clearer.
                if let ty::Param(_) = ty.peel_refs().data() {
...
fn check_opaque_types<'fcx, 'tcx>(
    ...
    ty.fold_with(&mut ty::fold::BottomUpFolder {
        tcx: fcx.tcx,
        ty_op: |ty| {
            if let ty::Opaque(def_id, substs) = *ty.data() {

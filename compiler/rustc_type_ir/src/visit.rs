...
pub trait TypeVisitor<I: Interner>: Sized {
    ...
    ///
    /// This is a separate hook because inference, bound, and placeholder
    /// evidence are not generic arguments and need custom handling by
    /// canonicalization and binder-aware visitors.
...
pub trait TypeVisitableExt<I: Interner>: TypeVisitable<I> {
    ...
    fn has_surface_projections(&self) -> bool {
        self.has_type_flags(TypeFlags::HAS_SURFACE_PROJECTION)
    }
}
...
impl<I: Interner> TypeVisitor<I> for HasTypeFlagsVisitor {
    ...
    fn visit_trait_evidence(&mut self, evidence: I::TraitEvidence) -> Self::Result {
        ...
        let evidence_flags = match &evidence.kind {
            ...
            ty::solve::TraitEvidenceKind::Infer(_) => TypeFlags::HAS_TY_INFER,

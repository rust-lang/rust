...
#[cfg(feature = "nightly")]
impl<CTX, I: Interner, T> HashStable<CTX> for Placeholder<I, T>
where
    I: Interner,
    T: HashStable<CTX>,
{
    ...
    I::DefId: HashStable<CTX>,
{
    fn hash_stable(&self, hcx: &mut CTX, hasher: &mut StableHasher) {
        match self {
            ...
            BoundRegionKind::NamedForPrinting(sym) => {
...
#[cfg(feature = "nightly")]
impl<CTX, I: Interner> HashStable<CTX> for BoundRegion<I>
where
    I: Interner,
    ty::BoundVar: HashStable<CTX>,
    BoundRegionKind<I>: HashStable<CTX>,
{
    fn hash_stable(&self, hcx: &mut CTX, hasher: &mut StableHasher) {
        let BoundRegion { var, kind } = self;
        var.hash_stable(hcx, hasher);

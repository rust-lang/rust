...
impl<I: Interner, J: Interner> crate::lift::Lift<J> for FnSigKind<I> {
    ...
    fn lift_to_interner(self, _cx: J) -> Self::Lifted {
        FnSigKind { flags: self.flags, splatted: self.splatted, _marker: PhantomData }
    }
}
...
impl<I: Interner> FnSigKind<I> {
    ...
    /// Create a new FnSigKind with the given ABI, safety, C-style variadic, and splatted argument index.
    pub fn new(
        abi: ExternAbi,
        safety: I::Safety,
        c_variadic: bool,

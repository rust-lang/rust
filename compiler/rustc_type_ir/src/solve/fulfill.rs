...
/// scope.
#[derive_where(Clone; I: Interner, T)]
...
impl<I: Interner, T: fmt::Debug> fmt::Debug for Obligation<I, T> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        if <I::ObligationCause as crate::inherent::ObligationCause<I>>::debug_with_internals() {
            write!(
                f,

...
use crate::lang_items::TraitSolverTraitLangItem;
...
impl SizedTraitKind {
    ...
    pub fn require_lang_item<I: Interner>(self, cx: I) -> I::TraitId {
        cx.require_trait_lang_item(match self {
            SizedTraitKind::Sized => TraitSolverTraitLangItem::Sized,
            SizedTraitKind::MetaSized => TraitSolverTraitLangItem::MetaSized,
        })
    }
}

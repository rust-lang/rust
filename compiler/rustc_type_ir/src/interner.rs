...
use crate::lang_items::{TraitSolverLangItem, TraitSolverTraitLangItem};
    ...
    + IrPrint<ty::PatternKind<Self>>
{
    ...
    fn require_trait_lang_item(self, lang_item: TraitSolverTraitLangItem) -> Self::TraitId;

    fn is_lang_item(self, def_id: Self::DefId, lang_item: TraitSolverLangItem) -> bool;

    fn is_trait_lang_item(self, def_id: Self::TraitId, lang_item: TraitSolverTraitLangItem)
    -> bool;
    ...
    fn as_trait_lang_item(self, def_id: Self::TraitId) -> Option<TraitSolverTraitLangItem>;

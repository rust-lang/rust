...
//@ is "$.index[*][?(@.name=='abi_c')].inner.function.header.abi" '{"C": {"can_unwind": false}}'
pub extern "C" fn abi_c() {}

//@ is "$.index[*][?(@.name=='abi_system')].inner.function.header.abi" '{"System": {"can_unwind": false}}'
pub extern "system" fn abi_system() {}

//@ is "$.index[*][?(@.name=='abi_c_unwind')].inner.function.header.abi" '{"C": {"can_unwind": true}}'
pub extern "C-unwind" fn abi_c_unwind() {}

//@ is "$.index[*][?(@.name=='abi_system_unwind')].inner.function.header.abi" '{"System": {"can_unwind": true}}'

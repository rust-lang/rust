...
//@ has   "$.index[?(@.name=='ref_maybe_unsized')].inner.function.sig.inputs[0][1].borrowed_ref.type.impl_trait.bounds[?(@.trait_bound.trait.path=='Sized')]"
//@ has   "$.index[?(@.name=='ref_maybe_unsized')].inner.function.sig.inputs[0][1].borrowed_ref.type.impl_trait.bounds[?(@.trait_bound.modifier=='maybe')]"
...
//@ has   "$.index[?(@.name=='ref_sized')].inner.function.sig.inputs[0][1].borrowed_ref.type.impl_trait.implied_bounds[?(@.trait_bound.trait.path=='Sized')]"
//@ !has  "$.index[?(@.name=='ref_sized')].inner.function.sig.inputs[0][1].borrowed_ref.type.impl_trait.implied_bounds[?(@.trait_bound.modifier=='maybe')]"
...
//@ has   "$.index[?(@.name=='ptr_maybe_unsized')].inner.function.sig.inputs[0][1].raw_pointer.type.impl_trait.bounds[?(@.trait_bound.trait.path=='Sized')]"
//@ has   "$.index[?(@.name=='ptr_maybe_unsized')].inner.function.sig.inputs[0][1].raw_pointer.type.impl_trait.bounds[?(@.trait_bound.modifier=='maybe')]"
...
//@ has   "$.index[?(@.name=='ptr_sized')].inner.function.sig.inputs[0][1].raw_pointer.type.impl_trait.implied_bounds[?(@.trait_bound.trait.path=='Sized')]"
//@ !has  "$.index[?(@.name=='ptr_sized')].inner.function.sig.inputs[0][1].raw_pointer.type.impl_trait.implied_bounds[?(@.trait_bound.modifier=='maybe')]"
...
//@ has   "$.index[?(@.name=='nested_ref_sized')].inner.function.sig.inputs[0][1].borrowed_ref.type.borrowed_ref.type.impl_trait.implied_bounds[?(@.trait_bound.trait.path=='Sized')]"
//@ !has  "$.index[?(@.name=='nested_ref_sized')].inner.function.sig.inputs[0][1].borrowed_ref.type.borrowed_ref.type.impl_trait.implied_bounds[?(@.trait_bound.modifier=='maybe')]"

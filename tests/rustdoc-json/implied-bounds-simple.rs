...
//@ has   "$.index[?(@.name=='sized_through_trait')].inner.function.generics.params[0].kind.type.bounds[?(@.trait_bound.trait.path=='Sized')]"
//@ has   "$.index[?(@.name=='sized_through_trait')].inner.function.generics.params[0].kind.type.bounds[?(@.trait_bound.modifier=='maybe')]"
...
//@ !has  "$.index[?(@.name=='sized_through_trait')].inner.function.generics.params[0].kind.type.implied_bounds[?(@.trait_bound.modifier=='maybe')]"
...
//@ has   "$.index[?(@.name=='static_via_trait')].inner.function.generics.params[0].kind.type.implied_bounds[?(@.trait_bound.trait.path=='Sized')]"
//@ !has  "$.index[?(@.name=='static_via_trait')].inner.function.generics.params[0].kind.type.implied_bounds[?(@.trait_bound.modifier=='maybe')]"
...
//@ !has  "$.index[?(@.name=='Inner')].inner.struct.generics.params[1].kind.type.implied_bounds[?(@.trait_bound.modifier=='maybe')]"
//@ has   "$.index[?(@.name=='Inner')].inner.struct.generics.params[1].kind.type.implied_bounds[?(@.outlives==\"'a\")]"
pub struct Inner<'a, T>(&'a T);

//@ has   "$.index[?(@.name=='InnerUnsized')].inner.struct.generics.params[1].kind.type.bounds[?(@.trait_bound.trait.path=='Sized')]"
//@ has   "$.index[?(@.name=='InnerUnsized')].inner.struct.generics.params[1].kind.type.bounds[?(@.trait_bound.modifier=='maybe')]"
...
//@ has   "$.index[?(@.name=='carries_inner_unsized')].inner.function.generics.params[1].kind.type.implied_bounds[?(@.trait_bound.trait.path=='Sized')]"
//@ !has  "$.index[?(@.name=='carries_inner_unsized')].inner.function.generics.params[1].kind.type.implied_bounds[?(@.trait_bound.modifier=='maybe')]"

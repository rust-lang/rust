...
//@ set gmWham = "$.index[?(@.docs[0].text=='Wham for George Michael')].id"
...
//@ is "$.index[?(@.docs[0].text == 'Wham for George Michael')].inner.impl.trait.id" $wham
//@ is "$.index[?(@.docs[0].text == 'Wham for George Michael')].inner.impl.for.resolved_path.id" $gm

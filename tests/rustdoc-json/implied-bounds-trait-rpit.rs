...
pub trait Provider {
    ...
    //@ has "$.index[?(@.name=='provides_static')].inner.function.sig.output.impl_trait.implied_bounds[?(@.trait_bound.trait.path=='Sized')]"
    ...
    //@ !has "$.index[?(@.name=='provides_static')].inner.function.sig.output.impl_trait.implied_bounds[?(@.trait_bound.modifier=='maybe')]"
    ...
    //@ has "$.index[?(@.name=='provides_ref')].inner.function.sig.output.borrowed_ref.type.impl_trait.bounds[?(@.trait_bound.trait.path=='Sized')]"
    //@ has "$.index[?(@.name=='provides_ref')].inner.function.sig.output.borrowed_ref.type.impl_trait.bounds[?(@.trait_bound.modifier=='maybe')]"
    //@ has "$.index[?(@.name=='provides_ref')].inner.function.sig.output.borrowed_ref.type.impl_trait.implied_bounds[?(@.trait_bound.trait.path=='Sized')]"
    //@ !has "$.index[?(@.name=='provides_ref')].inner.function.sig.output.borrowed_ref.type.impl_trait.implied_bounds[?(@.trait_bound.modifier=='maybe')]"

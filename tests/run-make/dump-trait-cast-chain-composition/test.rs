...
//! `-Z dump-trait-cast-chain-composition` diagnostic flag.
//!
...
//! `exercise`, and so `main` is transitively sensitive. The call_id chain
//! composition fires while computing transitive sensitivity at those edges.

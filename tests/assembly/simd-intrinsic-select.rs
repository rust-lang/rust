...
pub unsafe extern "C" fn select_f32x4(mask: m32x4, a: f32x4, b: f32x4) -> f32x4 {
    // CHECK-X86-AVX2: vpslld xmm0, xmm0, 31
    // CHECK-X86-AVX2-NEXT: vblendvps xmm0, xmm2, xmm1, xmm0
    //
    // CHECK-X86-AVX512: vpslld xmm0, xmm0, 31
    // CHECK-X86-AVX512-NEXT: vpmovd2m k1, xmm0
    // CHECK-X86-AVX512-NEXT: vblendmps xmm0 {k1}, xmm2, xmm1
    //
    // CHECK-AARCH64: shl v0.4s, v0.4s, #31
    // CHECK-AARCH64-NEXT: cmlt v0.4s, v0.4s, #0
    // CHECK-AARCH64-NEXT: bsl v0.16b, v1.16b, v2.16b
    simd_select(mask, a, b)
}
...
pub unsafe extern "C" fn select_f64x2(mask: m64x2, a: f64x2, b: f64x2) -> f64x2 {
    // CHECK-X86-AVX2: vpsllq xmm0, xmm0, 63
    // CHECK-X86-AVX2-NEXT: vblendvpd xmm0, xmm2, xmm1, xmm0
    //
    // CHECK-X86-AVX512: vpsllq xmm0, xmm0, 63
    // CHECK-X86-AVX512-NEXT: vpmovq2m k1, xmm0
    // CHECK-X86-AVX512-NEXT: vblendmpd xmm0 {k1}, xmm2, xmm1
    //
    // CHECK-AARCH64: shl v0.2d, v0.2d, #63
    // CHECK-AARCH64-NEXT: cmlt v0.2d, v0.2d, #0
    // CHECK-AARCH64-NEXT: bsl v0.16b, v1.16b, v2.16b
    simd_select(mask, a, b)
}
...
pub unsafe extern "C" fn select_f64x4(mask: m64x4, a: f64x4, b: f64x4) -> f64x4 {
    ...
    // CHECK-X86-AVX2-NEXT: vblendvpd ymm0, ymm2, ymm1, ymm0
    //
    // CHECK-X86-AVX512: vpsllq ymm0, ymm0, 63
    // CHECK-X86-AVX512-NEXT: vpmovq2m k1, ymm0
    // CHECK-X86-AVX512-NEXT: vblendmpd ymm0 {k1}, ymm2, ymm1
    simd_select(mask, a, b)
}
...
pub unsafe extern "C" fn select_f64x8(mask: m64x8, a: f64x8, b: f64x8) -> f64x8 {
    ...
    //
    // CHECK-X86-AVX512: vpsllq zmm0, zmm0, 63
    // CHECK-X86-AVX512-NEXT: vpmovq2m k1, zmm0
    // CHECK-X86-AVX512-NEXT: vblendmpd zmm0 {k1}, zmm2, zmm1
    simd_select(mask, a, b)
}

...
pub unsafe extern "C" fn load_i8x16(mask: m8x16, pointer: *const i8) -> i8x16 {
    ...
    // CHECK-X86-AVX2: vpsllw xmm0, xmm0, 7
    // CHECK-X86-AVX2-NEXT: vpmovmskb eax, xmm0
    // CHECK-X86-AVX2-NEXT: vpxor xmm0, xmm0
    // CHECK-X86-AVX2-NEXT: test al, 1
    // CHECK-X86-AVX2-NEXT: jne
    // CHECK-X86-AVX2-NEXT: test al, 2
    // CHECK-X86-AVX2-NEXT: jne
    // CHECK-X86-AVX2-DAG: movzx [[REG:[a-z]+]], byte ptr [rdi]
    // CHECK-X86-AVX2-NEXT: vmovd xmm0, [[REG]]
    // CHECK-X86-AVX2-DAG: vpinsrb xmm0, xmm0, byte ptr [rdi + 1], 1
    //
    // CHECK-X86-AVX512: vpsllw xmm0, xmm0, 7
    // CHECK-X86-AVX512-NEXT: vpmovb2m k1, xmm0
    // CHECK-X86-AVX512-NEXT: vmovdqu8 xmm0 {k1} {z}, xmmword ptr [rdi]
...
pub unsafe extern "C" fn load_f32x8(mask: m32x8, pointer: *const f32) -> f32x8 {
    // CHECK-X86-AVX2: vpslld ymm0, ymm0, 31
    // CHECK-X86-AVX2-NEXT: vmaskmovps ymm0, ymm0, ymmword ptr [rdi]
    //
    // CHECK-X86-AVX512: vpslld ymm0, ymm0, 31
    // CHECK-X86-AVX512-NEXT: vpmovd2m k1, ymm0
    // CHECK-X86-AVX512-NEXT: vmovups ymm0 {k1} {z}, ymmword ptr [rdi]
...
pub unsafe extern "C" fn load_f64x4(mask: m64x4, pointer: *const f64) -> f64x4 {
    // CHECK-X86-AVX2: vpsllq ymm0, ymm0, 63
    // CHECK-X86-AVX2-NEXT: vmaskmovpd ymm0, ymm0, ymmword ptr [rdi]
    //
    // CHECK-X86-AVX512: vpsllq ymm0, ymm0, 63
    // CHECK-X86-AVX512-NEXT: vpmovq2m k1, ymm0
    // CHECK-X86-AVX512-NEXT: vmovupd ymm0 {k1} {z}, ymmword ptr [rdi]

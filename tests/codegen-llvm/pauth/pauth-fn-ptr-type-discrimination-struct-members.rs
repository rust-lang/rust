...
pub fn test_8_tuple_members() {
    ...
    let dst = TupleDst {
        // DISK: call i64 @llvm.ptrauth.resign(i64 %1, i32 0, i64 18983, i32 0, i64 21613)
        // DISK: call i64 @llvm.ptrauth.resign(i64 %3, i32 0, i64 2712, i32 0, i64 7718)
    ...
    // DISK: call void %{{.*}}(float 0x3FDAE147A0000000) #[[#]] [ "ptrauth"(i32 0, i64 21613) ]
    // DISK: call void %{{.*}}(double 4.242000e-01) #[[#]] [ "ptrauth"(i32 0, i64 7718) ]
    (dst.pair.0)(0.42f32);
...
// }
//
// typedef void (*t0)(void);
// typedef void (*t1)(int);
// typedef void (*t2)(float);
...
// } TupleDst;
//
// static const TupleSrc T_TUPLE = {
//     .f0 = f,
//     .f1 = g,
// };
//
// static const TupleDst T_TUPLE_2 = {
//     .f0 = m,
//     .f1 = n,
// };
//
// __attribute__((noinline)) void test_8_tuple_members(void) {
//   volatile const TupleSrc *vp = &T_TUPLE;
//   TupleSrc src = *vp;
//
//   TupleDst dst = {
//       .f0 = (t2)src.f0,

...
// CHECK-LABEL: define void @plain_f16(half noundef %x)
#[unsafe(no_mangle)]
extern "C" fn plain_f16(x: f16) {
    black_box(x);
}

// CHECK-LABEL: define void @wrapped_f16(half %0)
#[unsafe(no_mangle)]
extern "C" fn wrapped_f16(x: Wrapper<f16>) {
    black_box(x);
}

// CHECK-LABEL: define void @plain_f32(float noundef %x)
#[unsafe(no_mangle)]
extern "C" fn plain_f32(x: f32) {
    black_box(x);
}

// CHECK-LABEL: define void @wrapped_f32(float %0)
#[unsafe(no_mangle)]
extern "C" fn wrapped_f32(x: Wrapper<f32>) {
    black_box(x);
}

// CHECK-LABEL: define void @plain_f64(double noundef %x)
#[unsafe(no_mangle)]
extern "C" fn plain_f64(x: f64) {
    black_box(x);
}

// CHECK-LABEL: define void @wrapped_f64(double %0)
#[unsafe(no_mangle)]
extern "C" fn wrapped_f64(x: Wrapper<f64>) {
    black_box(x);
}

// CHECK-LABEL: define void @plain_f128(ptr {{.*}}dereferenceable(16) %x)
#[unsafe(no_mangle)]
extern "C" fn plain_f128(x: f128) {
    black_box(x);
}

// CHECK-LABEL: define void @wrapped_f128(ptr {{.*}}dereferenceable(16) %x)
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define void @transparent_wrapped_f32(float %0)
#[unsafe(no_mangle)]
extern "C" fn transparent_wrapped_f32(x: Transparent<Wrapper<f32>>) {
    black_box(x);
}

// CHECK-LABEL: define void @transparent_transparent_wrapped_f32(float %0)
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define void @aligned_8_wrapped_f16(double %0)
#[unsafe(no_mangle)]
extern "C" fn aligned_8_wrapped_f16(x: Aligned8Wrapper<f16>) {
    black_box(x);
}

// CHECK-LABEL: define void @aligned_8_wrapped_f32(double %0)
#[unsafe(no_mangle)]
...
// CHECK-LABEL: define void @aligned_16_wrapped_f32(ptr {{.*}}dereferenceable(16)
#[unsafe(no_mangle)]
...
//
// CHECK-LABEL: define void @union_wrapped_f32(i32 %0)
#[unsafe(no_mangle)]
...
//
// CHECK-LABEL: define void @maybe_uninit_f32(float %x)
#[unsafe(no_mangle)]
...
//
// CHECK-LABEL: define void @array_f32(i32 %0)
#[unsafe(no_mangle)]

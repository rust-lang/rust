...
//@ compile-flags: -Zsanitizer-ignorelist={{src-base}}/sanitizer/ignorelist/ignorelist.txt -Ctarget-feature=-crt-static -Cunsafe-allow-abi-mismatch=sanitizer
...
// TSAN-NOT: sanitize_thread
// HWASAN-NOT: sanitize_hwaddress
// CHECK-NEXT: define void @test_all
#[no_mangle]
pub fn test_all(x: &mut i32) {
    *x = 6;
}

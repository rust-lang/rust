...
// CHECK-LABEL: @vscr_clobber
// CHECK: call void asm sideeffect "", "~{vscr}"()
#[no_mangle]
pub unsafe fn vscr_clobber() {
    asm!("", out("vscr") _, options(nostack, nomem, preserves_flags));
}

...
// CHECK-DAG: ![[#var_loc1]] = !DILocation{{.*}}scope: ![[#var_scope:]], inlinedAt: ![[#var_inlinedAt1:]]
...
// CHECK-DAG: ![[#var_inlinedAt1]] = !DILocation{{.*}}scope: ![[var_inlinedAt1_scope:]]
...
// CHECK-DAG: ![[#var_loc2]] = !DILocation{{.*}}scope: ![[#var_scope]], inlinedAt: ![[#var_inlinedAt2:]]

// Find the second location's inlinedAt.
// CHECK-DAG: ![[#var_inlinedAt2]] = !DILocation{{.*}}scope: ![[#var_inlinedAt2_scope:]]
...
// CHECK-DAG: ![[#var_inlinedAt2_scope]] = !DILexicalBlockFile{{.*}}discriminator: [[#]]

...
mod _struct2 {
    ...
    impl<'a> Path<'a, String> {
        ...
        //~| NOTE lifetime `'a` defined here
        //~| NOTE lifetime `'a` defined here
        pub fn sub(&mut self) -> Path<String> {
            //~^ NOTE: let's call the lifetime of this reference `'1`

...
//@ aux-build:kcfi_normalize_ints.rs
...
//[wrong_sanitizer]~^^^ ERROR mixing `-Zsanitizer-cfi-normalize-integers` will cause an ABI mismatch in crate `sanitizer_kcfi_normalize_ints`
#![crate_type = "rlib"]
#![no_core]

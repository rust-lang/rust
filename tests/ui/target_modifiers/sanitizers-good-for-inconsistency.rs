...
//@ compile-flags: -Cpanic=abort -C target-feature=-crt-static -Zunstable-options

//@[wrong_address_san] compile-flags: -Csanitizer=address
//@[wrong_leak_san] compile-flags: -Csanitizer=leak
//@ check-pass

...
fn gather_scatter_of_ptrs() {
    ...
    unsafe {
        ...
        assert_eq_const_safe!(r_strided, s_strided);
    }
...
make_runtime_and_compiletime! {
    fn gather_scatter() {
        ...
        unsafe {
            ...
            let pointers =
                x4::from_array([pointer, pointer.add(2), pointer.add(4), pointer.add(6)]);
        ...
        unsafe {
            ...
            assert_eq_const_safe!(x, [42., 1., 43., 3., 4., 5., 45., 7.]);
        }
    }
}

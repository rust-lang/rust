...
fn main() {
    ...
    impl i32x10 {
        ...
        fn to_array(self) -> [i32; 10] { unsafe { std::mem::transmute(self) } }
    }
    unsafe {
        ...
        assert_eq!(selected1.to_array(), mask.to_array());
        assert_eq!(selected2.to_array(), mask.to_array());
    }
    ...
    impl i32x20 {
        ...
        fn to_array(self) -> [i32; 20] { unsafe { std::mem::transmute(self) } }
    }
    unsafe {

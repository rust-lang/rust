    ...
    fn main() {
        unsafe {
            ...
            if cfg!(target_endian = "little") {
                assert_eq_const_safe!(i, 0b0101);
                assert_eq_const_safe!(a, [0b0101]);
            } else {
                assert_eq_const_safe!(i, 0b1010);
                assert_eq_const_safe!(a, [0b1010]);
            }
            ...
            if cfg!(target_endian = "little") {
                assert_eq_const_safe!(i, 0b0101000000001100);
                assert_eq_const_safe!(a, [0b00001100, 0b01010000]);
            } else {
                assert_eq_const_safe!(i, 0b0011000000001010);
                assert_eq_const_safe!(a, [0b00110000, 0b00001010]);
            }
        }
        ...
        unsafe {
            ...
            assert_eq_const_safe!(r.into_array(), e);

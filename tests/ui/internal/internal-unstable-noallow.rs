...
//@error-in-other-file:use of unstable library feature 'function'
//@error-in-other-file:use of unstable library feature 'struct_field'
//@error-in-other-file:use of unstable library feature 'method'
//@error-in-other-file:use of unstable library feature 'struct2_field'

...
//@ only-linux
//@ ignore-backends: gcc
//@ compile-flags: -Ctarget-feature=-crt-static -Ccodegen-units=1 -Clto -Cprefer-dynamic=off -Copt-level=0 -Tsanitizer=cfi -Cunsafe-allow-abi-mismatch=sanitizer -Zunstable-options --test
//@ run-pass

...
//@ only-linux
//@ ignore-backends: gcc
//@ compile-flags: -Ctarget-feature=-crt-static -Ccodegen-units=1 -Clto -Cprefer-dynamic=off -Copt-level=0 -Zsanitizer=cfi -Zsanitizer-cfi-generalize-pointers -Cunsafe-allow-abi-mismatch=sanitizer
//@ run-pass

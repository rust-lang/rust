//! Test using `#[arg_splat]` on tuple arguments of pointers to simple functions.
...
fn main() {
    ...
    #[rustfmt::skip]
    let fn_ptr: fn(#[arg_splat] (u32, i8)) = tuple_args;
    ...
    #[rustfmt::skip]
    let fn_ptr: fn(#[arg_splat] (u32, i8), f64) = splat_non_terminal_arg;
    fn_ptr(1, 2, 3.5);
    fn_ptr(1u32, 2i8, 3.5f64);

    // Bug #158603 regression test
    #[rustfmt::skip]
    let x: fn(#[arg_splat] (i32,)) = None.unwrap();
    x(1);
}

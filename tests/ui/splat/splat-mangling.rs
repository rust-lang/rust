...
fn main() {
    ...
    #[rustc_dump_symbol_name]
           //[legacy]~^ ERROR symbol-name(_ZN14splat_mangling4main70Type$LT$fn$LP$$C$$u20$$u23$$u5b$arg_splat$u5d$$LP$u8$C$u32$RP$$RP$$GT
    ...
    #[rustfmt::skip]
    #[rustc_dump_symbol_name]
           //[legacy]~^ ERROR symbol-name(_ZN14splat_mangling4main81Type$LT$fn$LP$$C$$u20$$u23$$u5b$arg_splat$u5d$$LP$$LP$u8$C$u32$RP$$C$$RP$$RP$$GT
           //[legacy]~| ERROR demangling(splat_mangling::main::Type<fn(, #[arg_splat]((u8,u32),))>::
           //[legacy]~| ERROR demangling-alt(splat_mangling::main::Type<fn(, #[arg_splat]((u8,u32),))>)
    ...
    #[rustfmt::skip]
    #[rustc_dump_symbol_name]
           //[legacy]~^ ERROR symbol-name(_ZN14splat_mangling4main84Type$LT$$BP$const$u20$fn$LP$$C$$u20$$u23$$u5b$arg_splat$u5d$$LP$u32$C$i8$RP$$RP$$GT
    ...
    #[rustfmt::skip]
    #[rustc_dump_symbol_name]
           //[legacy]~^ ERROR symbol-name(_ZN14splat_mangling4main76Type$LT$fn$LP$$C$$u20$$u23$$u5b$arg_splat$u5d$$LP$u32$C$i8$RP$$C$f64$RP$$GT

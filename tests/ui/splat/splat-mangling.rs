...
fn main() {
    ...
    #[rustc_dump_symbol_name]
           ...
           //[legacy]~| NOTE demangling(splat_mangling::main::Type<fn(#[rustc_splat] (u8,u32))>::
           //[legacy]~| NOTE demangling-alt(splat_mangling::main::Type<fn(#[rustc_splat] (u8,u32))>)
    //[v0,default]~^^^^ ERROR symbol-name(_RMNvCsCRATE_HASH_14splat_mangling4mainINtB<REF>_4TypeFwThmEEuE)
       //[v0,default]~| NOTE demangling(<splat_mangling[
       //[v0,default]~| NOTE demangling-alt(<splat_mangling::main::Type<fn(#[splat] (u8, u32))>>)
    impl Type<fn(#[rustc_splat] (u8, u32))> {}

    #[rustfmt::skip]
    #[rustc_dump_symbol_name]
           //[legacy]~^ ERROR symbol-name(_ZN14splat_mangling4main38Type$LT$fn$LP$$LP$u8$C$u32$RP$$RP$$GT
           //[legacy]~| NOTE demangling(splat_mangling::main::Type<fn((u8,u32))>::
           //[legacy]~| NOTE demangling-alt(splat_mangling::main::Type<fn((u8,u32))>)
    //[v0,default]~^^^^ ERROR symbol-name(_RMs_NvCsCRATE_HASH_14splat_mangling4mainINtB<REF>_4TypeFThmEEuE)
       //[v0,default]~| NOTE demangling(<splat_mangling[
       //[v0,default]~| NOTE demangling-alt(<splat_mangling::main::Type<fn((u8, u32))>>)
    impl Type<fn((u8, u32))> {}
    ...
    #[rustc_dump_symbol_name]
           ...
           //[legacy]~| NOTE demangling(splat_mangling::main::Type<*const fn(#[rustc_splat] (u32,i8))>::
           //[legacy]~| NOTE demangling-alt(splat_mangling::main::Type<*const fn(#[rustc_splat] (u32,i8))>)
    //[v0,default]~^^^^ ERROR symbol-name(_RMs2_NvCsCRATE_HASH_14splat_mangling4mainINtB<REF>_4TypePFwTmaEEuE)
       //[v0,default]~| NOTE demangling(<splat_mangling[
       //[v0,default]~| NOTE demangling-alt(<splat_mangling::main::Type<*const fn(#[splat] (u32, i8))>>)
    ...
    #[rustc_dump_symbol_name]
           ...
           //[legacy]~| NOTE demangling(splat_mangling::main::Type<*const fn((u32,i8))>::
           //[legacy]~| NOTE demangling-alt(splat_mangling::main::Type<*const fn((u32,i8))>)
    //[v0,default]~^^^^ ERROR symbol-name(_RMs3_NvCsCRATE_HASH_14splat_mangling4mainINtB<REF>_4TypePFTmaEEuE)
       //[v0,default]~| NOTE demangling(<splat_mangling[
       //[v0,default]~| NOTE demangling-alt(<splat_mangling::main::Type<*const fn((u32, i8))>>)
    ...
    #[rustc_dump_symbol_name]
           ...
           //[legacy]~| NOTE demangling(splat_mangling::main::Type<fn(#[rustc_splat] (u32,i8),f64)>::
           //[legacy]~| NOTE demangling-alt(splat_mangling::main::Type<fn(#[rustc_splat] (u32,i8),f64)>)
    //[v0,default]~^^^^ ERROR symbol-name(_RMs4_NvCsCRATE_HASH_14splat_mangling4mainINtB<REF>_4TypeFwTmaEdEuE)
       //[v0,default]~| NOTE demangling(<splat_mangling[
       //[v0,default]~| NOTE demangling-alt(<splat_mangling::main::Type<fn(#[splat] (u32, i8), f64)>>)
    ...
    #[rustc_dump_symbol_name]
           ...
           //[legacy]~| NOTE demangling(splat_mangling::main::Type<fn((u32,i8),f64)>::
           //[legacy]~| NOTE demangling-alt(splat_mangling::main::Type<fn((u32,i8),f64)>)
    //[v0,default]~^^^^ ERROR symbol-name(_RMs5_NvCsCRATE_HASH_14splat_mangling4mainINtB<REF>_4TypeFTmaEdEuE)
       //[v0,default]~| NOTE demangling(<splat_mangling[
       //[v0,default]~| NOTE demangling-alt(<splat_mangling::main::Type<fn((u32, i8), f64)>>)
    ...
    #[rustc_dump_symbol_name]
           ...
           //[legacy]~| NOTE demangling(splat_mangling::main::Type<*mut fn(u32,i8,#[rustc_splat] (f64,))>::
           //[legacy]~| NOTE demangling-alt(splat_mangling::main::Type<*mut fn(u32,i8,#[rustc_splat] (f64,))>)
    //[v0,default]~^^^^ ERROR symbol-name(_RMs6_NvCsCRATE_HASH_14splat_mangling4mainINtB<REF>_4TypeOFmawTdEEuE)
       //[v0,default]~| NOTE demangling(<splat_mangling[
       //[v0,default]~| NOTE demangling-alt(<splat_mangling::main::Type<*mut fn(u32, i8, #[splat] (f64,))>>)
    ...
    #[rustc_dump_symbol_name]
           ...
           //[legacy]~| NOTE demangling(splat_mangling::main::Type<*mut fn(u32,i8,(f64,))>::
           //[legacy]~| NOTE demangling-alt(splat_mangling::main::Type<*mut fn(u32,i8,(f64,))>)
    //[v0,default]~^^^^ ERROR symbol-name(_RMs7_NvCsCRATE_HASH_14splat_mangling4mainINtB<REF>_4TypeOFmaTdEEuE)
       //[v0,default]~| NOTE demangling(<splat_mangling[
       //[v0,default]~| NOTE demangling-alt(<splat_mangling::main::Type<*mut fn(u32, i8, (f64,))>>)
    ...
    #[rustc_dump_symbol_name]
           ...
           //[legacy]~| NOTE demangling(splat_mangling::main::Type<&fn(u32,#[rustc_splat] (i8,f32,usize),f64)>::
           //[legacy]~| NOTE demangling-alt(splat_mangling::main::Type<&fn(u32,#[rustc_splat] (i8,f32,usize),f64)>)
    //[v0,default]~^^^^ ERROR symbol-name(_RMs8_NvCsCRATE_HASH_14splat_mangling4mainINtB<REF>_4TypeRFmwTafjEdEuE)
       //[v0,default]~| NOTE demangling(<splat_mangling[
       //[v0,default]~| NOTE demangling-alt(<splat_mangling::main::Type<&fn(u32, #[splat] (i8, f32, usize), f64)>>)
    ...
    #[rustc_dump_symbol_name]
           ...
           //[legacy]~| NOTE demangling(splat_mangling::main::Type<&fn(u32,(i8,f32,usize),f64)>::
           //[legacy]~| NOTE demangling-alt(splat_mangling::main::Type<&fn(u32,(i8,f32,usize),f64)>)
    //[v0,default]~^^^^ ERROR symbol-name(_RMs9_NvCsCRATE_HASH_14splat_mangling4mainINtB<REF>_4TypeRFmTafjEdEuE)
       //[v0,default]~| NOTE demangling(<splat_mangling[
       //[v0,default]~| NOTE demangling-alt(<splat_mangling::main::Type<&fn(u32, (i8, f32, usize), f64)>>)
    ...
    #[rustc_dump_symbol_name]
           ...
           //[legacy]~| NOTE demangling(splat_mangling::main::Type<&mut fn(u32,#[rustc_splat] (),f64)>::
           //[legacy]~| NOTE demangling-alt(splat_mangling::main::Type<&mut fn(u32,#[rustc_splat] (),f64)>)
    //[v0,default]~^^^^ ERROR symbol-name(_RMsa_NvCsCRATE_HASH_14splat_mangling4mainINtB<REF>_4TypeQFmwudEuE)
       //[v0,default]~| NOTE demangling(<splat_mangling[
       //[v0,default]~| NOTE demangling-alt(<splat_mangling::main::Type<&mut fn(u32, #[splat] (), f64)>>)
    ...
    #[rustc_dump_symbol_name]
           ...
           //[legacy]~| NOTE demangling(splat_mangling::main::Type<&mut fn(u32,(),f64)>::
           //[legacy]~| NOTE demangling-alt(splat_mangling::main::Type<&mut fn(u32,(),f64)>)
    //[v0,default]~^^^^ ERROR symbol-name(_RMsb_NvCsCRATE_HASH_14splat_mangling4mainINtB<REF>_4TypeQFmudEuE)
       //[v0,default]~| NOTE demangling(<splat_mangling[
       //[v0,default]~| NOTE demangling-alt(<splat_mangling::main::Type<&mut fn(u32, (), f64)>>)
    ...
    #[rustc_dump_symbol_name]
           ...
           //[legacy]~| NOTE demangling(splat_mangling::main::Type<alloc::boxed::Box<fn(u32,#[rustc_splat] (fn(#[rustc_splat] ()),i8),f64)>>::
           //[legacy]~| NOTE demangling-alt(splat_mangling::main::Type<alloc::boxed::Box<fn(u32,#[rustc_splat] (fn(#[rustc_splat] ()),i8),f64)>>)
    //[v0,default]~^^^^ ERROR symbol-name(_RMsc_NvCsCRATE_HASH_14splat_mangling4mainINtB<REF>_4TypeINtNtCsCRATE_HASH_5alloc5boxed3BoxFmwTFwuEuaEdEuEE)
       //[v0,default]~| NOTE demangling(<splat_mangling[
       //[v0,default]~| NOTE demangling-alt(<splat_mangling::main::Type<alloc::boxed::Box<fn(u32, #[splat] (fn(#[splat] ()), i8), f64)>>>)
    ...
    #[rustc_dump_symbol_name]
           ...
           //[legacy]~| NOTE demangling(splat_mangling::main::Type<alloc::boxed::Box<fn(u32,(fn(#[rustc_splat] ()),i8),f64)>>::
           //[legacy]~| NOTE demangling-alt(splat_mangling::main::Type<alloc::boxed::Box<fn(u32,(fn(#[rustc_splat] ()),i8),f64)>>)
    //[v0,default]~^^^^ ERROR symbol-name(_RMsd_NvCsCRATE_HASH_14splat_mangling4mainINtB<REF>_4TypeINtNtCsCRATE_HASH_5alloc5boxed3BoxFmTFwuEuaEdEuEE)
       //[v0,default]~| NOTE demangling(<splat_mangling[
       //[v0,default]~| NOTE demangling-alt(<splat_mangling::main::Type<alloc::boxed::Box<fn(u32, (fn(#[splat] ()), i8), f64)>>>)
    ...
    #[rustc_dump_symbol_name]
           ...
           //[legacy]~| NOTE demangling(splat_mangling::main::Type<alloc::boxed::Box<fn(u32,#[rustc_splat] (fn(()),i8),f64)>>::
           //[legacy]~| NOTE demangling-alt(splat_mangling::main::Type<alloc::boxed::Box<fn(u32,#[rustc_splat] (fn(()),i8),f64)>>)
    //[v0,default]~^^^^ ERROR symbol-name(_RMse_NvCsCRATE_HASH_14splat_mangling4mainINtB<REF>_4TypeINtNtCsCRATE_HASH_5alloc5boxed3BoxFmwTFuEuaEdEuEE)
       //[v0,default]~| NOTE demangling(<splat_mangling[
       //[v0,default]~| NOTE demangling-alt(<splat_mangling::main::Type<alloc::boxed::Box<fn(u32, #[splat] (fn(()), i8), f64)>>>)
    ...
    #[rustc_dump_symbol_name]
           ...
           //[legacy]~| NOTE demangling(splat_mangling::main::Type<alloc::boxed::Box<fn(u32,(fn(()),i8),f64)>>::
           //[legacy]~| NOTE demangling-alt(splat_mangling::main::Type<alloc::boxed::Box<fn(u32,(fn(()),i8),f64)>>)
    //[v0,default]~^^^^ ERROR symbol-name(_RMsf_NvCsCRATE_HASH_14splat_mangling4mainINtB<REF>_4TypeINtNtCsCRATE_HASH_5alloc5boxed3BoxFmTFuEuaEdEuEE)
       //[v0,default]~| NOTE demangling(<splat_mangling[
       //[v0,default]~| NOTE demangling-alt(<splat_mangling::main::Type<alloc::boxed::Box<fn(u32, (fn(()), i8), f64)>>>)

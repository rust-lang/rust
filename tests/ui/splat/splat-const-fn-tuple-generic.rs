//@ run-pass
//! Test using `#[arg_splat]` on tuple arguments of const functions with generics.

#![allow(incomplete_features)]
#![feature(arg_splat)]

// Generic type in first position
const fn const_generic_first<T: Copy>(#[arg_splat] _: (T, u32)) {}

// Generic type in second position
const fn const_generic_second<T: Copy>(#[arg_splat] _: (u32, T)) {}

// Multiple generic types
const fn const_generic_both<T: Copy, U: Copy>(#[arg_splat] _: (T, U)) {}

// Generic with extra non-splatted arg
const fn const_generic_extra<T: Copy>(#[arg_splat] _: (T, u32), _extra: i32) {}

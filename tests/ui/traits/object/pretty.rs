...
//~^ WARN associated type bound for `Assoc` in `dyn Fixed` differs from associated type bound from supertrait
...
//~^ WARN associated type bound for `Assoc2` in `dyn FixedGeneric1` differs from associated type bound from supertrait

...
//@[bpf] error-in-other-file: linker flavor `bpf-linker` is unstable, the `-Z unstable-options` flag
// [bpf] needs-llvm-components:
//@[ptx] compile-flags: --target=nvptx64-nvidia-cuda -C linker-flavor=ptx-linker --crate-type=rlib
//@[ptx] error-in-other-file: linker flavor `ptx-linker` is unstable, the `-Z unstable-options` flag

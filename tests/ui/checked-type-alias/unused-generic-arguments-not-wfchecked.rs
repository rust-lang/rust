...
//
// FIXME(checked_type_aliases): I consider #100041 to be a stabilization-blocking concern for
//                         the checked version of LTA! The *entire premise* of checked_LTA
//                         is wfchecking; we can't have such obvious holes in it!
//

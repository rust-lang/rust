...
//
// FIXME(checked_type_aliases, #100041): At the time of writing however, that's not the case.
//                                  I consider this to be stabilization-blocking concern for the
//                                  strong checked version of LTA!

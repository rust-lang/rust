...
reuse generic_arguments::Trait::<_>::foo::<i32> as generic_arguments1;
//~^ ERROR mismatched types
reuse <u8 as generic_arguments::Trait<_>>::foo as generic_arguments2;
//~^ ERROR mismatched types
reuse <_ as generic_arguments::Trait<_>>::foo as generic_arguments3; // OK

...
//The goal of this test is to verify if, with the specified SimplifyCfg passes disabled, rustc can
//query an unreachable MIR block containing a drop without applying its effects.

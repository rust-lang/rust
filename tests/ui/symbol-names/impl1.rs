...
mod foo {
    ...
    impl Foo {
        ...
        //[legacy]~| NOTE demangling(impl1::foo::Foo::bar
        //[legacy]~| NOTE demangling-alt(impl1::foo::Foo::bar)
         //[v0]~^^^^ ERROR symbol-name(_RNvMNtCs
            //[v0]~| NOTE demangling(<impl1[
            //[v0]~| NOTE demangling-alt(<impl1::foo::Foo>::bar)
        #[rustc_dump_def_path]
...
mod bar {
    ...
    impl Foo {
        ...
        //[legacy]~| NOTE demangling(impl1::bar::<impl impl1::foo::Foo>::baz
        //[legacy]~| NOTE demangling-alt(impl1::bar::<impl impl1::foo::Foo>::baz)
         //[v0]~^^^^ ERROR symbol-name(_RNvMNtCs
            //[v0]~| NOTE demangling(<impl1[
            //[v0]~| NOTE demangling-alt(<impl1::foo::Foo>::baz)
        #[rustc_dump_def_path]
...
fn main() {
    ...
    || {
        ...
        impl Bar for [&'_ (dyn Foo<Assoc = extern "C" fn(&u8, ...)> + AutoTrait); 3] {
            ...
            //[legacy]~| NOTE demangling(<[&dyn impl1::Foo+Assoc = extern "C" fn(&u8, ::.)+impl1::AutoTrait; 3] as impl1::main::{{closure}}::Bar>::method
            //[legacy]~| NOTE demangling-alt(<[&dyn impl1::Foo+Assoc = extern "C" fn(&u8, ::.)+impl1::AutoTrait; 3] as impl1::main::{{closure}}::Bar>::method)
             //[v0]~^^^^ ERROR symbol-name(_RNvXNCNvCs
                //[v0]~| NOTE demangling(<[&dyn
                //[v0]~| NOTE demangling-alt(<[&dyn impl1::Foo<Assoc = for<'a> extern "C" fn(&'a u8, ...)> + impl1::AutoTrait; 3] as impl1::main::{closure#1}::Bar>::method)
            #[rustc_dump_def_path]

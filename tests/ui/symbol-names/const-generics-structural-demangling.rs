...
//~^ ERROR symbol-name
//~| NOTE demangling
//~| NOTE demangling-alt(<c::RefByte<{&123}>>)
impl RefByte<{ &123 }> {}
...
//~^ ERROR symbol-name
//~| NOTE demangling
//~| NOTE demangling-alt(<c::Array3Bytes<{[1, 2, 3]}>>)
...
//~^ ERROR symbol-name
//~| NOTE demangling
//~| NOTE demangling-alt(<c::TupleByteBool<{(1, false)}>>)
...
//~^ ERROR symbol-name
//~| NOTE demangling
//~| NOTE demangling-alt(<c::OptionUsize<{c::MyOption::<usize>::None}>>)
...
//~^ ERROR symbol-name
//~| NOTE demangling
//~| NOTE demangling-alt(<c::OptionUsize<{c::MyOption::<usize>::Some(0)}>>)
...
//~^ ERROR symbol-name
//~| NOTE demangling
//~| NOTE demangling-alt(<c::Foo_<{c::Foo { s: "abc", ch: 'x', slice: &[1, 2, 3] }}>>)
...
macro duplicate_field_name_test($x:ident) {
    ...
    //~^ ERROR symbol-name
    //~| NOTE demangling
    //~| NOTE demangling-alt(<c::Bar_<{c::Bar { x: 123, x: 4096 }}>>)

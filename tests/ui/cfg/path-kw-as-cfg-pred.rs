...
macro_rules! foo {
    () => {
        ...
        #[cfg_attr(true, cfg($crate))] //~ ERROR `cfg` predicate key must be an identifier
...
#[cfg_attr(true, cfg(crate))] //~ ERROR `cfg` predicate key must be an identifier
mod _cfg_attr_true_cfg_crate {}
#[cfg_attr(true, cfg(super))] //~ ERROR `cfg` predicate key must be an identifier
mod _cfg_attr_true_cfg_super {}
#[cfg_attr(true, cfg(self))] //~ ERROR `cfg` predicate key must be an identifier
...
#[cfg(r#crate)] //~ ERROR `cfg` predicate key must be an identifier
//~^ ERROR `crate` cannot be a raw identifier
mod _cfg_r_crate {}
#[cfg(r#super)] //~ ERROR `cfg` predicate key must be an identifier
//~^ ERROR `super` cannot be a raw identifier
mod _cfg_r_super {}
#[cfg(r#self)] //~ ERROR `cfg` predicate key must be an identifier
//~^ ERROR `self` cannot be a raw identifier
mod _cfg_r_self_lower {}
#[cfg(r#Self)] //~ ERROR `cfg` predicate key must be an identifier
//~^ ERROR `Self` cannot be a raw identifier
mod _cfg_r_self_upper {}
#[cfg_attr(r#crate, cfg(r#crate))] //~ ERROR `cfg` predicate key must be an identifier
//~^ ERROR `cfg` predicate key must be an identifier
//~^^ ERROR `crate` cannot be a raw identifier
//~^^^ ERROR `crate` cannot be a raw identifier
mod _cfg_attr_r_crate {}
#[cfg_attr(r#super, cfg(r#super))] //~ ERROR `cfg` predicate key must be an identifier
//~^ ERROR `cfg` predicate key must be an identifier
//~^^ ERROR `super` cannot be a raw identifier
//~^^^ ERROR `super` cannot be a raw identifier
mod _cfg_attr_r_super {}
#[cfg_attr(r#self, cfg(r#self))] //~ ERROR `cfg` predicate key must be an identifier
//~^ ERROR `cfg` predicate key must be an identifier
//~^^ ERROR `self` cannot be a raw identifier
//~^^^ ERROR `self` cannot be a raw identifier

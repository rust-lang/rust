// backchain on s390x is enabled with -Cforce-frame-pointers + -Zunstable-options
//@ add-minicore
...
//@ [backchain_cli] compile-flags: -Cforce-frame-pointers -Zunstable-options
//@ [backchain_cli] should-fail
//@ [backchain_cli] needs-llvm-components: systemz

//@ [with_softfloat] compile-flags: -Cforce-frame-pointers -Zunstable-options

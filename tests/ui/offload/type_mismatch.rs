...
fn main() {
    ...
    let not_fn = 42;
    core::intrinsics::offload::<_, _, ()>(not_fn, [1, 1, 1], [1, 1, 1], 0, -1, ());
    //~^ ERROR expected a function item for the offload kernel, found `i32`

    // argument count mismatch
    core::intrinsics::offload::<_, _, ()>(kernel_1, [1, 1, 1], [1, 1, 1], 0, -1, ());
    //~^ ERROR offload kernel expects 1 arguments, but 0 arguments were provided

    // argument type mismatch
    core::intrinsics::offload::<_, _, ()>(kernel_1, [1, 1, 1], [1, 1, 1], 0, -1, (42.0f64,));
    //~^ ERROR type mismatch in offload kernel argument 0: expected `f32`, found `f64`

    // return type mismatch
    let _: f64 = core::intrinsics::offload::<_, _, f64>(kernel_0, [1, 1, 1], [1, 1, 1], 0, -1, ());

...
//@ ignore-backends: gcc
#![feature(no_core, rustc_attrs, lang_items, pattern_type, pattern_type_macros)]
...
test_abi_compatible!(nonzero_int, pattern_type!(i32 is 1..), i32);
...
test_nonnull!(non_zero, pattern_type!(i32 is 1..));

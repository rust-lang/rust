...
//@ignore-target-asmjs no weak symbol support
//@ignore-target-emscripten no weak symbol support
//@ignore-target-windows no extern_weak linkage
//@ignore-target-macos no extern_weak linkage

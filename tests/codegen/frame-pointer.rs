...
// CHECK-X64-LINUX-NOT: {{.*}}"frame-pointer"{{.*}}
// CHECK-AARCH64-LINUX-NOT: {{.*}}"frame-pointer"{{.*}}
// CHECK-X64-APPLE-SAME: {{.*}}"frame-pointer"="all"
// CHECK-FORCE-SAME: {{.*}}"frame-pointer"="all"
// CHECK-AARCH64-APPLE-SAME: {{.*}}"frame-pointer"="non-leaf"
// CHECK-SAME: }

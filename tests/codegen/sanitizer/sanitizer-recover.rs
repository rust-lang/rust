...
//@[ASAN-RECOVER]     compile-flags: -Zunstable-options -Csanitizer=address
//@[ASAN-RECOVER]     compile-flags: -Zsanitizer-recover=address -Copt-level=0
//@[MSAN]             compile-flags: -Zunstable-options -Csanitizer=memory
//@[MSAN-RECOVER]     compile-flags: -Zunstable-options -Csanitizer=memory
//@[MSAN-RECOVER]     compile-flags: -Zsanitizer-recover=memory
//@[MSAN-RECOVER-LTO] compile-flags: -Zunstable-options -Csanitizer=memory
//@[MSAN-RECOVER-LTO] compile-flags: -Zsanitizer-recover=memory -C lto=fat
//

...
// CHECK-WINDOWS: $__llvm_profile_runtime_user = comdat any
...
// CHECK-WINDOWS: @__llvm_profile_runtime = external{{.*}}global i32
...
// CHECK-WINDOWS: define linkonce_odr hidden i32 @__llvm_profile_runtime_user() #[[LLVM_PROFILE_RUNTIME_USER_ATTR:[0-9]+]] comdat {
// CHECK-WINDOWS-NEXT:  %1 = load i32, ptr @__llvm_profile_runtime
// CHECK-WINDOWS-NEXT:  ret i32 %1
// CHECK-WINDOWS-NEXT:  }

// CHECK:         attributes #[[LLVM_INSTRPROF_INCREMENT_ATTR]] = { nounwind }
// CHECK-WINDOWS: attributes #[[LLVM_PROFILE_RUNTIME_USER_ATTR]] = { noinline }

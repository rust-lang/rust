...
pub unsafe fn swap_i32(x: &mut i32, y: &mut i32) {
    ...
    // CHECK-OPT3-SAME: !noundef
    // CHECK-OPT0: %[[TEMP2:.+]] = load i32, ptr %y, align 4
    // CHECK-OPT0: store i32 %[[TEMP2]], ptr %x, align 4
    // CHECK-OPT0-NOT: memcpy
    // CHECK-OPT3-NOT: load
    // CHECK-OPT3: call void @llvm.memcpy.p0.p0.i64(ptr align 4 %x, ptr align 4 %y, i64 4, i1 false)
...
// CHECK-OPT0-LABEL: @swap_string(
#[no_mangle]
pub unsafe fn swap_string(x: &mut String, y: &mut String) {
    // CHECK-OPT0: %[[TEMP:.+]] = alloca {{.+}}, align 8
    // CHECK-OPT0: call void @llvm.memcpy.p0.p0.i64(ptr align 8 %[[TEMP]], ptr align 8 %x, i64 24, i1 false)
    // CHECK-OPT0: call void @llvm.memcpy.p0.p0.i64(ptr align 8 %x, ptr align 8 %y, i64 24, i1 false)
    // CHECK-OPT0: call void @llvm.memcpy.p0.p0.i64(ptr align 8 %y, ptr align 8 %[[TEMP]], i64 24, i1 false)
    typed_swap(x, y)
}

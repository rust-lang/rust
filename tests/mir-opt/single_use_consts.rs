...
// EMIT_MIR single_use_consts.if_const.GVN.diff
...
// EMIT_MIR single_use_consts.match_const.GVN.diff
...
// EMIT_MIR single_use_consts.if_const_debug.GVN.diff
fn if_const_debug<T: MyTrait>() -> i32 {
    // CHECK-LABEL: fn if_const_debug(
    // CHECK: debug my_bool => const <T as MyTrait>::ASSOC_BOOL;
    // CHECK: switchInt(const <T as MyTrait>::ASSOC_BOOL)
...
// EMIT_MIR single_use_consts.match_const_debug.GVN.diff
fn match_const_debug<T: MyTrait>() -> &'static str {
    // CHECK-LABEL: fn match_const_debug(
    // CHECK: debug my_int => const <T as MyTrait>::ASSOC_INT;
    // CHECK: switchInt(const <T as MyTrait>::ASSOC_INT)
...
// EMIT_MIR single_use_consts.never_used_debug.GVN.diff
...
// EMIT_MIR single_use_consts.assign_const_to_return.GVN.diff
...
// EMIT_MIR single_use_consts.keep_parameter.GVN.diff

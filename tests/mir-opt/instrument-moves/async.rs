//@ compile-flags: -Z instrument-moves -Z instrument-moves-size-limit=1 -C debuginfo=full
//@ edition: 2021
...
// EMIT_MIR async.test_async.InstrumentMoves.after.mir
...
// EMIT_MIR async.test_future_move.InstrumentMoves.after.mir

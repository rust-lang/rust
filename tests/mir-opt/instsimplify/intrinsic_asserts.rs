...
// EMIT_MIR intrinsic_asserts.removable.InstSimplify-before-unreachable-propagation.diff
pub fn removable() {
...
// EMIT_MIR intrinsic_asserts.panics.InstSimplify-before-unreachable-propagation.diff
pub fn panics() {
...
// EMIT_MIR intrinsic_asserts.generic.InstSimplify-before-unreachable-propagation.diff
pub fn generic<T>() {
...
// Whether or not these asserts pass isn't known, so they shouldn't be modified.
// EMIT_MIR intrinsic_asserts.generic_ref.InstSimplify-before-unreachable-propagation.diff

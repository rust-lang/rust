...
//@ has 'repr/struct.ReprCNonExhaustiveStruct.html'
//@ !has - '//*[@class="rust item-decl"]//*[@class="code-attribute"]' '#[repr(C)]'
//@ has - '//*[@class="rust item-decl"]//*[@class="code-attribute"]' '#[non_exhaustive]'
#[repr(C)] // private...
#[non_exhaustive] // ...since this is non-exhaustive
pub struct ReprCNonExhaustiveStruct {
    pub field: u64,
}

//@ has 'repr/enum.ReprCNonExhaustiveEnum.html'
//@ !has - '//*[@class="rust item-decl"]//*[@class="code-attribute"]' '#[repr(C)]'
//@ has - '//*[@class="rust item-decl"]//*[@class="code-attribute"]' '#[non_exhaustive]'
#[repr(C)] // private...
#[non_exhaustive] // ...since this is non-exhaustive
pub enum ReprCNonExhaustiveEnum {
    Variant0,
    Variant1(i16, i16),
}

//@ has 'repr/enum.ReprCNonExhaustiveVariant.html'
//@ !has - '//*[@class="rust item-decl"]//*[@class="code-attribute"]' '#[repr(usize)]'
#[repr(usize)] // private...
pub enum ReprCNonExhaustiveVariant {
    Variant0,
    #[non_exhaustive]
    Variant1(i16, i16), // ...since this is non-exhaustive
}

...
pub mod sub2 {
    extern "C" {
        //@ has foreigntype_reexport/sub2/externtype.C.html
        pub type C;
...
//@ has foreigntype_reexport/externtype.C2.html
//@ has foreigntype_reexport/fn.f2.html
//@ has foreigntype_reexport/static.K2.html
//@ has foreigntype_reexport/index.html '//a[@class="externtype"]' 'C2'
...
//@ has foreigntype_reexport/index.html '//a[@class="externtype"]' 'C'
...
//@ has foreigntype_reexport/externtype.C4.html
//@ has foreigntype_reexport/fn.f4.html
//@ has foreigntype_reexport/static.K4.html
//@ !has foreigntype_reexport/externtype.X4.html
//@ has foreigntype_reexport/index.html '//a[@class="externtype"]' 'C4'
//@ has foreigntype_reexport/index.html '//a[@class="fn"]' 'f4'
//@ has foreigntype_reexport/index.html '//a[@class="static"]' 'K4'
//@ !has foreigntype_reexport/index.html '//a[@class="externtype"]' 'X4'
pub use self::sub3::*;

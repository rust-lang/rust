...
// item that's nested inside of a body (e.g., of a function or constant), we tried to look up the
// definition in the `TypeckResults` of the body owner which is wrong and lead to compiler ICEs.
//

...
mod chars_next {
    ...
    fn bench(b: &mut Bencher, corpus: &str) {
        b.iter(|| black_box(corpus.chars().next()));
    }
    ...
    #[bench]
    fn ru(b: &mut Bencher) {
        bench(b, corpora::ru::HUGE);
    }

    #[bench]
    fn emoji(b: &mut Bencher) {
        bench(b, corpora::emoji::HUGE);
    }
}
...
mod chars_rev_next {
    ...
    fn bench(b: &mut Bencher, corpus: &str) {
        b.iter(|| black_box(corpus.chars().next_back()));
    }
...
mod chars_for_each {
    ...
    fn bench(b: &mut Bencher, corpus: &str) {
        b.iter(|| black_box(corpus.chars().for_each(|_| {})));
    }
...
mod chars_rev_for_each {
    ...
    fn bench(b: &mut Bencher, corpus: &str) {
        b.iter(|| black_box(corpus.chars().rev().for_each(|_| {})));
    }
...
mod chars_sum {
    ...
    fn bench(b: &mut Bencher, corpus: &str) {
        b.iter(|| black_box(corpus.chars().map(u32::from).sum::<u32>()));
    }
...
mod chars_sum_rev {
    ...
    fn bench(b: &mut Bencher, corpus: &str) {
        b.iter(|| black_box(corpus.chars().rev().map(u32::from).sum::<u32>()));
    }

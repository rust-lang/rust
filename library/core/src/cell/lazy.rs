...
/// //   92
/// ```
#[stable(feature = "lazy_cell_fn_pointer", since = "CURRENT_RUSTC_VERSION")]
pub struct LazyCell<T, #[unstable(feature = "lazy_cell", issue = "109736")] F = fn() -> T> {
...
impl<T, F: FnOnce() -> T> LazyCell<T, F> {
    ...
    #[inline]
    #[stable(feature = "lazy_cell_fn_pointer", since = "CURRENT_RUSTC_VERSION")]
    #[rustc_const_stable(feature = "lazy_cell_fn_pointer", since = "CURRENT_RUSTC_VERSION")]

...
pub trait Pattern<H: Haystack + ?Sized>: Sized {
    ...
    type Searcher<'a>: Searcher<'a, H>
    where
        H: 'a;

    /// Constructs the associated searcher from
    /// `self` and the `haystack` to search in.
    fn into_searcher(self, haystack: &H) -> Self::Searcher<'_>;
    ...
    #[inline]
    fn is_suffix_of<'a>(self, haystack: &'a H) -> bool
    where
        Self::Searcher<'a>: ReverseSearcher<'a, H>,
    {
        matches!(
    ...
    #[inline]
    fn strip_suffix_of<'a>(self, haystack: &'a H) -> Option<&'a H>
    where
        Self::Searcher<'a>: ReverseSearcher<'a, H>,
    {
...
pub unsafe trait Searcher<'a, H: Haystack + ?Sized> {
...
pub unsafe trait ReverseSearcher<'a, H: Haystack + ?Sized>: Searcher<'a, H> {
...
impl Pattern<str> for char {
    ...
    #[inline]
    fn into_searcher<'a>(self, haystack: &'a str) -> CharSearcher<'a> {
    ...
    where
        Self::Searcher<'a>: ReverseSearcher<'a, str>,
    {

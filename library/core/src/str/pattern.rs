...
pub use crate::pattern::{
    DoubleEndedSearcher, Haystack, MatchOnly, Pattern, RejectOnly, ReverseSearcher, SearchResult,
    SearchStep, Searcher, Utf8Pattern,
};
use crate::{fmt, str_bytes};
...
impl Pattern<str> for char {
    ...
    fn is_contained_in(self, haystack: &str) -> bool {
        self.encode_utf8(&mut [0u8; 4]).is_contained_in(haystack)
    }

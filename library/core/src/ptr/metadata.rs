...
/// ```
#[inline]
pub const fn metadata<T: ?Sized + PointeeSized>(ptr: *const T) -> <T as Pointee>::Metadata {
    ptr_metadata(ptr)
}
...
#[unstable(feature = "ptr_metadata", issue = "81513")]
#[inline]
pub const fn from_raw_parts<T: ?Sized + PointeeSized>(
...
#[unstable(feature = "ptr_metadata", issue = "81513")]
#[inline]
pub const fn from_raw_parts_mut<T: ?Sized + PointeeSized>(
...
#[lang = "dyn_metadata"]
pub struct DynMetadata<Dyn: ?Sized + PointeeSized> {
...
impl<Dyn: ?Sized + PointeeSized> DynMetadata<Dyn> {
...
unsafe impl<Dyn: ?Sized + PointeeSized> Send for DynMetadata<Dyn> {}
unsafe impl<Dyn: ?Sized + PointeeSized> Sync for DynMetadata<Dyn> {}

impl<Dyn: ?Sized + PointeeSized> fmt::Debug for DynMetadata<Dyn> {
...
impl<Dyn: ?Sized + PointeeSized> Unpin for DynMetadata<Dyn> {}

impl<Dyn: ?Sized + PointeeSized> Copy for DynMetadata<Dyn> {}

impl<Dyn: ?Sized + PointeeSized> Clone for DynMetadata<Dyn> {
    #[inline]
    fn clone(&self) -> Self {
        *self
    }
...
impl<Dyn: ?Sized + PointeeSized> Eq for DynMetadata<Dyn> {}

impl<Dyn: ?Sized + PointeeSized> PartialEq for DynMetadata<Dyn> {
    #[inline]
...
impl<Dyn: ?Sized + PointeeSized> Ord for DynMetadata<Dyn> {
    #[inline]
...
impl<Dyn: ?Sized + PointeeSized> PartialOrd for DynMetadata<Dyn> {
    #[inline]
...
impl<Dyn: ?Sized + PointeeSized> Hash for DynMetadata<Dyn> {
    #[inline]

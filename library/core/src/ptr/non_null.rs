...
pub struct NonNull<T: ?Sized + PointeeSized> {
...
#[stable(feature = "nonnull", since = "1.25.0")]
impl<T: ?Sized + PointeeSized> !Send for NonNull<T> {}

/// `NonNull` pointers are not `Sync` because the data they reference may be aliased.
// N.B., this impl is unnecessary, but should provide better error messages.
#[stable(feature = "nonnull", since = "1.25.0")]
impl<T: ?Sized + PointeeSized> !Sync for NonNull<T> {}
...
impl<T: ?Sized + PointeeSized> NonNull<T> {
...
#[stable(feature = "nonnull", since = "1.25.0")]
impl<T: ?Sized + PointeeSized> Clone for NonNull<T> {
    #[inline(always)]
    fn clone(&self) -> Self {
        *self
    }
...
#[stable(feature = "nonnull", since = "1.25.0")]
impl<T: ?Sized + PointeeSized> Copy for NonNull<T> {}

#[unstable(feature = "coerce_unsized", issue = "18598")]
impl<T: ?Sized + PointeeSized, U: ?Sized + PointeeSized> CoerceUnsized<NonNull<U>> for NonNull<T> where
    T: Unsize<U>
{
}

#[unstable(feature = "dispatch_from_dyn", issue = "none")]
impl<T: ?Sized + PointeeSized, U: ?Sized + PointeeSized> DispatchFromDyn<NonNull<U>> for NonNull<T> where
    T: Unsize<U>
{
}

#[stable(feature = "pin", since = "1.33.0")]
unsafe impl<T: ?Sized + PointeeSized> PinCoerceUnsized for NonNull<T> {}

#[unstable(feature = "pointer_like_trait", issue = "none")]
impl<T> core::marker::PointerLike for NonNull<T> {}

#[stable(feature = "nonnull", since = "1.25.0")]
impl<T: ?Sized + PointeeSized> fmt::Debug for NonNull<T> {
...
#[stable(feature = "nonnull", since = "1.25.0")]
impl<T: ?Sized + PointeeSized> fmt::Pointer for NonNull<T> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        fmt::Pointer::fmt(&self.as_ptr(), f)
    }
}
...
#[stable(feature = "nonnull", since = "1.25.0")]
impl<T: ?Sized + PointeeSized> Eq for NonNull<T> {}

#[stable(feature = "nonnull", since = "1.25.0")]
impl<T: ?Sized + PointeeSized> PartialEq for NonNull<T> {
    #[inline]
...
#[stable(feature = "nonnull", since = "1.25.0")]
impl<T: ?Sized + PointeeSized> Ord for NonNull<T> {
    #[inline]
    #[allow(ambiguous_wide_pointer_comparisons)]
...
#[stable(feature = "nonnull", since = "1.25.0")]
impl<T: ?Sized + PointeeSized> PartialOrd for NonNull<T> {
    #[inline]
    #[allow(ambiguous_wide_pointer_comparisons)]
...
#[stable(feature = "nonnull", since = "1.25.0")]
impl<T: ?Sized + PointeeSized> hash::Hash for NonNull<T> {
    #[inline]
...
impl<T: ?Sized + PointeeSized> From<Unique<T>> for NonNull<T> {
    #[inline]
...
#[stable(feature = "nonnull", since = "1.25.0")]
impl<T: ?Sized + PointeeSized> From<&mut T> for NonNull<T> {
...
#[stable(feature = "nonnull", since = "1.25.0")]
impl<T: ?Sized + PointeeSized> From<&T> for NonNull<T> {

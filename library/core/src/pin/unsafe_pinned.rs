...
pub struct UnsafePinned<T: ?Sized + ?Forget> {
    value: UnsafeCell<T>,
}
...
#[unstable(feature = "unsafe_pinned", issue = "125735")]
impl<T: ?Sized + ?Forget> !Unpin for UnsafePinned<T> {}
...
// #[unstable(feature = "unsafe_pinned", issue = "125735")]
impl<T: DispatchFromDyn<U>, U: ?Forget> DispatchFromDyn<UnsafePinned<U>> for UnsafePinned<T> {}

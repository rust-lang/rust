...
///     fn clone(&self) -> Self {
///         let a: &u8 = &self.1;
///         // when self.0 points to self, we write to self.1 while we have a live `&u8` pointing to it -- this is UB
...
// `CloneFromCell` can be implemented for types that don't have indirection. A commonly-used subset is covered here.
#[unstable(feature = "cell_get_cloned", issue = "145329")]
...
#[unstable(feature = "cell_get_cloned", issue = "145329")]
unsafe impl<T: CloneFromCell> CloneFromCell for PhantomData<T> {}
#[unstable(feature = "cell_get_cloned", issue = "145329")]

...
pub trait AsRef<T: ?Sized + PointeeSized>: PointeeSized {
...
pub trait AsMut<T: ?Sized + PointeeSized>: PointeeSized {
...
// As lifts over &
#[stable(feature = "rust1", since = "1.0.0")]
impl<T: ?Sized + PointeeSized, U: ?Sized + PointeeSized> AsRef<U> for &T
where
    T: AsRef<U>,
{
    #[inline]
...
// As lifts over &mut
#[stable(feature = "rust1", since = "1.0.0")]
impl<T: ?Sized + PointeeSized, U: ?Sized + PointeeSized> AsRef<U> for &mut T
where
    T: AsRef<U>,
{
    #[inline]
...
#[stable(feature = "rust1", since = "1.0.0")]
impl<T: ?Sized + PointeeSized, U: ?Sized + PointeeSized> AsMut<U> for &mut T
where
    T: AsMut<U>,
{
    #[inline]

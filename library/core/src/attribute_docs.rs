...
#[doc(attribute = "doc")]
//
/// The `doc` attribute controls how documentation is generated and handled by rustdoc,
/// allowing you to include documentation comments, external files, and customize the presentation
/// of documentation.
///
/// It can be applied at both the crate and item levels to enhance the documentation process. The
/// `doc` attribute can be used in two forms `///` and `#[doc = "text"]` the `///` is a syntactic
/// sugar.
///
/// Example:
///
...
/// ```
///
/// At the crate level, use the inner-attribute form:
///
/// ```rust
/// #![doc = "Crate-level documentation goes here."]
/// ```
///
/// `#![doc]` can also be written as `//!`.
///
///
/// The attribute form is particularly useful when generating documentation in macros, since
/// multiple `#[doc]` attributes on the same item are merged into a single doc comment.
///
/// With external files:
///
...
/// ```
///
/// For more information, see the Reference on [the `doc` attribute].
///
/// [the `doc` attribute]: ../../rustdoc/write-documentation/the-doc-attribute.html
mod doc_attribute {}

#[doc(attribute = "feature")]
//
...
///
/// #[unstable(feature = "my_new_api", issue = "12345")]
/// pub fn greet() {}
/// ```
///
/// For more information, see the Reference on [the `feature` attribute].
///
/// [the `feature` attribute]: ../../unstable-book/the-unstable-book.html
mod feature_attribute {}

use crate::marker::{Forget, PointeeSized, Unsize};
...
#[lang = "coerce_unsized"]
pub trait CoerceUnsized<T: PointeeSized + ?Forget>: ?Forget {
    // Empty.
}

// &mut T -> &mut U
#[unstable(feature = "coerce_unsized", issue = "18598")]
impl<'a, T: PointeeSized + ?Forget + Unsize<U>, U: PointeeSized> CoerceUnsized<&'a mut U>
    for &'a mut T
{
}
// &mut T -> &U
#[unstable(feature = "coerce_unsized", issue = "18598")]
impl<'a, 'b: 'a, T: PointeeSized + ?Forget + Unsize<U>, U: PointeeSized> CoerceUnsized<&'a U>
    for &'b mut T
{
}
// &mut T -> *mut U
#[unstable(feature = "coerce_unsized", issue = "18598")]
impl<'a, T: PointeeSized + ?Forget + Unsize<U>, U: PointeeSized> CoerceUnsized<*mut U>
    for &'a mut T
{
}
// &mut T -> *const U
#[unstable(feature = "coerce_unsized", issue = "18598")]
impl<'a, T: PointeeSized + ?Forget + Unsize<U>, U: PointeeSized> CoerceUnsized<*const U>
    for &'a mut T
{
}
...
// &T -> *const U
#[unstable(feature = "coerce_unsized", issue = "18598")]
impl<'a, T: PointeeSized + ?Forget + Unsize<U>, U: PointeeSized> CoerceUnsized<*const U> for &'a T {}

// *mut T -> *mut U
#[unstable(feature = "coerce_unsized", issue = "18598")]
impl<T: PointeeSized + ?Forget + Unsize<U>, U: PointeeSized> CoerceUnsized<*mut U> for *mut T {}
// *mut T -> *const U
#[unstable(feature = "coerce_unsized", issue = "18598")]
impl<T: PointeeSized + ?Forget + Unsize<U>, U: PointeeSized> CoerceUnsized<*const U> for *mut T {}

// *const T -> *const U
#[unstable(feature = "coerce_unsized", issue = "18598")]
impl<T: PointeeSized + ?Forget + Unsize<U>, U: PointeeSized> CoerceUnsized<*const U> for *const T {}
...
pub trait DispatchFromDyn<T: ?Forget>: ?Forget {
    // Empty.
}

// &T -> &U
#[unstable(feature = "dispatch_from_dyn", issue = "none")]
impl<'a, T: PointeeSized + ?Forget + Unsize<U>, U: PointeeSized + ?Forget> DispatchFromDyn<&'a U>
    for &'a T
{
}
// &mut T -> &mut U
#[unstable(feature = "dispatch_from_dyn", issue = "none")]
impl<'a, T: PointeeSized + ?Forget + Unsize<U>, U: PointeeSized + ?Forget>
    DispatchFromDyn<&'a mut U> for &'a mut T
{
}
// *const T -> *const U
#[unstable(feature = "dispatch_from_dyn", issue = "none")]
impl<T: PointeeSized + ?Forget + Unsize<U>, U: PointeeSized + ?Forget> DispatchFromDyn<*const U>
    for *const T
{
}
// *mut T -> *mut U
#[unstable(feature = "dispatch_from_dyn", issue = "none")]
impl<T: PointeeSized + ?Forget + Unsize<U>, U: PointeeSized + ?Forget> DispatchFromDyn<*mut U>
    for *mut T
{
}

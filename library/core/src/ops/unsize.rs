...
#[lang = "coerce_unsized"]
pub trait CoerceUnsized<T: ?Sized + PointeeSized> {
    // Empty.
}

// &mut T -> &mut U
#[unstable(feature = "coerce_unsized", issue = "18598")]
impl<'a, T: ?Sized + PointeeSized + Unsize<U>, U: ?Sized + PointeeSized> CoerceUnsized<&'a mut U>
    for &'a mut T
{
}
// &mut T -> &U
#[unstable(feature = "coerce_unsized", issue = "18598")]
impl<'a, 'b: 'a, T: ?Sized + PointeeSized + Unsize<U>, U: ?Sized + PointeeSized>
    CoerceUnsized<&'a U> for &'b mut T
{
}
// &mut T -> *mut U
#[unstable(feature = "coerce_unsized", issue = "18598")]
impl<'a, T: ?Sized + PointeeSized + Unsize<U>, U: ?Sized + PointeeSized> CoerceUnsized<*mut U>
    for &'a mut T
{
}
// &mut T -> *const U
#[unstable(feature = "coerce_unsized", issue = "18598")]
impl<'a, T: ?Sized + PointeeSized + Unsize<U>, U: ?Sized + PointeeSized> CoerceUnsized<*const U>
    for &'a mut T
{
}
...
// *mut T -> *mut U
#[unstable(feature = "coerce_unsized", issue = "18598")]
impl<T: ?Sized + PointeeSized + Unsize<U>, U: ?Sized + PointeeSized> CoerceUnsized<*mut U>
    for *mut T
{
}
// *mut T -> *const U
#[unstable(feature = "coerce_unsized", issue = "18598")]
impl<T: ?Sized + PointeeSized + Unsize<U>, U: ?Sized + PointeeSized> CoerceUnsized<*const U>
    for *mut T
{
}
...
// &T -> &U
#[unstable(feature = "dispatch_from_dyn", issue = "none")]
impl<'a, T: ?Sized + PointeeSized + Unsize<U>, U: ?Sized + PointeeSized> DispatchFromDyn<&'a U>
    for &'a T
{
}
// &mut T -> &mut U
#[unstable(feature = "dispatch_from_dyn", issue = "none")]
impl<'a, T: ?Sized + PointeeSized + Unsize<U>, U: ?Sized + PointeeSized> DispatchFromDyn<&'a mut U>
    for &'a mut T
{
}
// *const T -> *const U
#[unstable(feature = "dispatch_from_dyn", issue = "none")]
impl<T: ?Sized + PointeeSized + Unsize<U>, U: ?Sized + PointeeSized> DispatchFromDyn<*const U>
    for *const T
{
}
// *mut T -> *mut U
#[unstable(feature = "dispatch_from_dyn", issue = "none")]
impl<T: ?Sized + PointeeSized + Unsize<U>, U: ?Sized + PointeeSized> DispatchFromDyn<*mut U>
    for *mut T
{
}

...
fn test_format_f64() {
    ...
    assert_eq!("10 100 100110011001100110011001100110011001100110011001100000000000000", format!("{:b}", -4.3f64));
    assert_eq!("0 111111111110 11001100110011001100110011001100110011001100110100000000000000", format!("{:b}", 1.55f64));
    assert_eq!("10 10001 110001111101111100111011011001000101101000011100100000000000000", format!("{:b}", -43.123f64));
    assert_eq!("0 110000 1110000111100100001111001001111011101100101111111100000000000000", format!("{:b}", 9999.1324f64));
    assert_eq!("10 111111100111 1010111000010100011110101110000101000111101011100000000000000000", format!("{:b}", -0.03f64));
    assert_eq!("0 111111100111 1010111000010100011110101110000101000111101011100000000000000000", format!("{:b}", 0.03f64));
    assert_eq!("0 111111000010 1000110110111000101110101100011100010000110010110100000000000000", format!("{:b}", 0.00005f64));
}
...
fn test_format_f32() {
    ...
    assert_eq!("10 100 1001100110011001101000000000000", format!("{:b}", -4.3f32));
    assert_eq!("0 111111110 110011001100110011000000000000", format!("{:b}", 1.55f32));
    assert_eq!("10 10001 1100011111011111010000000000000", format!("{:b}", -43.123f32));
    assert_eq!("0 110000 11100001111001000100000000000000", format!("{:b}", 9999.1324f32));
    assert_eq!("10 111100111 10101110000101000111100000000000", format!("{:b}", -0.03f32));
    assert_eq!("0 111100111 10101110000101000111100000000000", format!("{:b}", 0.03f32));
    assert_eq!("0 111000010 10001101101110001011100000000000", format!("{:b}", 0.00005f32));
}

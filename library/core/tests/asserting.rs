...
test!(
    capture_with_non_copyable_and_non_debugable_elem_has_correct_params,
    NoCopyNoDebug,
    None,
    "N/A"
);
...
test!(capture_with_non_debugable_elem_has_correct_params, NoDebug, None, "N/A");

test!(capture_with_copyable_and_debugable_elem_has_correct_params, 1i32, Some(1i32), "1");

...
pub(super) mod netc {
    ...
    pub use crate::sys::c::{
        ...
        SOCK_STREAM, SOCKADDR as sockaddr, SOCKADDR_STORAGE as sockaddr_storage, SOL_SOCKET,
        WSAEMSGSIZE as EMSGSIZE, bind, connect, freeaddrinfo, getpeername, getsockname, getsockopt,
        listen, setsockopt,
    };

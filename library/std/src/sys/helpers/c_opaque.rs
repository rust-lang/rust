...
///
/// Some libraries like UNIX's pthread have data types that must be treated as
/// entirely opaque. Soundly wrapping these types is very hard since Rust's
...
/// like `pthread_mutexattr_init` might not fully initialize the

...
//! exactly what we need for `SysRng`. Unfortunately, it's not available on all
//! UNIX systems, most notably Linux (until recently, but it's just a wrapper
//! for `getrandom`. Since we need to hook into `getrandom` directly for

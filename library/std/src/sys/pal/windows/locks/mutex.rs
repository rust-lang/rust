...
//!
//! 1. SRWLock is several times faster than CriticalSection according to benchmarks performed on
//!    both Windows 8 and Windows 7.
//!
...
//!
//! 3. While CriticalSection is fair and SRWLock is not, the current Rust policy is that there are

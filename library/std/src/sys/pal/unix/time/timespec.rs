...
pub(in crate::sys) struct Nanoseconds(pub u32);

#[derive(Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash)]
pub(crate) struct Timespec {
    pub(in crate::sys) tv_sec: i64,
    pub(in crate::sys) tv_nsec: Nanoseconds,
}
...
impl Timespec {
    ...
    pub(in crate::sys) const fn new(tv_sec: i64, tv_nsec: i64) -> Result<Timespec, io::Error> {

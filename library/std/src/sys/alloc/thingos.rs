...
//!
//! This file is not used directly — the active implementation is loaded via
//! `#[path = "../pal/thingos/alloc.rs"]` in `sys/alloc/mod.rs`.
//! Kept in sync for reference; see `sys/pal/thingos/alloc.rs` for the

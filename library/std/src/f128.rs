...
#[cfg(not(test))]
impl f128 {
    // FIXME: f128 math is broken in LLVM. Calls get lowered to `long double` functions,
    // which is often not `f128`.
    // See https://github.com/llvm/llvm-project/issues/44744
    ...
    // #[unstable(feature = "f128_math", issue = "116909")]
    ...
    pub fn abs(self) -> f128 {
        unsafe { intrinsics::fabsf128(self) }
    }

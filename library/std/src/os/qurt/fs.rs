...
impl MetadataExt for Metadata {
    #[allow(deprecated)]
    fn as_raw_stat(&self) -> &raw::stat {
        // Note: This cast is technically incorrect since libc::stat and raw::stat
        // have different layouts on QuRT, but this function is deprecated.
        // Users should use the accessor methods instead.

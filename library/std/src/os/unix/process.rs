...
pub impl(self) trait CommandExt {
    ...
    ///
    /// `old_fd` is an open file descriptor in the parent process. This descriptor will be
    /// duplicated in the child process and associated with the file descriptor number `new_fd`.
    ///
    ...
    /// [`man 2 dup`] for more information.
    ///
    /// [`man 2 dup`]: https://pubs.opengroup.org/onlinepubs/9799919799/functions/dup.html
    /// ```

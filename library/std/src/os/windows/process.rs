...
pub trait CommandExt: Sealed {
    ...
    /// Sets a raw attribute on the command, providing extended configuration options for Windows
    /// processes.
    ///
    ...
    /// holds the value associated with that attribute. Please refer to the [`windows-rs`] documentation
    /// or the [`Win32 API documentation`] for detailed information about available attributes
    /// and their meanings.
    ///
    /// # Note
    ///
    ...
    /// indicating that the maximum number of attributes has been exceeded. # Safety
    ///
    /// The usage of raw attributes is potentially unsafe and should be done with caution. Incorrect
    /// attribute values or improper configuration can lead to unexpected behavior or errors.
    ///
    /// # Example
    ///
    ...
    /// used.
    ///
    /// [`windows-rs`]: https://microsoft.github.io/windows-docs-rs/doc/windows/

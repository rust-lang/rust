...
impl TestDesc {
    ...
    /// Returns None for ignored test or tests that are just run, otherwise returns a description of
    /// the type of test. Descriptions include "should panic", "compile fail" and "compile".

...
impl<'a, T, U, I, A> core::trait_cast::TraitCast<I, U> for Rc<T, A>
where
    ...
    unsafe fn unchecked_cast(self) -> Result<Rc<U, A>, core::trait_cast::TraitCastError<Self>> {
        unsafe {
            ...
            let Some(Some(vtable)) = table.get(idx) else {
                let this = Rc::from_raw_in(this, alloc);

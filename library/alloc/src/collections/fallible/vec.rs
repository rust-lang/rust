...
use core::ops::{self, DerefPure, Index, IndexMut};
...
impl<T> FallibleVec<T> {
    ...
    pub const unsafe fn from_raw_parts(ptr: *mut T, length: usize, capacity: usize) -> Self {
        ...
        unsafe { Self { buf: InfallibleVec::from_raw_parts(ptr, length, capacity) } }
    }
...
impl<T> FallibleVec<T> {
    ...
    #[rustc_const_unstable(feature = "fallible_vec", issue = "157392")]
    #[inline]
    pub const fn to_infallible(self) -> InfallibleVec<T> {
    ...
    /// [`Allocator::shrink`]: crate::alloc::Allocator
    ///
    /// # Errors
    ///
...
#[unstable(feature = "fallible_vec", issue = "157392")]
impl<T> ops::Deref for FallibleVec<T> {
    type Target = [T];
...
#[unstable(feature = "fallible_vec", issue = "157392")]
impl<T> ops::DerefMut for FallibleVec<T> {
    #[inline]
...
unsafe impl<T> DerefPure for FallibleVec<T> {}

#[unstable(feature = "fallible_vec", issue = "157392")]
impl<T, I: SliceIndex<[T]>> Index<I> for FallibleVec<T> {
...
#[unstable(feature = "fallible_vec", issue = "157392")]
impl<T, I: SliceIndex<[T]>> IndexMut<I> for FallibleVec<T> {
    #[inline]
...
#[unstable(feature = "fallible_vec", issue = "157392")]
impl<T> IntoIterator for FallibleVec<T> {
    type Item = T;
...
#[unstable(feature = "fallible_vec", issue = "157392")]
impl<'a, T> IntoIterator for &'a FallibleVec<T> {
    type Item = &'a T;
...
#[unstable(feature = "fallible_vec", issue = "157392")]
impl<'a, T> IntoIterator for &'a mut FallibleVec<T> {
    type Item = &'a mut T;
...
impl<T> AsRef<FallibleVec<T>> for FallibleVec<T> {
    fn as_ref(&self) -> &FallibleVec<T> {
        self
    }
}

#[unstable(feature = "fallible_vec", issue = "157392")]
impl<T> AsMut<FallibleVec<T>> for FallibleVec<T> {
    fn as_mut(&mut self) -> &mut FallibleVec<T> {
        self
    }
}

#[unstable(feature = "fallible_vec", issue = "157392")]
impl<T> AsRef<[T]> for FallibleVec<T> {
    fn as_ref(&self) -> &[T] {
        self
    }
}
...
#[unstable(feature = "fallible_vec", issue = "157392")]
impl<T> AsMut<[T]> for FallibleVec<T> {

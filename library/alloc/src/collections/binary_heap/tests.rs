...
fn assert_covariance() {
    fn drain<'new>(
        d: Drain<'static, &'static str, Global, { CO_ALLOC_PREF_META_NO!() }>,
    ) -> Drain<'new, &'new str, Global, { CO_ALLOC_PREF_META_NO!() }> {
        d
    }
    fn drain_co<'new>(
        d: Drain<'static, &'static str, Global, { CO_ALLOC_PREF_META_YES!() }>,
    ) -> Drain<'new, &'new str, Global, { CO_ALLOC_PREF_META_YES!() }> {
        d
    }
}
